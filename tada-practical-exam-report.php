...
if ($is_filtered) {
    ...
    $sql = "SELECT id, unique_id, full_name, duty_category, duty_type, gross_total_amount
...
<head>
    ...
    <title>Practical Exam Bill Report</title>
</head>
<body>
            ...
            <div class="min-height-200px">
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Practical Exam Bill</h4>
                            </div>
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Practical Exam Bill Report</li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <form method="GET" action="">
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <a href="tada-practical-exam-report.php" class="btn btn-outline-secondary"><i class="fa fa-refresh mr-2"></i> Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                    ...
                    <div class="alert alert-info">
                        This view shows a quick summary of the submissions for the selected dates. Please use the <strong>Export Date-wise Bill Format</strong> button above to download the exact format required for the practical exam bill.
                    </div>
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        action: function (e, dt, node, config) {
                            window.location.href = 'api/export-practical-exam-bill.php?from_date=<?= $from_date ?>&to_date=<?= $to_date ?>';
                        }
                    },
                    {
                        extend: 'pdf',
