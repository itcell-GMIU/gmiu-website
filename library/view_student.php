                            ...
                            <div class="table-responsive">
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                    <thead>
                                        <tr align="center">
                                            ...
                                            if ($url_for == "approved") {
                                                ...
                                                echo ' <th scope="row" style="color:black;"><b>Book bank Fees Paid</b></th>';
                                            } else if ($url_for == "all") {
                                                echo ' <th scope="row" style="color:black;">Book bank Status</b></th>';
                                            }
                                            ?>
                                    ...
                                    <tbody>
                                        ...
                                        if ($url_for != "") {
                                            if ($url_for == "pending") {
                                                $cmd = $cmd . " AND stu.bookbank_fees_status  = '0'";
                                            } elseif ($url_for == "approved") {
                                                $cmd = $cmd . " AND stu.bookbank_fees_status ='1' ";
                                            }
                                        }
                                        if ($url_faculty_id != "") {
                                        ...
                                        if ($rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                $bookbank_status = $row['bookbank_fees_status'];
                                                if ($bookbank_status == 0) {
                                                    $status = "Pending";
                                                } else if ($bookbank_status == 1) {
                                                    $status = "Completed";
                                                }
                                    ...
                                    <tfoot>
                                        <tr align="center">
                                            ...
                                            if ($url_for == "approved") {
                                                ...
                                                echo ' <th scope="row" style="color:black;">Book bank Fees Paid</b></th>';
                                            }   else if ($url_for == "all") {
                                                echo ' <th scope="row" style="color:black;">Book bank Status</b></th>';
                                            }
                                            ?>
