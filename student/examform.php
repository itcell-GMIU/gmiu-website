                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-responsive">
                            ...
                            <tbody class="tbody">
                                <?php
                                $cmd = $con->prepare("SELECT `id`, `faculty_id`, `level_id`, `program_id`, `semester`, `type`, `subject_code`, `session`, `start_date`, `end_date`, `year`, `late_fee`,`hallticket_status`,`pr_hallticket_status` FROM `tbl_exam_form` WHERE `is_active` = 1 AND `faculty_id` =? AND `level_id` =? AND `program_id`= ? AND `semester` = ?");
                                ...
                                ?>
                                        ...
                                        <?php
                                           if ($prhallticket_status == 1 && $account_status == 1) {
                                            ?>
                                                <a href="PRexam_hall_ticket.php?eid=<?= $exam_id ?>" class="btn btn-info" style="width: 150px;"><i class="fa fa-file"></i>Practical Hall Ticket</a>
                                        <?php
                                            }
