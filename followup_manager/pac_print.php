...
<body>
    <?php
    // SQL query to fetch data from the tbl_pac_form table + admission_year
    $sqlQuery = "SELECT p.*, f.admission_year
                FROM tbl_pac_form p
    ...
    if ($resultSet->num_rows < 2) {
        ...
        while ($row = $resultSet->fetch_assoc()) {
            ...
            if ($row['is_edited']) {
                $is_edited = json_decode($row['is_edited'], true);
            }

            // Now you can use $display_formno instead of $formno below
            ?>
            <div class="a4-page mx-auto">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td
                                    class="font-weight-bold col-md-8 d-flex justify-content-between w-100 border-bottom-0 border-top-0">
                                    ...
                                    <?php if ($row['is_edited']) { ?>
                                        <input type="text" class="col-md-1 border-0"
                                            value="<?php echo ($is_edited['mode'] == $row['mode']) ? '' : 'Edited' ?>">
                                    <?php } ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-dark font-weight-bold col-md-4">Faculty</td>
                                <td
                                    class="font-weight-bold text-dark font-weight-bold col-md-8 d-flex justify-content-between border-1 border-bottom-0 w-100">
                                    <p class="cfs-10 my-0"><?php
                                    $result1 = $con->query("SELECT name FROM tbl_faculty WHERE id = " . $row['faculty_id']);
                                    while ($row1 = $result1->fetch_assoc()) {
                                        echo $row1['name'];
                                        // . " / " ;
                                    }
                                    $result3 = $con->query("SELECT name FROM tbl_level WHERE id = " . $row['level_id']);
                                    ...
                                    <?php if ($row['is_edited']) { ?>
                                        <input type="text" class="col-md-1 border-0"
                                            value="<?php echo ($is_edited['faculty_id'] == $row['faculty_id']) ? '' : 'Edited' ?>">
                                    <?php } ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td
                                    class="font-weight-bold col-md-8 d-flex justify-content-between border-1 border-bottom-0 w-100">
                                    <div class="d-flex">
                                        <div class="d-flex mx-2">
                                    ...
                                    <?php if ($row['is_edited']) { ?>
                                        <input type="text" class="col-md-1 border-0"
                                            value="<?php echo ($is_edited['level2'] == $row['level2']) ? '' : 'Edited' ?>">
                                    <?php } ?>
                                ...
                                <td
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex mx-1">
                                            ...
                                            <p class="mb-0 text-dark cfs-10">1<sup>st</sup>&nbsp;Year</p>
                                        </div>
                                        <div class="d-flex mx-1">
                                            <input type="checkbox" <?php echo (strpos($row['admissionType'], '2nd Year') !== false) ? 'checked' : ''; ?>>
                                            <p class="mb-0 text-dark cfs-10">2<sup>nd</sup>&nbsp;Year</p>
                                        </div>
                                        <div class="d-flex mx-1">
                                            <input type="checkbox" <?php echo (strpos($row['admissionType'], 'GB') !== false) ? 'checked' : ''; ?>>
                                            <p class="mb-0 text-dark cfs-10">GB</p>
                                        </div>
                                        <div class="d-flex mx-1">
                                            <input type="checkbox" <?php echo (strpos($row['admissionType'], 'VOC') !== false) ? 'checked' : ''; ?>>
                                            <p class="mb-0 text-dark cfs-10">VOC</p>
                                        </div>
                                        <div class="d-flex mx-1">
                                            <input type="checkbox" <?php echo (strpos($row['admissionType'], 'Minor') !== false) ? 'checked' : ''; ?>>
                                            <p class="mb-0 text-dark cfs-10">Minor</p>
                                        </div>
                                        <div class="d-flex mx-1">
                                            <input type="checkbox" <?php echo (strpos($row['admissionType'], 'Honour') !== false) ? 'checked' : ''; ?>>
                                            <p class="mb-0 text-dark cfs-10">Honour</p>
                                        </div>
                                    </div>
                                    <?php if ($row['is_edited']) { ?>
                                        <input type="text" class="col-md-1 border-0"
                                            value="<?php echo ($is_edited['admissionType'] == $row['admissionType']) ? '' : 'Edited' ?>">
                                    <?php } ?>
                                </td> <!-- Empty cell for input -->
                            </tr>
                            <tr>
                                ...
                                <td
                                    ...
                                    <p class="my-0">
                                        <?php
                                        $nameToShow = (strlen($row2['name']) > 30 && !empty($row2['shortname'])) ? $row2['shortname'] : $row2['name'];
                                        echo $row2['branch_code'] . ' / ' . $nameToShow;

                                        // Fetch and display Minor
                                        if (!empty($row['minor'])) {
                                            $minorId = intval($row['minor']);
                                            $minorQuery = $con->query("SELECT name FROM tbl_program WHERE id = $minorId");
                                            if ($minorQuery && $minorRow = $minorQuery->fetch_assoc()) {
                                                echo " / M: " . htmlspecialchars($minorRow['name']);
                                            }
                                        }

                                        // Fetch and display Honour
                                        if (!empty($row['honour'])) {
                                            $honourId = intval($row['honour']);
                                            $honourQuery = $con->query("SELECT name FROM tbl_program WHERE id = $honourId");
                                            if ($honourQuery && $honourRow = $honourQuery->fetch_assoc()) {
                                                echo " / H: " . htmlspecialchars($honourRow['name']);
                                            }
                                        }
                                        ?>
                                    </p>
                                    <?php if ($row['is_edited']) { ?>
                                        <input type="text" class="col-md-1 border-0"
                                            value="<?php echo ($is_edited['branchSpecialization'] == $row['branchSpecialization']) ? '' : 'Edited' ?>">
                                    <?php } ?>
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="d-flex justify-content-between col-md-12">
                    <p class="font-weight-bold text-dark my-0 p-4 py-0" style="font-size: 13px; font-weight: bolder;">
                        Account Section - 02
                        (OFFICE COPY)</p>
                    <p class="font-weight-bold text-dark my-0 p-4 py-0">Form No : <?php
                    if ($formno != $pacid) {
                        // Show formno as-is
                        echo htmlspecialchars($formno);
                    } else {
                    ...
                    <table class="table table-bordered mb-1">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-dark font-weight-bold col-md-3 cfs-13">Branch</td>
                                <td class="text-dark font-weight-bold col-md-3 cfs-10"><?php
                            ...
                            <tr>
                                ...
                                <td class="text-dark font-weight-bold col-md-3 cfs-13">is Minor or Honour </td>
                                <td class="text-dark font-weight-bold col-md-3 cfs-13">
                                    <?php
                                    $minorName = '';
                                    $honourName = '';
                                    ...
                                    // Fetch Minor name
                                    if (!empty($row['minor'])) {
                                        $minorQuery = $con->query("
                                            SELECT name, shortname 
                                            FROM tbl_program 
                                            WHERE id = " . intval($row['minor'])
                                        );
                                        if ($minorQuery && $minorRow = $minorQuery->fetch_assoc()) {
                                            $minorDisplayName = (strlen($minorRow['name']) > 30 && !empty($minorRow['shortname']) && strtolower($minorRow['shortname']) != 'n/a')
                                                ? $minorRow['shortname']
                                                : $minorRow['name'];
                                            $minorName = "M: " . $minorDisplayName;
                                        }
                                    }

                                    // Fetch Honour name
                                    if (!empty($row['honour'])) {
                                        $honourQuery = $con->query("
                                            SELECT name, shortname 
                                            FROM tbl_program 
                                            WHERE id = " . intval($row['honour'])
                                        );
                                        if ($honourQuery && $honourRow = $honourQuery->fetch_assoc()) {
                                            $honourDisplayName = (strlen($honourRow['name']) > 30 && !empty($honourRow['shortname']) && strtolower($honourRow['shortname']) != 'n/a')
                                                ? $honourRow['shortname']
                                                : $honourRow['name'];
                                            $honourName = "H: " . $honourDisplayName;
                                        }
                                    }

                                    // Display logic
                                    if (!empty($minorName) || !empty($honourName)) {
                                        echo $minorName;
                                        if (!empty($minorName) && !empty($honourName))
                                            echo " | ";
                                        echo $honourName;
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-dark font-weight-bold col-md-3 cfs-10">
                                    <?php
                                    $result3 = $con->query("SELECT branch_code, name, shortname FROM tbl_program WHERE id = " . intval($row['program_id']));
                                    while ($row3 = $result3->fetch_assoc()) {
                                        $branch = $row3['branch_code'];
                                        $name = isset($row3['name']) ? trim($row3['name']) : '';
                                        $shortname = isset($row3['shortname']) ? trim($row3['shortname']) : '';
                                        ...
                                        if (
                                            ($name == '' || strtolower($name) == 'n/a') &&
                                            ($shortname == '' || strtolower($shortname) == 'n/a')
                                        ) {
                                            continue;
                                        }

                                        // Decide what to show for main program name
                                        if (strlen($name) > 30 && !empty($shortname) && strtolower($shortname) != 'n/a') {
                                            $nameToShow = $shortname;
                                        } else {
                                            $nameToShow = $name;
                                        ...
                                        // Fetch minor name or shortname
                                        if (!empty($row['minor'])) {
                                            $minorResult = $con->query("SELECT name, shortname FROM tbl_program WHERE id = " . intval($row['minor']));
                                            if ($minorResult && $minorRow = $minorResult->fetch_assoc()) {
                                                $minorName = (strlen($minorRow['name']) > 30 && !empty($minorRow['shortname']) && strtolower($minorRow['shortname']) != 'n/a')
                                                    ? $minorRow['shortname']
                                                    : $minorRow['name'];
                                                $output .= " / M: " . htmlspecialchars($minorName);
                                            }
                                        }

                                        // Fetch honour name or shortname
                                        if (!empty($row['honour'])) {
                                            $honourResult = $con->query("SELECT name, shortname FROM tbl_program WHERE id = " . intval($row['honour']));
                                            if ($honourResult && $honourRow = $honourResult->fetch_assoc()) {
                                                $honourName = (strlen($honourRow['name']) > 30 && !empty($honourRow['shortname']) && strtolower($honourRow['shortname']) != 'n/a')
                                                    ? $honourRow['shortname']
                                                    : $honourRow['name'];
                                                $output .= " / H: " . htmlspecialchars($honourName);
                                            }
                                        }
            ...
            <div class="a4-page mx-auto mt-5 d-none" style="line-height: 1;">
                ...
                <div class="d-flex justify-content-between col-md-12">
                    <p class="font-weight-bold text-dark my-2 p-4 py-0" style="font-size: 13px; font-weight: bolder;">
                        ...
                        Section
                        (OFFICE COPY)</p>
                    <p class="font-weight-bold text-dark my-2 p-4 py-0">Form No : <?php
                    if ($formno != $pacid) {
                        // Show formno as-is
                        echo htmlspecialchars($formno);
                    } else {
                ...
                <div class="my-5 mx-4">
                    <h6>FULL NAME OF STUDENT : ______________________________________________________________</h6>
                </div>
            </div>
