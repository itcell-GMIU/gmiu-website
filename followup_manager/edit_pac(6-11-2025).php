                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="<?php echo $row['formno']; ?>" id="formno" name="formno"
                                                            required hidden>
                                                        <input type="text" class="form-control"
                                                            value="2025 / <?php echo str_pad(htmlspecialchars($row['formno']), 4, '0', STR_PAD_LEFT); ?>"
                                                            id="formno" name="formno" required disabled>
                                                    </div>
                                                </div>
