                    ...
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="font-weight-bold text-dark font-weight-bold col-md-8 cfs-10"><?php
                    ...
                    <table class="table table-bordered mb-1">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-dark font-weight-bold col-md-3 cfs-13">
                                    <?php
                                    echo isset($row['minor']) ? $row['minor'] : '';
                                    echo isset($row['honour']) ? $row['honour'] : '';
                                    echo (!isset($row['minor']) && !isset($row['honour'])) ? '---' : '';
                                    ?>
                                </td>
                            </tr>
                            <tr>
