                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    if (!empty($row['handwritten_file'])) {
                                                        $path = 'uploads/handwritten/' . $row['handwritten_file'];
                                                    ...
                                                    if (!empty($row['receipt'])) {
                                                        $path = 'uploads/receipts/' . $row['receipt'];
                                                        $ext = strtolower(pathinfo($path, PATHINFO_EXTENSION));
                                                        if (in_array($ext, ['jpg', 'jpeg', 'png', 'gif', 'webp'])) {
                                                    ...
                                                    if (!empty($row['passbook_cheque'])) {
                                                        $path = 'uploads/passbook_cheques/' . $row['passbook_cheque'];
                                                        $ext = strtolower(pathinfo($path, PATHINFO_EXTENSION));
                                                        if (in_array($ext, ['jpg', 'jpeg', 'png', 'gif', 'webp'])) {
                                                    ...
                                                    // Faculty Remark
                                                    echo "<tr><td>Faculty Remark</td><td>" . (!empty($row['f_remark']) ? htmlspecialchars($row['f_remark']) : "<i>(empty)</i>") . "</td></tr>";
                                                }
                                            } else {
                                                echo "<tr><td colspan='2'>No records found</td></tr>";
                                            }
