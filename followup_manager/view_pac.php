                                                    ...
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        <td>
                                                            ...
                                                            if (empty($admission_year) || $admission_year === '2025-26_july') {
                                                                ...
                                                                // If formno equals pacid → generate "2025 / XXXX"
                                                                if ($formno == $pacid) {
                                                                    echo "2025 / " . str_pad($pacid, 4, '0', STR_PAD_LEFT);

                                                                    // If formno does not start with "2025 /" → prepend it
                                                                } elseif (strpos($formno, '2025 /') !== 0) {
                                                                    echo "2025 / " . ltrim($formno, "0");
