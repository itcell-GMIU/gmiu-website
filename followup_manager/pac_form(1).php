...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $requiredFields = ['stu_id', 'studentName', 'studentMobile', 'studentEmail', 'whatsappNumber', 
                        'mode', 'faculty_id', 'level_id', 'program_id', 'admissionType',   'dateProvisional', 
                        'dateAdmission', 'cbpaStatus', 'tokenFeesAmount', 'tokenFeesPaidDate', 'remainingFees', 
                        'remainingPayDate', 'formno', 'remarks'];
   ...
   $sql = "INSERT INTO tbl_pac_form (
               ...
               formno, remarks, level2, minor, honour
           ) VALUES (
               ?, ?, ?, ?, ?, 
               ?, ?, ?, ?, ?, 
               ?, ?, ?, ?, ?, 
   ...
   if ($stmt = $con->prepare($sql)) {
       ...
       $stmt->bind_param(
          "ssssssssssssssssssssssssssssss",
           $stu_id, $studentName, $studentMobile, $studentEmail, $whatsappNumber, 
           $parentMobile, $mode,  $faculty_id, $level_id, $program_id, 
           $admissionType, $branchSpecialization, $quota, $category, $dateProvisional, 
           $dateAdmission,  $cbpaStatus, $tokenFeesAmount, $tokenFeesPaidDate, $remainingFees, 
           $remainingPayDate, $photoStatus, $one_time_scholarship, $mode_of_payment, $tshirt,
           $formno, $remarks, $level2, $minor, $honour
       );
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="admissionType[]" id="typeDualDegree" value="Dual Degree">
                                                    <label class="form-check-label" for="typeDualDegree">Dual Degree</label>
                                                </div>
                                                <div class="form-check form-check-inline">
