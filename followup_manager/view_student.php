...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        LEFT JOIN 
            tbl_admission_feedback af ON stu.id = af.student_id 
            AND af.is_active = 1 
            AND af.is_delete = 0
        WHERE 
            stu.is_active = 1 
            AND stu.is_delete = 0";
                                        ...
                                        if ($result && $result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                // Determine admission type (admy)
                                                $admy = 'N';
                                                if ($admission_year === '2025-26_july') {
                                                    $admy = 'N';
                                                } elseif ($admission_year === '2026-27_jan') {
                                                    $admy = 'B';
                                                } elseif ($admission_year === '2026-27_july') {
                                                    $admy = 'R';
                                                }

                                                // Check PAC form existence
                                                $query_count = "SELECT COUNT(*) as count FROM tbl_pac_form WHERE student_id = ? AND is_delete = 0";
                                                $stmt_count = $con->prepare($query_count);
                                                $stmt_count->bind_param("i", $stu_id);
                                                $stmt_count->execute();
                                                ...
                                                <tr align="center">
                                                    ...
                                                    <td><?php echo $stu_gr_number; ?></td>
                                                    <td><?php echo $stu_program_name; ?></td>
                                                    <td><?php echo $stu_first_name . " " . $stu_middle_name . " " . $stu_last_name; ?>
                                                    </td>

                                                    <td>
                                                        <a href="view_student_detail.php?stu_id=<?php echo $stu_id; ?>"
                                                            target="_blank">
                                                            <button type="button" class="btn btn-success">View</button>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="full_student_detail.php?stu_id=<?php echo $stu_id; ?>"
                                                            target="_blank">
                                                            <button type="button" class="btn btn-success">View</button>
                                                        </a>
                                                    </td>
                                                    ...
                                                    if ($total_count > 0) {
                                                        ...
                                                        <td>
                                                            <a
                                                                href="pac_form.php?stu_id=<?php echo $stu_id; ?>&admy=<?php echo $admy; ?>">
                                                                <button type="button" class="btn btn-info">Fill</button>
                                                            </a>
                                                        </td>
                                                    <?php } ?>
                                                </tr>
