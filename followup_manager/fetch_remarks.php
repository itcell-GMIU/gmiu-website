                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php if ($role_id == 14) {
                                ?>
                                <a class="btn btn-primary" style="margin-left: 90%;"
                                    href="../inquiry_head/assign_student.php"><i class="fa-solid"></i>Student Inquiry</a>
                                <?php
                            } elseif ($role_id == 15) {
                                ?>
                                <a class="btn btn-primary" style="margin-left: 90%;"
                                    href="../staff/view_assign_student.php"><i class="fa-solid"></i>Student Inquiry</a>
                            <?php } elseif ($role_id == 16) {
                                ?>
                                <a class="btn btn-primary" style="margin-left: 90%;" href="../counselor/student_list.php"><i
                                        class="fa-solid"></i>Student Inquiry</a>
                            <?php } elseif ($role_id == 12) {
                                ?>
                                <a class="btn btn-primary" style="margin-left: 90%;" href="../students/student_view.php"><i
                                        class="fa-solid"></i>Student Inquiry</a>
                            <?php } ?>
