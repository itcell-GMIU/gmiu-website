...
if (isset($_POST['submit'])) {
    ...
    if ($type_file == 'pdf') {
        ...
        if ($file_upload_status['status'] == 200) {
            ...
            $stmt = $con->prepare("INSERT INTO tbl_inquiry_photos (type, file_type, file_name) VALUES (?, ?, ?)");
            $stmt->bind_param("sss", $type, $type_file, $file_name);

            $result = $stmt->execute();

            if ($result) {
                $_SESSION['status'] = "Calling Document Inserted Successfully";
                $_SESSION['status_code'] = "success";
                echo "<script>setTimeout(function(){window.location='doc_view.php'}, 1000);</script>";
            } else {
                $_SESSION['status'] = "Calling Document Insertion Failed";
                $_SESSION['status_code'] = "error";
                echo "<script>setTimeout(function(){window.location='doc_insert.php'}, 1000);</script>";
            }
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Add Calling Document </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Add Calling Document</li>
                            </ol>
                        </div><!-- /.col -->
            ...
            <section class="content">
                <form id="post" method="POST" onsubmit="return validation()" enctype='multipart/form-data'>
                    <div class="container-fluid">
                        <div class="row">
                            <!-- left column -->
                            <div class="col-md-12">
                                ...
                                <div class="card card-gmiu">
                                    <div class="card-header">
                                        <h3 class="card-title">Add Calling Document</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <div class="card-body">
