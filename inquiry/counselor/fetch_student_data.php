<?php
include "../include/checklogin.php"; // Include your database connection
...
while ($row = $result->fetch_assoc()) {
    ...
    $data[] = [
        ...
        "actions" => "<a href='conform_admission.php?id=".$row['id']."' class='btn btn-primary'><i class='fa-solid fa-square-check'></i></a>"
    ];
}
