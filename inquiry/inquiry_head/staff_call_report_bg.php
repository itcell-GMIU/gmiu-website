                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-sm-2">
                                                    <select class="form-control" name="url_staff_id" id="staff_id">
                                                        ...
                                                        <?php
                                                        $stmt = $con->prepare("SELECT id, name FROM tbl_staff WHERE is_delete = '0' AND is_active = '1' AND role_id = '15' and id IN($u_staff_id)");
                                                        //$stmt->bindParam(':u_staff_id', $u_staff_id);
                                                        $stmt->execute();
