                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-3">
                                                ...
                                                <input type="text" name="first_name" value="<?php echo $first_name ?>" class="form-control" id="title_id" placeholder="Enter First Name" required>
                                            </div>
                                            <div class="form-group col-sm-3">
                                                <label for="name">Middle Name<span style="color: red;">*</span></label>
                                                <input type="text" name="middle_name" value="<?php echo $middle_name ?>" class="form-control" id="title_id" placeholder="Enter Middle Name" required>
                                            </div>
                                            <div class="form-group col-sm-3">
                                                <label for="name">Last Name<span style="color: red;">*</span></label>
                                                <input type="text" name="last_name" value="<?php echo $last_name ?>" class="form-control" id="title_id" placeholder="Enter Last Name" required>
                                            </div>
                                            <div class="form-group col-sm-3">
                                            ...
                                            <div class="form-group col-sm-3">
                                                ...
                                                <input type="email" name="email" value="<?php echo $email ?>" class="form-control" id="title_id" placeholder="Enter Email" required>
                                            </div>
                                            <div class="form-group col-sm-3">
                                                <label for="gender">Last Exam<span style="color: red;">*</span></label>
                                                <select name="exam" id="exam" value="<?php echo $last_exam ?>" class="form-control" required>
