                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-sm-2">
                                                    <select class="form-control" name="url_staff_id" id="staff_id">
                                                        ...
                                                        <?php
                                                        $sql = "SELECT id, name FROM tbl_staff WHERE is_delete = '0' AND is_active = '1'";

                                                       if ($role_id == 14) {
                                                           $sql .= " AND role_id = '15'";
                                                       }
                                                       
                                                       $sql .= " AND id IN($u_staff_id)";
                                                       
                                                       $stmt = $con->prepare($sql);  //$stmt->bindParam(':u_staff_id', $u_staff_id);
                                                        $stmt->execute();
                                ...
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        $cmd = "SELECT CS.call_title AS call_status_title, R.followup_why_input as followup_why_input,
                                                CR.call_title AS call_rating_title, R.follow_up_date as followup_date, R.is_followup_need as followup, R.call_status as call_status,  R.remark_date as date, staff.name as staff_name, faculty.name as faculty_name, level.name as level_name, program.name as program_name, S.mobile_number as mobile_number, S.mobile_number2 as mobile_number2, S.id AS id, R.inq_student_id AS student_id, CONCAT(S.first_name, ' ', S.last_name) AS student_name, R.remarks AS call_remarks , S.last_exam AS last_exam
                                                FROM tbl_inquiry_remarks R JOIN tbl_inquiry_student S ON R.inq_student_id = S.inq_student_id 
                                        ...
                                        if ($role_id == "14" ) {
                                            $cmd .= " AND R.staff_id  IN($u_staff_id) ";
                                        }
                                        if ($url_faculty_id != "") {
                                        ...
                                        ?>
                                            <tr align="center">
                                                ...
                                                <td scope="row">
                                                    <a href="/gmiu/inquiry/staff/view_student_detail.php?id=<?php echo $row['id'] ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                                                </td>
                                            </tr>
