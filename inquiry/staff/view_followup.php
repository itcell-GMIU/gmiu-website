            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                                ...
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                    <thead>
                                        <tr align="center">
                                            ...
                                            <th scope="row" style="color:black;"><b>call Date</b></th>
                        ...
                        ch.call_datetime as call_datetime,
                    ...
                    LEFT JOIN 
                        tbl_call_history ch ON pro.inq_student_id = ch.inq_student_id 
                    LEFT JOIN 
                            (
                                SELECT 
                                    ir.inq_student_id, 
                    ...
                    WHERE 
                       ...
                       GROUP BY pro.id ");
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            $call_date = $row['call_datetime'];
                                            $latest_remarks = $row['latest_remarks'];
                                            ...
                                            $call_date= !empty($row['call_datetime']) ? $row['call_datetime'] : "<b>N/A</b>";
