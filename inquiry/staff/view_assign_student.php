        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Pending Student Call List</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Pending Student Call List</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <span>
                                <center>
                                    <h5><b><i class="fa-solid fa-phone-volume"></i> Pending Student Call List</b></h5>
                                </center>
                            </span>
                        </div>
                        <!-- /.card-header -->
                                    ...
                                    <tbody>
                                        ...
                                        $cmd = $con->prepare("
                                            ...
                                            WHERE 
                                                pro.is_delete =  ? AND
                                                pro.staff_id = ? and 
                                                pro.is_admission_confirm = '0' and 
                                                (r.inq_student_id IS NULL OR (r.staff_id = $staff_id and r.is_followup_need = '0')) 
                                        ...
                                        // WHERE pro.is_delete = ? AND pro.staff_id = ? AND pro.is_admission_confirm = '0' AND R.is_followup_need = '0'");
