                                ...
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                    <thead>
                                        <tr align="center">
                                            ...
                                            <th scope="row" style="color:black;"><b>Calling Date</b></th>
                                    ...
                                    <tbody>
                                        <?php
                                        $status = "1";
                                        //         $cmd = $con->prepare("SELECT h.call_datetime as calling_date, R.is_followup_need as followup,
                                        ...
                                        //         CONCAT(S.first_name, ' ',middle_name,'', S.last_name) AS student_name, 
                                        ...
                                        //  LEFT JOIN tbl_call_history h ON R.inq_student_id = h.inq_student_id
                                        //  WHERE R.staff_id = ? and h.staff_id = ?;");
                                        $cmd =$con->prepare( "SELECT 
                                            ...
                                            LEFT JOIN tbl_call_status CR ON R.call_rating = CR.id
                                            LEFT JOIN (
                                                SELECT inq_student_id, MAX(call_datetime) AS latest_call
                                                FROM tbl_call_history
                                                WHERE staff_id = ?
                                                GROUP BY inq_student_id
                                            ) h ON R.inq_student_id = h.inq_student_id
                                            WHERE R.staff_id = ?;");
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            $calling_date = !empty($row['calling_date']) ? $row['calling_date'] : "<b>N/A</b>";
