...
if (isset($_GET['programFilter']) &&  $_GET['programFilter'] != "") {
    ...
    $cmd2 = $con->prepare("SELECT staff.id as staff_id, staff.password as password,staff.name as staff_name, staff.email as staff_email, staff.mobile_number as staff_mobile_number, staff.shortname as staff_shortname, c staff.is_active as staff_is_active, 
    ...
    $cmd2 = $con->prepare("SELECT staff.id as staff_id, staff.password as password , staff.name as staff_name, staff.email as staff_email, staff.mobile_number as staff_mobile_number, staff.shortname as staff_shortname, staff.role_id as staff_role_id,staff.is_active as staff_is_active, 
                                            faculty.name as faculty_name, level.name as level_name, program.name as program_name, level.id as level_id FROM tbl_staff as staff
                                            LEFT JOIN tbl_faculty faculty ON staff.faculty_id = faculty.id 
                                            LEFT JOIN tbl_level level ON staff.level_id = level.id LEFT JOIN tbl_program program ON staff.program_id = program.id  
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- + ADD Button  -->
                        <a class="btn btn-primary" style="margin-left: 90%;" href="../staff/staff_insert.php"><i class="fa-solid fa-plus"></i> Add</a>
                        <!-- + ADD Button End -->
                            ...
                            <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                ...
                                <tbody>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        $staff_role_id = !empty($row['staff_role_id']) ? $row['staff_role_id'] : "<b>N/A</b>";
                                    ...
                                    ?>
                                        <tr align="center">
                                            ...
                                            <td scope="row">
                                                <?php
                                                $cmd8 = "SELECT name FROM tbl_role WHERE id = $staff_role_id ";
                                                $stmt8 = $con->prepare($cmd8);
                                                $stmt8->execute();
                                            ...
                                            <td scope="row">
                                                <a href="assign_faculty_edit.php?id=<?php echo $row['staff_id'] ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
...
<script>
    document.getElementById("applyFilter").addEventListener("click", function() {
        ...
        window.location.href = "assign_faulty_view.php?programFilter=" + programFilter;
    });
</script>