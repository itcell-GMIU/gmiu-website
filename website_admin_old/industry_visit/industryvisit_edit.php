...
// Retrieving data from the database based on the provided visit ID
if (isset($_GET['visit_id'])) {
    // GET faculty id from display table
    if (isset($_GET['visit_id']) && !empty($_GET['visit_id'])) {
        $visit_id = mysqli_real_escape_string($con, $_GET['visit_id']);
        $visit_id = only_digits($visit_id);
        if ($visit_id == false) {
...
$status = 0;
// get date fromDB
$cmd = $con->prepare("SELECT visit.id as visit_id, visit.faculty_id as faculty_id,visit.level_id as level_id,visit.program_id as program_id,visit.visit_name as visit_name, visit.date as date ,visit.visit_description as visit_detail, visit.report as report ,visit.visit_year as visit_year,faculty.name as faculty_name FROM tbl_industry_visit as visit 
 LEFT JOIN tbl_faculty faculty ON visit.faculty_id = faculty.id 
 LEFT JOIN tbl_level level ON visit.level_id = level.id
 LEFT JOIN tbl_program program ON visit.program_id = program.id  WHERE visit.is_delete = ? and visit.id = ? ");
$cmd->bind_param("ii", $status, $visit_id);
$cmd->execute();
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Industry Visit</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active"> Edit Industry Visit</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Industry Visit</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="quickForm" method="POST" action="industryvisit_update.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <?php if ($role_id != 8) { ?>
       ...
       $stmt = $con->prepare($cmd);
        ...
        <?php } ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" id="title" value="<?php echo $visit_name ?>" placeholder="Enter Industry Visit Title" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="ckeditor" id="description" required><?php echo htmlspecialchars_decode($visit_detail); ?></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="level_name">Date<span style="color: red;">*</span></label>
                                            <input type="date" name="date" class="form-control" id="title" value="<?php echo $date; ?>" required>
                                        </div>
                                        <input type="hidden" name="id" id="id" value="<?php echo $visit_id; ?>">
                                        ...
                                        <div name="image_display_main" id="image_display_main" class="form-group">
                                            ...
                                            $cmd->bind_param("ss", $type, $visit_id);
                                            $cmd->execute();
                                            $result = $cmd->get_result();
                                            ...
                                            ?>
                                                ...
                                                <div name="image_display" id="image_display" class="form-group">
                                                    <img src="<?php echo "../uploads/industry_visit/image/" . "$file_name"; ?>" width="200" height="200">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        ...
                                                        <label class="custom-file-label" for="exampleInputFile"><?php echo  $report; ?> </label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <a href="<?php echo '../uploads/industry_visit/report/' . $report; ?>" class="btn btn-primary" target="_BLANK">View Report</a>
