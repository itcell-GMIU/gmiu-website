                                    ...
                                    <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                        ...
                                        <tbody>
                                            ...
                                            if ($role_id == 8) {
                                                ...
                                                $cmd = $con->prepare("SELECT level.name as level, program.name as program_name,visit.id as visit_id,
                                                visit.date as date,visit.visit_name as visit_name, visit.report as report ,visit.visit_year as visit_year,
                                                faculty.name as faculty_name,visit.faculty_id as faculty_id, visit.level_id as level_id,
                                                visit.program_id as program_id FROM tbl_industry_visit as visit 
                                                 LEFT JOIN tbl_faculty faculty ON visit.faculty_id = faculty.id 
                                                 LEFT JOIN tbl_level level ON visit.level_id = level.id
                                                 LEFT JOIN tbl_program program ON visit.program_id = program.id  WHERE visit.is_delete = ?");
