...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.php" class="brand-link"
        ...
        <img src="../../website_assets/images/logo3.png" alt="logo"
            style="width : 70%; position: relative; left: -6px;">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item"> <a href="#" class="nav-link"> <i class="fas fa-photo-video"></i>
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item"> <a href="../student_corner/student_corner_insert.php"
                                            class="nav-link"> <i class="far fa-circle nav-icon"></i>
                                            <p>Add Student Corner</p>
                                        </a> </li>
                                    <li class="nav-item"> <a href="../student_corner/student_corner_view.php"
                                            class="nav-link"> <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="../training_and_placement/training_and_placement_insert.php"
                                            class="nav-link">
                                            <i class="fa-solid fa-plus nav-icon"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="../training_and_placement/training_and_placement_view.php"
                                            class="nav-link">
                                            <i class="fa-solid fa-eye nav-icon"></i>
            ...
            <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item"> <a href="#" class="nav-link"> <i class="fas fa-photo-video"></i>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item"> <a href="../student_corner/student_corner_insert.php" class="nav-link"> <i
                                        class="far fa-circle nav-icon"></i>
                                    <p>Add Student Corner</p>
                                </a> </li>
                            <li class="nav-item"> <a href="../student_corner/student_corner_view.php" class="nav-link"> <i
                                        class="far fa-circle nav-icon"></i>
                                    <p>View Student Corner</p>
                                </a> </li>
                        </ul>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="../initiatives_collaboration_modes/initiatives_collaboration_modes_insert.php"
                                            class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Add Initiatives & Collaboration Modes</p>
                                        </a>
                                        <a href="../initiatives_collaboration_modes/initiatives_collaboration_modes_view.php"
                                            class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="../international_admission/international_admission_insert.php"
                                            class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Add International Admission</p>
                                        </a>
                                        <a href="../international_admission/international_admission_view.php"
                                            class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item"> <a href="../our_project/our_social_insert.php" class="nav-link"> <i
                                        class="far fa-circle nav-icon"></i>
                                    <p>Add Social Impact Projects</p>
                                </a> </li>
                            <li class="nav-item"> <a href="../our_project/our_social_view.php" class="nav-link"> <i
                                        class="far fa-circle nav-icon"></i>
                                    <p>View Social Impact Projects</p>
                                </a> </li>
                            <li class="nav-item"> <a href="../our_project/our_project_insert.php" class="nav-link"> <i
                                        class="far fa-circle nav-icon"></i>
                                    <p>Add Projects</p>
                                </a> </li>
                            <li class="nav-item"> <a href="../our_project/our_project_view.php" class="nav-link"> <i
                                        class="far fa-circle nav-icon"></i>
                                    <p>View Projects</p>
                                </a> </li>
                            <li class="nav-item"> <a href="../our_project/our_hackathon_insert.php" class="nav-link"> <i
                                        class="far fa-circle nav-icon"></i>
                                    <p>Add Our Hackathon</p>
                                </a> </li>
                            <li class="nav-item"> <a href="../our_project/our_hackathon_view.php" class="nav-link"> <i
                                        class="far fa-circle nav-icon"></i>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i class="fas fa-layer-group"></i>
                            <p>CA Program Registration<i class="right fas fa-angle-left"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="../ca-foundation/view-registration.php" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
