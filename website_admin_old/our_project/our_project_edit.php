...
if (isset($_GET['exp_id']) && !empty($_GET['exp_id'])) {
    ...
    $status = 0;
    $cmd = $con->prepare("SELECT  exp.faculty_id as faculty_id, exp.level_id as level_id, exp.program_id as program_id,  exp.title1 as exp_title1, exp.description as exp_description, exp.is_active as exp_is_active FROM tbl_our_project as exp WHERE exp.is_delete = ? AND exp.id = ?");
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $exp_title1 = !empty($row['exp_title1']) ? $row['exp_title1'] : 'N/A';
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Our Project</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Edit Our Project</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Our Project</h3>
                                    <!-- <h3 class="card-title">Quick Example <small>jQuery Validation</small></h3> -->
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="quickForm" method="POST" action="our_project_update.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <?php if ($role_id != 8) { ?>
                                        ...
                                        ?> 
                                        <div class="form-group">
                                            <label for="title1_id">Project Title<span style="color: red;">*</span></label>
                                            <input type="text" name="title1" class="form-control" id="title1_id" value="<?php echo $exp_title1; ?>" placeholder="Enter Our Project Name" required>
                                        </div>
