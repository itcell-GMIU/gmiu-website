...
if (isset($_GET['cwp_id']) && !empty($_GET['cwp_id'])) {

    $cwp_id = mysqli_real_escape_string($con, $_GET['cwp_id']);
    $cwp_id = only_digits($cwp_id);
    if ($cwp_id == false) {
        $_SESSION['status'] = "Invalid data in url";
        $_SESSION['status_code'] = "error";
        echo "<script>setTimeout(function(){window.location='cwp_view.php'},1000)</script>";
    }
    $cmd = "SELECT sp.id as cwp_id, sp.title as title , sp.description as cwp_description, site_photos.file_name as file_name FROM tbl_campus as sp
    LEFT JOIN tbl_site_photos site_photos on sp.id = site_photos.type_id WHERE sp.id = ?";
    $stmt = $con->prepare($cmd);
    $stmt->bind_param('i', $cwp_id);
    $stmt->execute();
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $cwp_id = $row['cwp_id'];
        $title = $row['title'];
        $cwp_description = !empty($row['cwp_description']) ? $row['cwp_description'] : "<b>N/A</b>";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit cwp Activity</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Edit cwp Activity</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                <div class="card-header">
                                    <h3 class="card-title">Edit cwp Activity</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="quickForm" method="POST" action="cwp_update.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        
                                            <input type="hidden" name="cwp_id" value="<?php echo $cwp_id; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="description" class="ckeditor" name="description"><?php echo htmlspecialchars_decode($cwp_description); ?></textarea>
                                            </div>
                                            ...
                                            <div name="image_display_main" id="image_display_main" class="form-group">
                                                ...
                                                ?>
                                                    <input type="hidden" name="image_uploads" id="id" value="<?php echo $cwp_id; ?>">
                                                    <div name="image_display" id="image_display" class="form-group">
                                                        <img src="<?php echo "../uploads/cwp/" . "$file_name"; ?>" width="200" height="200">
