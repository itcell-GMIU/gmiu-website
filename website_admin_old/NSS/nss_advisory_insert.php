...
if (isset($_POST['submit'])) {
    ...
    $stmt = $con->prepare("INSERT INTO `tbl_nss_advisory` (`description`) VALUES (?)");
    $stmt->bind_param("s", $description);
    $result = $stmt->execute();
    $id = $con->insert_id;

    if ($result) {
        $_SESSION['status'] = "Advisory Committe Inserted Successfully";
        $_SESSION['status_code'] = "success";
        echo "<script>setTimeout(function(){window.location='nss_advisory_view.php'},1000);</script>";
    } else {
        // Handle error and provide feedback
        $_SESSION['status'] = "Advisory Committe Insertion Failed";
        $_SESSION['status_code'] = "error";
        echo "<script>setTimeout(function(){window.location='nss_advisory_insert.php'},1000)</script>";
    }
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Add Advisory Committe</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Add Advisory Committe</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                <div class="card-header">
                                    <h3 class="card-title">Add Advisory Committe</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
