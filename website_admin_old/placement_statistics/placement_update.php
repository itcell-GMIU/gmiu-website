...
if ($role_id == 8)
{
    ...
    // Check if new company logo is uploaded
        ...
        $stmt->bind_param("iiissssi", $faculty_id, $level_id, $program_id, $placement_student_name, $placement_year, $placement_student_image, $placement_company_logo, $placement_id);
        $result = $stmt->execute();
        if ($result) {
