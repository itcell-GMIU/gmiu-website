...
if (isset($_GET['mm_id']) && !empty($_GET['mm_id'])) {
    ...
    $cmd = "SELECT sp.id as mm_id, sp.title as title, site_photos.file_name as file_name, description FROM tbl_campus as sp LEFT JOIN tbl_site_photos site_photos on sp.id = site_photos.type_id WHERE sp.id = ?";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Advance Laboratories Activity</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Edit Advance Laboratories Activity</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Advance Laboratories Activity</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="quickForm" method="POST" action="advance_laboratories_update.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="text_editor"><?php echo strip_tags($description); ?></textarea>
                                        </div>
                                        ...
                                        <div name="image_display_main" id="image_display_main" class="form-group">
                                            ...
                                            ?>
                                                ...
                                                <div name="image_display" id="image_display" class="form-group">
                                                    <img src="<?php echo "../uploads/advance_laboratories/" . "$file_name"; ?>" width="200" height="200">
