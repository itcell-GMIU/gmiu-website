...
if (isset($_GET['ic_id']) && !empty($_GET['ic_id'])) {
    ...
    if ($ic_id == false) {
        ...
        echo "<script>setTimeout(function(){window.location='research_view.php'},1000)</script>";
    }
    $status = 0;
    $cmd = $con->prepare("SELECT id, title, img_name, description FROM tbl_research WHERE is_delete = ? AND type_id= ? and id=?");
    $cmd->bind_param("iii", $status, $type, $ic_id);
    $cmd->execute();
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit <?php echo $heading; ?></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Edit <?php echo $heading; ?></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                <div class="card-header">
                                    <h3 class="card-title">Edit <?php echo $heading; ?></h3>
                                    <!-- <h3 class="card-title">Quick Example <small>jQuery Validation</small></h3> -->
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="quickForm" method="POST" action="research_update.php"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" id="title_id"
                                                value="<?php echo $title; ?>" placeholder="Enter GMRDC title here"
                                                required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="text_editor"
                                                name="program_description"><?php echo htmlspecialchars_decode($description); ?></textarea>
                                        </div>
