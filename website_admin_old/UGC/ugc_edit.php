                    ...
                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="type" required>
                                                ...
                                                <option value="schedule" <?php echo ($current_type == 'schedule') ? 'selected' : ''; ?>>Schedule</option>
                                                <option value="advertisement" <?php echo ($current_type == 'advertisement') ? 'selected' : ''; ?>>Advertisement</option>
                                                <option value="merit_list" <?php echo ($current_type == 'merit_list') ? 'selected' : ''; ?>>Merit List</option>
                                </select>
                            </div>
