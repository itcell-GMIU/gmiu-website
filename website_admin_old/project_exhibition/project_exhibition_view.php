        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">View Project Exhibition</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">View Project Exhibition </li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <span>
                                <center>
                                    <h5><b><i class="fas fa-globe"></i> View Project Exhibition</b></h5>
                                </center>
                            </span>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <!-- + ADD Button  -->
                            <a class="btn btn-primary" style="margin-left: 90%;" href="project_exhibition_insert.php"><i class="fa-solid fa-plus"></i> Add</a>
                            <!-- + ADD Button End -->
                            <div class="table-responsive">
                                <table id="mm" class="dataTableLoad table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        $status = 0;
                                        $type = 5;
                                       $cmd = $con->prepare("SELECT id,title FROM tbl_campus WHERE is_delete = ? AND type_id= ?");
                                            ...
                                            <tr align="center">
                                                ...
                                                <td scope="row" class="image-cell">
                                                   ...
                                                   ?>
                                                    ...
                                                    <a href="<?php echo "../uploads/project_exhibition/" . $file_name; ?>" target="_blank">
                                                     <img src="../uploads/project_exhibition/<?php echo $file_name; ?>" alt="" class="thumbnail" >
                                                     </a>
                                                   </div>
                                                    <?php
                                                    }
                                                   ...
                                                   // If no images are found, display a message
                                                     echo "<p>No images found for this Project Exhibition.</p>";
                                                     }
                                                 ?>
                                                 </td>
                                                ...
                                                <td scope="row">
                                                    <a href="project_exhibition_edit.php?mm_id=<?php echo $mm_id ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
                                                      <?php if($role_id == 11) { ?>
                                                    <a href="project_exhibition_delete.php?mm_id=<?php echo $mm_id; ?>" class="btn btn-danger"><i class="fas fa-trash"></i>
                                                    </a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
