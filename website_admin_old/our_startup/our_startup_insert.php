...
// include '../../common/function.php';
    ...
    if (isset($_POST['submit'])) {
        ...
        $stmt = $con->prepare("INSERT INTO `tbl_our_startup`(title)VALUES (?)");
        ...
        if (isset($_FILES['images']['tmp_name'])) {
            $targetDirectory = "../uploads/our_startup/image/";
            ...
            if ($uploaded_images['status'] == 200) {
                ...
                $_SESSION['status'] = "Our Startup Inserted Successfully";
                ...
                echo "<script>setTimeout(function(){window.location='our_startup_insert.php'},1000)</script>";
            }
        }
    }
?>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Add Our Startup</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                    <li class="breadcrumb-item active">Add Our Startup</li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-gmiu">
                                    <div class="card-header">
                                        <h3 class="card-title">Add Our Startup</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form id="quickForm" method="POST" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" id="title_id" placeholder="Enter Our Startup Title" required>
                                            </div>
