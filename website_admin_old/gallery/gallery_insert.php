...
if (isset($_POST["submit"])) {
    $gallery_img =  $_FILES['file_input'];
    $image_type = "gallery_image";
      
// Check if the image type is 'gallery_image'
    if ($image_type == 'gallery_image') {
        if (isset($_FILES['file_input'])) {
            $targetDirectory = "../uploads/gallery_image/";
            ...
            if ($file_upload_status['status'] == 200) {
                ...
                $result = $stmt->execute();
                if ($result) {
                    $_SESSION['status'] = "Gallery Image Inserted Successfully";
                    $_SESSION['status_code'] = "success";
                    echo "<script>setTimeout(function(){window.location='gallery_view.php'},1000);</script>";
                } else {
                    $_SESSION['status'] = "Gallery Image Insertion Failed";
                    $_SESSION['status_code'] = "error";
                    echo "<script>setTimeout(function(){window.location='gallery_insert.php'},1000)</script>";
                }
            } else {
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form method="POST" enctype='multipart/form-data' action="gallery_insert.php">
                    <div class="container-fluid">
                        <div class="row">
                            <!-- left column -->
                            <div class="col-md-12">
                                ...
                                <div class="card card-gmiu">
                                    ...
                                    <!-- form start -->
                                    <div class="card-body">
                                        <label for="exampleInputFile">Upload Image</label><span style="color: red;">
