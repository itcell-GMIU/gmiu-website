        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">View Gallery image</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <span>
                                <center>
                                    <h5><b><i class="fas fa-book-reader"></i>View Gallery image</b></h5>
                                </center>
                            </span>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <!-- + ADD Button  -->
                            <a class="btn btn-primary" style="margin-left: 90%;" href="gallery_insert.php"><i
                                ...
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr align="center">
                                            ...
                                            <td scope="row">
                                                <a href='../uploads/gallery_image/<?php echo $tbl_site_photos_file; ?>'
                                                    target="_blank"><img
                                                        src="../uploads/gallery_image/<?php echo $tbl_site_photos_file; ?>"
                                            ...
                                            <td scope="row">
                                            <?php if($role_id == 11) { ?>
                                                <a href="gallery_delete.php?tbl_site_photos_file_id=<?php echo $row['tbl_site_photos_id'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                                  <?php } ?>
                                            </td>
                                        </tr>
