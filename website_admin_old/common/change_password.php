...
if (isset($_POST['submit'])) {
    ...
    if (empty($current_password_error) && empty($new_password_error) && empty($confirm_password_error)) {
        ...
        $stmt = $con->prepare("SELECT password FROM tbl_admin WHERE id = $web_admin_id");
        $stmt->execute();
        $ex = $stmt->get_result();
        ...
        if ($current_password == $row['password']) {
            ...
            if ($new_password == $confirm_password) {
                ...
                $stmt = $con->prepare("UPDATE tbl_admin SET password = ?  WHERE id = ?");
                $stmt->bind_param("si", $new_password, $web_admin_id);
                if ($stmt->execute()) {
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <?php echo $web_admin_id;?>
                    <div class="login">
                            <section class="login-area">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-offset-8">
                                            <form action="" class="learnpro-register-form text-center" method="POST" style="width: 400px;">
