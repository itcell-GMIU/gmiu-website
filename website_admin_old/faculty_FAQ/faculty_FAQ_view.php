                                    ...
                                    WHERE FAQ.is_delete = ?");
                                        ...
                                        ?>
                                            <tr align="center">
                                                ...
                                                <td scope="row">
                                                    <?php if ($FAQ_document == "document") {
                                                    ?>
                                                        <a href='../uploads/faculty_FAQ/document/<?php echo $FAQ_document ?>' target="_blank"><img src="../uploads/faculty_FAQ/document/<?php echo $FAQ_document ?>" alt="" style="width: 200px;"></a>
                                                    <?php
                                                    } else {
                                                    ?>
