...
if (isset($_POST['submit'])) {
    ...
    $stmt = $con->prepare("INSERT INTO `tbl_faculty_faq`(faculty_id, level_id ,document) VALUES (?,?,?)");
    $stmt->bind_param("iis", $faculty_id, $level_id, $document);
    $result = $stmt->execute();

    // Check if the insertion was successful
    if ($result) {
        $_SESSION['status'] = "FAQ Inserted Successfully";
        $_SESSION['status_code'] = "success";
        echo "<script>setTimeout(function(){window.location='faculty_FAQ_view.php'},1000);</script>";
    } else {
        $_SESSION['status'] = "FAQ Details Insertion Failed";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Add FAQ Documents</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Add FAQ Documents</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                <div class="card-header">
                                    <h3 class="card-title">Add FAQ Documents</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <!-- form start -->
