                                ...
                                <div class="table-responsive">
                                    <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                        ...
                                        <tbody>
                                            ...
                                            if($role_id == 8)
                                            { $status = 0;
                                                $cmd = $con->prepare("SELECT pro.id as id, pro.faculty_id as faculty_id, pro.level_id as level_id, pro.program_id as program_id, pro.title as program_title, pro.is_active as program_is_active, 
                                                faculty.name as faculty_name,level.name as level_name ,program.name as program_name FROM tbl_program_outcome as pro
                                                LEFT JOIN tbl_faculty faculty ON pro.faculty_id = faculty.id 
                                                LEFT JOIN tbl_level level ON pro.level_id = level.id 
                                                LEFT JOIN tbl_program program ON pro.program_id = program.id WHERE pro.is_delete = ? and pro.faculty_id = ? and pro.level_id IN($level_id)  and pro.program_id = ?");
                                            ...
                                            LEFT JOIN tbl_faculty faculty ON pro.faculty_id = faculty.id 
                                            LEFT JOIN tbl_level level ON pro.level_id = level.id 
                                            LEFT JOIN tbl_program program ON pro.program_id = program.id WHERE pro.is_delete = ?");
