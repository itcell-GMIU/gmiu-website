                        ...
                        <div class="col-sm-6">
                            ...
                            <h1 class="m-0">View <?php
                                                    if ($url_for == 'payment_completed') {
                                                        ...
                                                        echo "Offline Payment Completed";
                                                    }
                                                    elseif ($url_for == 'all') {
                                                        echo " Total ";
                                                    ...
                                                    } elseif ($url_for == 'admission_cancel_students') {
                                                        echo "Cancel Request";
                                                    }
                            ...
                            <div class="table-responsive">
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                    <thead>
                                        <tr align="center">
                                            <?php
                                            if ($url_for == 'admission_cancel_students') {
                                            ?>
                                                ...
                                                <th scope="row" style="color:black;"><b>Feedback Source</b></th>
                                                <th scope="row" style="color:black;"><b>Referral Code</b></th>
                                                <th scope="row" style="color:black;"><b>Admission Year</b></th>
                                                <th scope="row" style="color:black;"><b>Method</b></th>
                                                ...
                                                <th scope="row" style="color:black;"><b>Admission Cancel Request Accept/Reject</b></th>
                                                <td colspan='2' style="color:black;"><b>Admission Cancel Request Reason</b></td>
                                    ...
                                    <tbody>
                                        <?php
                                        $cmd = "Select stu.password,stu.admission_status,stu.id,stu.gr_number,stu.comment,stu.program_id,stu.first_name,stu.middle_name,stu.last_name,stu.email,stu.mobile_number,stu.status,stu.payment_status,stu.payment_mode,stu.account_office_status,stu.created_at,pro.name as program_name,level.name as level_name,faculty.name as faculty_name,
                                            fb.feedback_source,
                                            fb.referral_code,
                                            fb.admission_year,
                                            fb.method from 
                                            ...
                                            LEFT JOIN tbl_admission_feedback fb ON stu.id = fb.student_id and fb.is_active=1 and fb.is_delete=0
                                        ...
                                        if ($url_for != "") {
                                            if ($url_for == "payment_completed") {
                                                ...
                                                $cmd = $cmd . " AND stu.payment_mode = 'offline' and stu.account_office_status = 'approved'";
                                            }elseif ($url_for == "payment_pending") {
                                        ...
                                        if ($rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                $feedback_labels = [ "social_media" => "Social media (WhatsApp, API, Instagram, FB, Telegram, Twitter, LinkedIn)", "voice" => "Voice broadcasting (tune call)", "counselor" => "Counselor", "faculty" => "Faculty", "student" => "Student", "school_teacher" => "School Teacher/coaching teacher/support center", "fm" => "FM/hoardings/newspaper advertisement/leaflet", "acpc" => "ACPC/ACPDC site", "own" => "Own", "other" => "Other" ]; 
                                                // Map admission year values to labels 
                                                $admission_year_labels = [ "2025-26_july" => "2025-26 (REGULAR)", 
                                                "2026-27_jan" => "2026-27 (BIANNUAL)", "2026-27_july" => "2026-27 (REGULAR)" ]; 
                                                $method_labels= [ "reg" => "REGULAR", "plm" => "PLM" ];
                                        ...
                                        ?>
                                                <tr align="center">
                                                    ...
                                                    <td scope="row">
                                                        <?php echo isset($feedback_labels[$feedback_source]) ? $feedback_labels[$feedback_source] : $feedback_source; ?>
                                                    </td>
                                                    <td scope="row">
                                                        <?php echo $referral_code; ?>
                                                    </td>
                                                    <td scope="row">
                                                        <?php echo isset($admission_year_labels[$admission_year]) ? $admission_year_labels[$admission_year] : $admission_year; ?>
                                                    </td>
                                                    <td scope="row">
                                                        <?php echo isset($method_labels[$method]) ? $method_labels[$method] : $method; ?>
                                                    </td>
