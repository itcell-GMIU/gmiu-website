...
$check_receipt_id_query = "SELECT receipt_id FROM  tbl_admission_student_2024  WHERE receipt_id IS NOT NULL LIMIT 1";
...
if ($check_receipt_id_result && mysqli_num_rows($check_receipt_id_result) > 0) {
    ...
    $latest_receipt_id_query = "SELECT MAX(CAST(SUBSTRING(receipt_id, 5) AS UNSIGNED)) AS max_id FROM  tbl_admission_student_2024 ";
