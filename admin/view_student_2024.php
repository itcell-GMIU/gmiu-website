...
if (isset($_POST['comment_btn'])) {
    ...
    $update = $con->prepare("UPDATE tbl_admission_student_2024 SET comment = ? WHERE id = ?");
...
if (isset($_POST['approved_btn'])) {
    $update = $con->prepare(
        "UPDATE tbl_admission_student_2024 SET `admission_status` = ? WHERE id = ?"
    );
...
if (isset($_POST['delete_btn'])) {
    ...
    $stmt1 = $con->prepare("UPDATE `tbl_admission_student_2024` SET is_delete = 1 WHERE id = ? ");
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        <?php
                                        $cmd = "Select stu.password,stu.admission_status,stu.id,stu.gr_number,stu.comment,stu.program_id,stu.first_name,stu.middle_name,stu.last_name,stu.email,stu.mobile_number,stu.status,stu.payment_status,stu.payment_mode,stu.account_office_status,stu.created_at,pro.name as program_name,level.name as level_name,faculty.name as faculty_name from tbl_admission_student_2024 as stu LEFT JOIN tbl_program pro
