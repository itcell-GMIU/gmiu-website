                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <h1 class="m-0">View Cancel Request Student
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">View/Cancel Request Student</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                ...
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                    <thead>
                                        <tr align="center">
                                                ...
                                                <td scope="row" style="color:black;"><b>Admission Cancel Request Reason</b></td>
                                                <th scope="row" style="color:black;"><b>Admission Status</b></th>
                                                <th scope="row" style="color:black;"><b>Documents</b></th>
                                 ...
                                 LEFT JOIN 
                                     tbl_student_document doc ON stu.id = doc.student_id
                                 WHERE 
                                     stu.is_active = 1 
                                     AND stu.is_delete = 0  
                                     AND stu.admission_status = 'cancel_request' OR stu.admission_status = 'cancel_approved' OR  stu.admission_status = 'cancel_rejected'
                                     AND stu.is_cancel = 0";
                                        ...
                                        ?>
                                                ...
                                                class="badge badge-success">' . $stu_cluster_status . '</span>';
                                                    ...
                                                    <td scope="row">
                                                        ...
                                                        <?php
                                                        } elseif ($stu_admission_status == 'cancel_approved')  {
                                                        ?>
                                                            <form action="" method="POST">
                                                                <input type="hidden" name="student_id" value="<?php echo $stu_id; ?>">
                                                                <input type="hidden" name="admission_status" value="cancel_rejected">
                                                ...
                                                class="badge badge-success">' . $stu_admission_status . '</span>';
                                                    ...
                                                    <td>
                                                    <a href="../admission/uploads/<?php echo $stu_id; ?>/<?php echo $fee_receipt; ?> " style="color:blue;" target="_blank"><button type="button" class="btn btn-success">Fee Receipt View</button></a>
                                                    <br>
                                                   <a href="../admission/uploads/<?php echo $stu_id; ?>/<?php echo $fee_receipt;?>" style="color:blue;" target="_blank"><button type="button" class="btn btn-success">Application View</button></a></td>
