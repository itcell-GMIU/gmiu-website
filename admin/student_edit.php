...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $cmd = $con->prepare("SELECT * FROM tbl_admission_student WHERE id = ?");
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $account_office_status = $row['account_office_status'];
        ...
        $payment_detail_status = $row['payment_detail_status'];
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                ...
                                <!-- form start -->
                                <form id="quickForm" method="POST" action="student_update.php">
                                    <!-- card body -->
                                    <div class="card-body">
