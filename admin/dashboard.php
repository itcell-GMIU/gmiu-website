...
<head>
    ...
    $payment_completed_students_count = $result->num_rows;
     ...
     $stmt = $con->prepare("SELECT payment_status from tbl_admission_student where payment_mode = 'offline' and account_office_status = 'approved' AND is_active=1 AND is_delete=0");
    $stmt->execute();
    $result = $stmt->get_result();
    $payment_offlinecompleted_students_count = $result->num_rows;
    ...
    // cancel admission 
    $stmt = $con->prepare("SELECT admission_status from tbl_admission_student where admission_status='cancel_request' AND is_cancel = 1 AND is_active=1 AND is_delete=0");
    $stmt->execute();
    $result = $stmt->get_result();
    $admission_cancel_students_count = $result->num_rows;
    ...
    $stmtcmd = $con->prepare("SELECT id from `tbl_cancellation_requests` where is_active=1 AND is_delete=0 AND hod_status = 'approved'");
    $stmtcmd->execute();
    $result = $stmtcmd->get_result();
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                ...
                                <a href="view_student.php?url_for=cluster_approved_student" class="small-box-footer">More info
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-danger">
                                ...
                                <a href="view_student.php?url_for=cluster_rejected_student" class="small-box-footer">More info
                                    <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                ...
                                <a href="view_student.php?url_for=admission_pending_student" class="small-box-footer">More
                                    info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                ...
                                <a href="view_student.php?url_for=admission_approved_student" class="small-box-footer">More info
                                    <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-danger">
                                ...
                                <a href="view_student.php?url_for=admission_rejected_student" class="small-box-footer">More info
                                    <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                ...
                                <a href="view_student.php?url_for=payment_pending" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            <!-- small box -->
                         ...
                         <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                <div class="inner">
                                    <h3><?php echo "$payment_offlinecompleted_students_count"; ?>
                                        <!-- <sup style="font-size: 20px">%</sup> -->
                                    </h3>

                                    <p>Offline Payment students</p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-person-add"></i>
                                </div>
                                <a href="view_student.php?url_for=payment_offline" class="small-box-footer">More info
                                    <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h3><?php echo "$admission_cancel_students_count"; ?></h3>

                                    <p>admission cancel Students</p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-person-add"></i>
                                </div>
                                <a href="admission_cancel_students.php" class="small-box-footer">More
                                    info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
