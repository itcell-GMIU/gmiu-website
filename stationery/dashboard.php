...
<head>
    ...
    $stmt = $con->prepare("SELECT id from tbl_admission_student where uniform_status = 0 AND is_active=1 AND is_delete=0");
    $stmt->execute();
    $result = $stmt->get_result();
    $uniform_status_pending = $result->num_rows;

    $stmt = $con->prepare("SELECT id from tbl_admission_student where uniform_status = 1 AND is_active=1 AND is_delete=0");
    $stmt->execute();
    $result = $stmt->get_result();
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                ...
                                <a href="view_student.php?url_for=pending"
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                ...
                                <a href="view_student.php?url_for=approved"
                                    class="small-box-footer">More
                                    info
                                    <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
