                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr align="center">
                                                    ...
                                                    <td scope="row"><?php
                                                                    $cmd = "SELECT `regular`, `genius`, `honors`, `international`, `minor` ,`blended_mode`,`token` ,`token_minor` , `token_genius` ,`token_international` , `token_honors` ,`token_blended_mode` FROM `tbl_program` WHERE `id`=? AND `faculty_id`=? AND `level_id`=?";
                                                                    $stmt = $con->prepare($cmd);
                                                                    $stmt->bind_param("iii", $stu_program_id, $stu_faculty_id, $stu_level_id);
                                                                    $stmt->execute();
                                                                    $result = $stmt->get_result();
