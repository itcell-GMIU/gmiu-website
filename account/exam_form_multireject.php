            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                ...
                                                <select class="form-control select2option" name="exam_id" required id="exam_id" >
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <!-- Reject ALL button Coding -->
                            <!-- Add this above the <table> section -->
                                <form method="POST" action="reject_selected_students.php">
                                    <input type="hidden" name="exam_id" value="<?= $exam_id ?>">
                                    <button type="submit" class="btn btn-danger mb-2">Reject Selected</button>
                                ...
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped">
                                    <thead>
                                        <tr align="center">
                                            ...
                                            <th style="color:black;"><b>Select</b></th>
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        ?>
                                                ...
                                                <tr align="center">
                                                    ...
                                                    <td scope="row"><input type="checkbox" name="selected_students[]" value="<?= $id ?>"></td>
