...
if (isset($_POST['submit'])) {
    ...
    $fees = $_POST['fees'];
        ...
        $stmt = $con->prepare("INSERT INTO `tbl_competetion`(name,file,fees) VALUES (?,?,?)");
        $stmt->bind_param("sss", $title, $document,$fees);
        $result = $stmt->execute();
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Add Competitions</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Add Competitions</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                <div class="card-header">
                                    <h3 class="card-title">Add Competitions</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <!-- form start -->
