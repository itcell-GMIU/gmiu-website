...
if (isset($_POST['btn-login'])) {
    ...
    $cmd = $con->prepare("SELECT role_id, `id` as staff_id, `email` as staff_email from tbl_admin  WHERE email=? AND password= ? AND role_id= ? AND is_active=1 AND is_delete=0");
