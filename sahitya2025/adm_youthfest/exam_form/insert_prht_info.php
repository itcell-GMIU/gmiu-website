...
if (isset($_POST['submit'])) {
    ...
    $stmt = $con->prepare("INSERT INTO tbl_exam_assets(`id`,`instructions`) VALUES (2,?)");
    ...
    if ($result1) {
        ...
        echo "<script>setTimeout(function(){window.location='insert_prht_info.php'},1000)</script>";
    } else {
...
if (isset($_POST['update'])) {
    ...
    $des = $_POST['description'];
    // Insert the JSON data into the database
    $stmt = $con->prepare("UPDATE `tbl_exam_assets` SET instructions = ? where id = 2");
    $stmt->bind_param("s", $des);
    $result = $stmt->execute();
    // Error handling if insertion fails
    if ($result) {
...
$cmd = $con->prepare("SELECT instructions FROM tbl_exam_assets where id = 2");
$cmd->execute();
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Add Practical Hall Ticket Info</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Add Practical Hall Ticket Info</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                <div class="card-header">
                                    <h3 class="card-title">Add Practical Hall Ticket Info</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                            ...
                            ?>
                                <div class="card card-gmiu mt-3">
                                    <div class="card-header">
                                        <h3 class="card-title">Update Practical Hall Ticket Info</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form id="quickForm" method="POST" enctype="multipart/form-data">
