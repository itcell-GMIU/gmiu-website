                                    ...
                                    <tbody class="tbody">
                                        ...
                                        if (isset($_GET['exam_id']) && isset($_GET['report_type'])) {
                                            if ($_GET['report_type'] == "all") {
                                                $query = "SELECT id, seat_no,enrollnment_no, status FROM tbl_exam_student WHERE exam_id = ?";
                                                ...
                                                $query = "SELECT id, seat_no,enrollnment_no, status FROM tbl_exam_student WHERE exam_id = ? and status = ?";
                                                $stmt = $con->prepare($query);
