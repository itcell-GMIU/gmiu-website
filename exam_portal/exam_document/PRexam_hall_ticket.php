            ...
            <div class="receipt-container">
                <div class="row">
                    ...
                    <div class="col-8 text-center border border-dark">
                        ...
                        <div class="row">
                            <h4 class="mx-auto">-:: PRACTICAL HALL TICKET ::-</h4>
                        </div>
                    </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        while ($row2 = $result2->fetch_assoc()) {
                                            ...
                                            foreach ($subjectArray as $subject_code) {
                                                $examtt = $con->prepare("SELECT `subject_code`, `date` FROM `tbl_exam_timetable` WHERE `subject_code`= ? AND `sub_type`= 'Practical' and exam_id = ?");
                                            ...
                                            $subjectArray = explode(', ',  $subject_codes);
                                            foreach ($subjectArray as $subject_code) {
                                                $examtt = $con->prepare("SELECT `subject_code` FROM `tbl_exam_timetable` WHERE `subject_code`= ? and `sub_type`= 'Practical' and exam_id = ?");
                                                $examtt->bind_param("si", $subject_code, $exam_id);
                                                $examtt->execute();
                                                $examttres = $examtt->get_result();
                                                while ($rowtt = $examttres->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                            ...
                                            $subjectArray = explode(', ',  $subject_codes);
                                            foreach ($subjectArray as $subject_code) {
                                                $examtt = $con->prepare("SELECT `date` FROM `tbl_exam_timetable` WHERE `subject_code`= ? and `sub_type`= 'Practical' and is_active = 1 and exam_id = ?");
                                                $examtt->bind_param("si", $subject_code, $exam_id);
                                                $examtt->execute();
                                                $examttres = $examtt->get_result();
                                                while ($rowtt = $examttres->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                            ...
                                            $subjectArray = explode(', ',  $subject_codes);
                                            foreach ($subjectArray as $subject_code) {
                                                $examtt = $con->prepare("SELECT `start_time`, `end_time` FROM `tbl_exam_timetable` WHERE `subject_code`= ? and `sub_type`= 'Practical' and is_active = 1 and exam_id = ?");
                                                $examtt->bind_param("si", $subject_code, $exam_id);
                                                $examtt->execute();
                                                $examttres = $examtt->get_result();
                                                while ($rowtt = $examttres->fetch_assoc()) {
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        foreach ($subject_codes as $subject_code) {
                                            $examtt = $con->prepare("SELECT `date` FROM `tbl_exam_timetable` WHERE `subject_code`= ? and `sub_type`= 'Practical' and exam_id = $exam_id and is_active = 1");
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                        foreach ($subject_codes as $subject_code) {
                                            $examtt = $con->prepare("SELECT `start_time`, `end_time` FROM `tbl_exam_timetable` WHERE `subject_code`= ? and `sub_type`= 'Practical' and exam_id = $exam_id and is_active = 1");
                                            $examtt->bind_param("s", $subject_code);
                                            $examtt->execute();
                                            $examttres = $examtt->get_result();
                                            while ($rowtt = $examttres->fetch_assoc()) {
