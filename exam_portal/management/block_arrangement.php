...
if (isset($_POST['submit'])) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if ($sub_code != $prevSubCode || $srCount % 30 == 0 || $exam_id != $prevExamId) {
            $blockNo++;
        }
    ...
    $button_echo = '<div class="col-sm-3">
    <a href="view_block.php?dt=' . $ex_dt . '&st=' . $shift . '" class="btn btn-success w-100"><i class="fa fa-th"></i> Block Arrangement</a>
    </div>
    <div class="col-sm-3">
        <a href="view_form_one.php?dt=' . $ex_dt . '&st=' . $shift . '" class="btn btn-success w-100"><i class="fa fa-file"></i> Form 1</a>
    </div>
    <div class="col-sm-3">
    <a href="view_nc_block.php?dt=' . $ex_dt . '&st=' . $shift . '&clg=MHV" class="btn btn-success w-100"><i class="fa fa-th"></i> Block (Mahuva)</a>
    </div>
    <div class="col-sm-3">
        <a href="view_nc_form_one.php?dt=' . $ex_dt . '&st=' . $shift . '&clg=MHV" class="btn btn-success w-100"><i class="fa fa-file"></i> Form 1 (Mahuva)</a>
    </div>';
}
