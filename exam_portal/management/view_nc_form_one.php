                        ...
                        <div class="col-md-12">
                            <div class="card card-gmiu">
                                ...
                                <div class="card-body">
                                    <?php
                                    $status = 0;
                                    $cmd = $con->prepare("SELECT * FROM tbl_exam_timetable WHERE is_delete = ? AND date = ? $shiftQ ;");
                                    ...
                                    ?>
                                        ...
                                        <div class="row mt-3">
                                            <p>I hereby declare that I have verified above mentioned details and also declare that students have returned these answer books and supplementary as mentioned above.</p>
                                            <p>
                                            Total Answerbook Used:_______ Total Supplementary Used:_______ Sign of Jr. Supervisor___________ Sign of Sr. Supervisor___________
Name of Jr. Sup. ______________ Name of Sr. Sup.
______________
                                            </p>
                                        </div>';
                                                }
