        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Exam Assessment</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Exam Assessment</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <span>
                                <center>
                                    <h5><b><i class="fas fa-book-reader"></i>Exam Assessment</b></h5>
                                </center>
                            </span>
                        </div>
                                    ...
                                    <div class="form-row">
                                            ...
                                            <div class="form-label-group">
                                                ...
                                                <select class="form-control browser-default custom-select" name="exam_id" required id="exam_id">
                                                    ...
                                                    $cmd = $con->prepare("SELECT std.id as id, std.faculty_id as faculty_id, std.level_id as level_id, std.program_id as program_id, std.semester as semester, std.is_active as std_is_active, std.type as type , std.session as session , std.start_date as start_date, std.end_date as end_date, std.year as year,
                                                        ...
                                                        LEFT JOIN tbl_program program ON std.program_id = program.id WHERE std.is_delete = ? AND std.result_status = 1 AND std.semester IN (2,4)");
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control browser-default custom-select" name="report_type" id="report_type">
                                                ...
                                                <option value="1" <?= $pending ?>>Recheck</option>
                                                <option value="2" <?= $completed ?>>Reassessment</option>
                                            </select>
                                        </div>
                                ...
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped">
                                    <thead>
                                        <tr align="center">
                                            ...
                                            <th style="color:black;"><b>Assessment Subjects</b></th>
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        if (isset($_GET['exam_id'])) {
                                            if ($_GET['report_type'] != "") {
                                                $query = "SELECT id, enrollnment_no, status, is_pass, total_backlog , exam_sgpa, exam_cgpa, subject_code FROM tbl_exam_reassement WHERE exam_id = ? and assesment_type IN (?) AND status = 1";
                                                $stmt = $con->prepare($query);
                                                $stmt->bind_param("ii", $exam_id, $report_type);
                                                $stmt->execute();
                                                $result = $stmt->get_result();
                                            } else {
                                                $query = "SELECT id, enrollnment_no, status, is_pass, total_backlog , exam_sgpa, exam_cgpa, subject_code FROM tbl_exam_reassement WHERE exam_id = ? AND status = 1";
                                                $stmt = $con->prepare($query);
                                        ...
                                        ?>
                                                ...
                                                <tr align="center">
                                                    ...
                                                    <td scope="row"><a href="update_marks.php?assid=<?= $id ?>" class="btn btn-info"><i class="fa fa-edit"></i></a></td>
                                                </tr>
                                            ...
                                            $one = 1;
                                            $query = "SELECT id, enrollnment_no, status, is_pass, total_backlog , exam_sgpa, exam_cgpa, subject_code, assesment_type FROM tbl_exam_reassement WHERE status = ?";
                                            $stmt = $con->prepare($query);
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                if ($assesment_type == 1) {
                                                    $echo_status = '<span class="badge badge-primary">Re-check</span>';
                                                } elseif ($assesment_type == 2) {
                                                    $echo_status = '<span class="badge badge-info">Re-assessment</span>';
                                                }
