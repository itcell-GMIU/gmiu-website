                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="table-responsive">
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped">
                                    <thead>
                                        <tr align="center">
                                            <th style="color:black;"><b>Agency Control Number</b></th>
                                            ...
                                            $semi = 1;
                                            while ($semi < 11) { ?>
                                                <th style="color:black;"><b>CC<?= $semi ?></b></th>
                                                <th style="color:black;"><b>CN<?= $semi ?></b></th>
                                                <th style="color:black;"><b>Credit<?= $semi ?></b></th>
                                                <th style="color:black;"><b>SA<?= $semi ?></b></th>
                                                <th style="color:black;"><b>SEE_T<?= $semi ?></b></th>
                                                <th style="color:black;"><b>SEE_P<?= $semi ?></b></th>
                                                <th style="color:black;"><b>CCE_M<?= $semi ?></b></th>
                                                <th style="color:black;"><b>CCE_I<?= $semi ?></b></th>
                                                <th style="color:black;"><b>CCE_V<?= $semi ?></b></th>
                                                <th style="color:black;"><b>CG<?= $semi ?></b></th>
                                                <th style="color:black;"><b>CP1<?= $semi ?></b></th>
                                            <?php $semi++;
                                            } ?>


                                            <th style="color:black;"><b>Credit Offsered</b></th>
                                            <th style="color:black;"><b>Credits Earned</b></th>
                                            <th style="color:black;"><b>Credits Points Earned</b></th>
                                            <th style="color:black;"><b>SGPA</b></th>
                                            <th style="color:black;"><b>BACKLOG 1</b></th>
                                            <th style="color:black;"><b>BACKLOG 2</b></th>
                                            <th style="color:black;"><b>BACKLOG 3</b></th>
                                            <th style="color:black;"><b>BACKLOG 4</b></th>
                                            <th style="color:black;"><b>BACKLOG 5</b></th>
                                            <th style="color:black;"><b>BACKLOG 6</b></th>
                                            <th style="color:black;"><b>BACKLOG 7</b></th>
                                            <th style="color:black;"><b>BACKLOG 8</b></th>
                                            <th style="color:black;"><b>Credits Offred</b></th>
                                            <th style="color:black;"><b>Credits Earned</b></th>
                                            <th style="color:black;"><b>Credit Points Offered</b></th>
                                            <th style="color:black;"><b>Credit Points Earned</b></th>
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        if (isset($_GET['exam_id'])) {
                                            ...
                                            $monthdata = mysqli_fetch_assoc(mysqli_query($con, "SELECT date FROM tbl_exam_timetable WHERE exam_id = $exam_id AND is_active = 1 ORDER BY date ASC LIMIT 1"));

                                            // Convert the date to a timestamp
                                            $timestamp = strtotime($monthdata['date']);

                                            // Extract the month name and year
                                            $monthName = date("F", $timestamp); // Full month name, e.g., October

                                            $crud->readSingleRecordColumn("tbl_exam_form", "type", ["id" => $exam_id, "is_active" => 1], $extype);

                                            $query = "SELECT * FROM tbl_exam_student WHERE exam_id = ? AND status IN (3)";
                                        ...
                                        ?>
                                                ...
                                                <tr align="center">
                                                    ...
                                                    <td style="color:black;"><?= $monthName . '-' . $exd['year'] ?></td>
                                                    ...
                                                    <td scope="row">
                                                        <?php
                                                        if ($extype == 'remedial') {
                                                            echo intval($semester_data[$exd_sem]['total_credit']);
                                                        } else {
                                                            echo intval($total_credit);
                                                        }
                                                        ?>
                                                    </td>
                                                    <td scope="row">
                                                        <?php
                                                        $conditions = array("is_active" => 1, "exam_id" => $exam_id, "enrollnment_no" => $enrollnment_no, "seat_no" => $seat_no, "status" => 0);

                                                        $records = $crud->readRecordsWithConditions("tbl_final_exam_results", $conditions);
                                                        $cred_minus = 0;
                                                        if (is_array($records)) {
                                                            foreach ($records as $rc) {
                                                                $scode = $rc['subject_code'];
                                                                $crud->readSingleRecordColumn("tbl_subject_master", "credit", ["subject_code" => $scode, "is_active" => 1], $credm);
                                                                $cred_minus = $cred_minus + $credm;
                                                            }
                                                        }
                                                        if ($extype == 'remedial') {
                                                            echo intval($semester_data[$exd_sem]['total_credit']) - $cred_minus;
                                                        } else {
                                                            echo intval($total_credit) - $cred_minus;
                                                        }
                                                        ?>
                                                    </td>
                                                    <td scope="row">
                                                    ...
                                                    <td scope="row">
                                                        <?php
                                                        $query_sem_data_cred = "
                                                        SELECT b.*, fe.subject_code as fe_sub
                                                        FROM tbl_exam_backlogs b
                                                        JOIN tbl_exam_form f ON b.exam_id = f.id
                                                        JOIN tbl_final_exam_results fe ON b.exam_id = fe.exam_id 
                                                            AND b.enrollnment_no = fe.enrollnment_no
                                                        WHERE b.enrollnment_no = '$enrollnment_no'
                                                        AND fe.status = 0
                                                        AND (
                                                            (b.semester = $exd_sem AND (
                                                        ...
                                                        // Execute the query
                                                        $result_sem_data_cred = mysqli_query($con, $query_sem_data_cred);
                                                        $cred_minus2 = 0;
                                                        if ($result_sem_data_cred && mysqli_num_rows($result_sem_data_cred) > 0) {
                                                            while ($rc2 = mysqli_fetch_assoc($result_sem_data_cred)) {
                                                                $scode2 = $rc2['fe_sub'];
                                                                $crud->readSingleRecordColumn("tbl_subject_master", "credit", ["subject_code" => $scode2, "is_active" => 1], $credm2);
                                                                $cred_minus2 = $cred_minus2 + $credm2;
                                                            }
                                                        }


                                                        // $conditions2 = array("is_active" => 1, "enrollnment_no" => $enrollnment_no, "status" => 0);

                                                        // $records2 = $crud->readRecordsWithConditions("tbl_final_exam_results", $conditions2);
                                                        // $cred_minus2 = 0;
                                                        // if (is_array($records2)) {
                                                        //     foreach ($records2 as $rc2) {
                                                        //         $scode2 = $rc2['subject_code'];
                                                        //         $crud->readSingleRecordColumn("tbl_subject_master", "credit", ["subject_code" => $scode2, "is_active" => 1], $credm2);
                                                        //         $cred_minus2 = $cred_minus2 + $credm2;
                                                        //     }
                                                        // }
                                                        ...
                                                        if ($extype == 'remedial') {
                                                            echo  intval($semester_data[$exd_sem]['total_credit']) - $cred_minus2;
                                                        } else {
                                                            echo intval($total_credit) - $cred_minus;
                                                        }
                                                        ?>
                                                    ...
                                                    <td scope="row">
                                                        <?php
                                                        echo  intval($semester_data[$exd_sem]['total_credit']) * 10;
                                                        ?>
                                                    </td>
                                                    <td scope="row">
                                                        <?php
