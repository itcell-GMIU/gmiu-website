                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-row">
                                                            <div class="form-label-group d-flex mx-auto">
                                                                <input id="" type="number" class="form-control" name="marks" placeholder="Enter Mark">

                                                                <input type="text" class="form-control" name="brCode" value="<?= $std_er ?>" hidden>

                                                                <button type="submit" name="submit" class="ml-2 btn btn-success btn-block" id="export" style="float:center" onclick="myFunction()"><i class="fa fa-lock"></i> Lock Mark</button>
                                                            </div>
