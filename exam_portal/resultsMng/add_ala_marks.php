...
if (isset($_POST['update'])) {
    ...
    foreach ($idNEW as $in) {
        ...
        $stmt = $con->prepare("UPDATE tbl_exam_results SET Mala = ?, UpMala = ? WHERE id = ? ");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">ALA MARKS</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">ALA MARKS</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <span>
                                <center>
                                    <h5><b><i class="fa fa-check-square-o"></i> ALA MARKS</b></h5>
                                </center>
                            </span>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <?php
                            $query33 = "SELECT `entALA`, `passALA` FROM tbl_mi_subject_master WHERE subject_code = ?";
                            ...
                            while ($row33 = $result33->fetch_assoc()) {
                                $passingMark = $row33['entALA'];
                                $passingMark = intval($passingMark);

                                $minimumMark = $row33['passALA'];
                                $minimumMark = intval($minimumMark);
                            ?>
                                <table class="table table-bordered mb-3">
                                    <thead>
                                        <tr>
                                            <th>Enter From : <?= $row33['entALA'] ?></th>
                                            <th>Passing Marks : <?= $row33['passALA'] ?></th>
                                        </tr>
                                    </thead>
                                </table>
                            <?php
                                ...
                                <table class="table table-bordered">
                                    <tbody class="tbody">
                                        ...
                                        if (isset($_GET['exm']) && isset($_GET['sbj']) && $ex_type == 'remedial') {
                                            ...
                                            $query22 = "SELECT exam_id,subject_code, enrollnment_no, id, Mala, UpMala, Mrmid FROM tbl_exam_results WHERE exam_id = ? AND subject_code = ? AND (Mala < $minimumMark OR Mala = 'AB' OR Mala IS NULL) ORDER BY enrollnment_no ASC";
                                        } else {
                                            $query22 = "SELECT exam_id,subject_code, enrollnment_no, id, Mala, UpMala FROM tbl_exam_results WHERE exam_id = ? AND subject_code = ? ORDER BY enrollnment_no ASC";
                                        }
                                        ...
                                        while ($row22 = $result22->fetch_assoc()) {
                                            ...
                                            if ($role_id == 51 || $upmidStat < 2) {
                                                ...
                                                if (isStudentStatusThree($student_id, $exm_id)) {
                                                    ...
                                                    // if ($row22['Mala']  == "" || $row22['Mala']  == NULL || empty($row22['Mala'])) {
                                                    if ($ex_type == 'remedial') {
