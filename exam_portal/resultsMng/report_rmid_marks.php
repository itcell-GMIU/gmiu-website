                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="acedemic" class="dataTableLoad table table-bordered table-striped">
                                ...
                                <tbody class="tbody">
                                    <?php
                                    $query22 = "SELECT subject_code, enrollnment_no, id, Mrmid FROM tbl_exam_results WHERE exam_id = ? AND subject_code = ?";
                                    ...
                                    while ($row22 = $result22->fetch_assoc()) {
                                        ...
                                        if ($row22['Mrmid']  != "" || $row22['Mrmid']  != NULL || !empty($row22['Mrmid'])) {
                                    ?>
                                            <tr>
                                                ...
                                                <td><?= $row22['Mrmid'] ?></td>
                                                <td><?php
                                                    if ($row22['Mrmid'] < $passMSE  && $row22['Mrmid'] != "AB") {
                                                        echo  '<span class="badge badge-warning">Fail</span>';
                                                    } elseif ($row22['Mrmid'] >= $passMSE && $row22['Mrmid'] != "AB") {
                                                        echo  '<span class="badge badge-success">Pass</span>';
                                                    } elseif ($row22['Mrmid'] == "AB") {
