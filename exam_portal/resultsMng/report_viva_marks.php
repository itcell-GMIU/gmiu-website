        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">VIVA MARKS REPORT</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">VIVA MARKS REPORT</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <span>
                                <center>
                                    <h5><b><i class="fa fa-check-square-o"></i> VIVA MARKS REPORT</b></h5>
                                </center>
                            </span>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            while ($row33 = $result33->fetch_assoc()) {
                                $entVIVA = $row33['entVIVA'];
                                $entVIVA = intval($entVIVA);

                                $passVIVA = intval($row33['passVIVA']);
                            }
                            ?>
                            <table id="acedemic" class="dataTableLoad table table-bordered table-striped">
                                ...
                                <tbody class="tbody">
                                    <?php
                                    $query22 = "SELECT subject_code, enrollnment_no, id, Mviva FROM tbl_exam_results WHERE exam_id = ? AND subject_code = ?";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?= $row22['Mviva'] ?></td>
                                                <td><?php
                                                    if ($row22['Mviva'] < $passVIVA  && $row22['Mviva'] != "AB") {
                                                        echo  '<span class="badge badge-warning">Fail</span>';
                                                    } elseif ($row22['Mviva'] >= $passVIVA && $row22['Mviva'] != "AB") {
                                                        echo  '<span class="badge badge-success">Pass</span>';
                                                    } elseif ($row22['Mviva'] == "AB") {
