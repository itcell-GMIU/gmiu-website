                                ...
                                <table class="table table-bordered">
                                    <tbody class="tbody">
                                        ...
                                        if (isset($_GET['exm']) && isset($_GET['sbj']) && $ex_type == 'remedial') {
                                            ...
                                            $query22 = "SELECT subject_code, enrollnment_no, id, Mmid, UpMmid, Mrmid FROM tbl_exam_results WHERE exam_id = ? AND subject_code = ? AND ((Mmid <= $minimumMark OR Mmid = 'AB') OR (Mrmid <= $minimumMark OR Mrmid = 'AB')) ORDER BY enrollnment_no ASC";
                                        } else {
                                            $query22 = "SELECT subject_code, enrollnment_no, id, Mmid, UpMmid, Mrmid FROM tbl_exam_results WHERE exam_id = ? AND subject_code = ? ORDER BY enrollnment_no ASC";
                                        }
                                        ...
                                        while ($row22 = $result22->fetch_assoc()) {
                                            ...
                                            if (intval($row22['Mrmid']) > intval($row22['Mmid'])) {
                                                $MidMark = $row22['Mrmid'];
                                            } else {
                                                $MidMark = $row22['Mmid'];
                                            }

                                            $upmidStat = $row22['UpMmid'];
