...
if (isset($_POST['update'])) {
    ...
    foreach ($idNEW as $in) {
        ...
        $stmt = $con->prepare("UPDATE tbl_exam_results SET Mpractical = ?, UpMpractical = ? WHERE id = ? ");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">PRACTICAL MARKS</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <span>
                                <center>
                                    <h5><b><i class="fa fa-check-square-o"></i> PRACTICAL MARKS</b></h5>
                                </center>
                            </span>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <?php
                            $query33 = "SELECT `entPRACTICAL`, `passPRACTICAL` FROM tbl_mi_subject_master WHERE subject_code = ?";
                            ...
                            while ($row33 = $result33->fetch_assoc()) {
                                $passingMark = $row33['entPRACTICAL'];
                                $passingMark = intval($passingMark);

                                $minimumMark = $row33['passPRACTICAL'];
                                $minimumMark = intval($minimumMark);
                            ?>
                                <table class="table table-bordered mb-3">
                                    <thead>
                                        <tr>
                                            <th>Enter From : <?= $row33['entPRACTICAL'] ?></th>
                                            <th>Passing Marks : <?= $row33['passPRACTICAL'] ?></th>
                                        </tr>
                                    </thead>
                                </table>
                            <?php
                            ...
                            <form action="" class="form" method="post" id="myForm">
                                <table class="table table-bordered">
                                    <tbody class="tbody">
                                        ...
                                        if (isset($_GET['exm']) && isset($_GET['sbj']) && $ex_type == 'remedial') {
                                            ...
                                            $query22 = "SELECT exam_id, subject_code, enrollnment_no, id, Mpractical, UpMpractical, Mrmid FROM tbl_exam_results WHERE exam_id = ? AND subject_code = ? AND (Mpractical < $minimumMark OR Mpractical = 'AB' OR Mpractical IS NULL) ORDER BY enrollnment_no ASC";
                                        } else {
                                            $query22 = "SELECT exam_id, subject_code, enrollnment_no, id, Mpractical, UpMpractical FROM tbl_exam_results WHERE exam_id = ? AND subject_code = ? ORDER BY enrollnment_no ASC";
                                        }
                                        ...
                                        while ($row22 = $result22->fetch_assoc()) {
                                            ...
                                            if (isStudentStatusThree($student_id, $exm_id)) {
                                                ...
                                                $MidMark = $row22['Mpractical'];

                                                if ($role_id == 51 || $upmidStat < 2) {

                                                    // if ($row22['Mpractical']  == "" || $row22['Mpractical']  == NULL || empty($row22['Mpractical'])) {
                                                    if ($ex_type == 'remedial') {

                                                        if (($MidMark === NULL)  || empty($MidMark) || is_null($MidMark) || ($MidMark < $minimumMark)) {
                                        ...
                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <label for="">
                                                                        <input type="checkbox" name="is_absent[]" value="<?= $row22['id'] ?>"> <b> Yes</b>
                                                                    </label>
                                                                </td>
                                                            </tr>
                                                        <?php
                                ...
                                <div class="text-center">
                                    ...
                                    ?>
                                        <div class="badge badge-warning">This Mark is Locked Already</div>
                                    <?php
                                    } else {
                                    ?>
