...
// $allowed_ips = array('2409:40c1:101f:1d2d:546a:d507:d3ac:1edf', '136.232.127.118'); // Add your allowed IP addresses here

// // Check if the request originates from an allowed IP address
// if (!in_array($_SERVER['REMOTE_ADDR'], $allowed_ips)) {
//     http_response_code(403); // Forbidden
//     exit("Under Maintanance");
// }
...
if (isset($_POST['update'])) {
    ...
    foreach ($idNEW as $in) {
        ...
        $stmt = $con->prepare("UPDATE tbl_exam_results SET Mmid = ?, UpMmid = ? WHERE id = ? ");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">MID MARKS</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">MID MARKS</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <span>
                                <center>
                                    <h5><b><i class="fa fa-check-square-o"></i> MID MARKS</b></h5>
                                </center>
                            </span>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <form action="" class="form" method="post" id="myForm">
                                <table class="table table-bordered">
                                    <tbody class="tbody">
                                        ...
                                        if (isset($_GET['exm']) && isset($_GET['sbj']) && $ex_type == 'remedial') {
                                            $query22 = "SELECT exam_id,subject_code, enrollnment_no, id, Mmid, UpMmid, Mrmid FROM tbl_exam_results WHERE exam_id = ? AND subject_code = ? AND ((Mmid < $minimumMark OR Mmid = 'AB' OR Mmid IS NULL) OR (Mrmid < $minimumMark OR Mrmid = 'AB' OR Mrmid IS NULL)) ORDER BY enrollnment_no ASC";
                                        } else {
                                            $query22 = "SELECT subject_code, enrollnment_no, id, Mmid, UpMmid, Mrmid, exam_id FROM tbl_exam_results WHERE exam_id = ? AND subject_code = ? ORDER BY enrollnment_no ASC";
                                        }
                                        ...
                                        while ($row22 = $result22->fetch_assoc()) {
                                            ...
                                            if (isStudentStatusThree($student_id, $exm_id)) {
                                                ...
                                                if ($row22['Mrmid'] > intval($row22['Mmid'])) {
                                                    $MidMark = $row22['Mrmid'];
                                                } else {
                                                    $MidMark = $row22['Mmid'];
                                                }
                                                ...
                                                if ($role_id == 51 || $upmidStat < 2) {
                                                    ...
                                                    if ($ex_type == 'remedial') {
                                                        ...
                                                        if (($MidMark === NULL) || ($MidMark == 'AB')  || empty($MidMark) || is_null($MidMark) || ($MidMark < $minimumMark)) {
                                ...
                                <div class="text-center">
                                    ...
                                    ?>
                                        <div class="badge badge-warning">This Mid Mark is Locked Already</div>
                                    <?php
                                    } else {
                                    ?>
