...
/* if ($stu_cluster_status == "submitted" || $stu_cluster_status == "approved") {
...
<body>
    ...
    <section class="Welcome-area new_responsive_method">
        ...
        <div class="container_new">
            ...
            <div class="row">
                <form id="final_submit" method="POST">
                        ...
                        <table class="table table-bordered" id="table-resp">
                            <thead>
                                <tr>
                                    <td colspan="6">
                                        <center>
                                            <h4> Please Review the below mentioned details<h4>
                                        </center>
                                    </td>
                                    <!--   <td colspan="6">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="6" class="text-center bgChange">
                                        Student Details</td>
                                </tr>
                            </tbody>
                            <tbody>
                            ...
                            <tbody>
                                <tr>
                                    <th colspan="6" class="text-center bgChange">Declaration</th>
                                </tr>
                            </tbody>
                            <tbody>
                                <tr>
                                    <th colspan="6">
                                        <ul>
                                            <input type="checkbox" class="btn btn-primary" data-toggle="modal"
                                                name="accept_declaration1" data-target="#exampleModalCenter" required>
                                            <label for="accept_declaration"> Accept Terms and Condition</label><br>


                                            <div style="height:100%; padding-top:100px;" class="modal fade"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <h3>
                                                                <h4>
                                                                    <p>
                                                                        <b>1.</b> I certify that the information
                                                                        submitted
                                                                        by me
                                                                        in support of this application is true to the
                                                                        best
                                                                        of
                                                                        knowledge and belief understand that in the
                                                                        event of
                                                                        any
                                                                        information being found false or incorrect, my
                                                                        admission
                                                                        is liable to be rejected/cancelled at any stage
                                                                        of
                                                                        the
                                                                        program. I undertake to abide by the
                                                                        disciplinary
                                                                        rules
                                                                        and regulation of the institute.
                                                                    </p>
                                                                </h4>
                                                            </h3>
                                                            <h3>
                                                                <h4>
                                                                    <p>
                                                                        <b>2.</b> We are aware that tuition fees are
                                                                        prescribed
                                                                        by FEES regulatory committee and are subject to
                                                                        revision, thus, we undertake to pay the
                                                                        difference,
                                                                        if
                                                                        any, as and when prescribed by the committee.
                                                                    </p>
                                                                </h4>
                                                            </h3>
                                                            <h3>
                                                                <h4>
                                                                    <p>
                                                                        <b>3.</b> We declare that my ward shall attain
                                                                        minimum
                                                                        attendance as per university norms so as to be
                                                                        eligible
                                                                        for appearing in the mid-semester examination
                                                            ...
                                                            <h3>
                                                                <h4>
                                                                    <p>
                                                                        <b>4.</b> We declare that any information found
                                                                        incorrect may lead to the cancellation of my
                                                                        admission.
                                                                    </p>
                                                                </h4>
                                                            </h3>
                                                            <h3>
                                                                <h4>
                                                                    <p>
                                                                        <b>5.</b> I certify that the previous boards are
                                                                        reflected as invalid then we are aware that the
                                                                        admission stands cancel without any explanations
                                                                        form
                                                                        the concerned college authority.
                                                                    </p>
                                                                </h4>
                                                            </h3>
                                                            <h3>
                                                                <h4>
                                                                    <!--  <p>
                                                                        <b>6.</b> I also read refund policy of
                                                                        university I
                                                                        am
                                                                        agree with that. Read refund policy click here:
                                                                        <a target="_blank"
                                                                            href="refund_policy.php">link</a>
                                                                    </p> -->
                                                                </h4>
                                                            </h3>
                                                        </div>
                    ...
                    <center><button style="background-color:#ba2a21;" type="submit"
                            class="btn btn-danger final_submit_btn">Save
                            and
                            Final Submit</button>
                    </center>
                </form>
...
$("#final_submit").on('submit', function(e) {
    ...
    var api_for = "final_submit";

    var formData = new FormData(document.getElementById("final_submit"));
    ...
    $.ajax({
        ...
        success: function(data) {
            //  alert(data.status);
            if (data.status == 200) {
                Swal.fire('Submitted Successfully,Wait for approval.', 'success');
                location.href = "application_status.php";
            } else {
