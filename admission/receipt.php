...
if ($check_receipt_id_result && mysqli_num_rows($check_receipt_id_result) > 0) {
    ...
    if ($latest_receipt_id_result && mysqli_num_rows($latest_receipt_id_result) > 0) {
        ...
        $new_receipt_id = 'GMIU' . str_pad($student_id, 3, '0', STR_PAD_LEFT);
    } else {
...
// Continue with your code to print the receipt using $new_receipt_id
?>
                                        ...
                                        <div class="side-by-side-content">
                                            ...
                                            <ul class="list-unstyled mb0 print-right-side" style="margin-top: -11px;">
                                               ...
                                               <li class="padding-all">
                                                    Session : 
                                                    <?php 
                                                        echo isset($admission_year_labels[$admission_year]) 
                                                            ? $admission_year_labels[$admission_year] 
                                                            : "$session"; 
                                                    ?>
                                                </li>
