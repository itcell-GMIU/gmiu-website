                            ...
                            <div class="col-lg-12">
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="side-by-side-content">
                                            ...
                                            <ul class="list-unstyled mb0 print-right-side" style="margin-top: -11px;">
                                                ...
                                                <li class="padding-all">Session : 2023-24</li>
                                ...
                                <table class="table table-bordered rj">
                                    ...
                                    <tbody>
                                        ...
                                        <tr> <td colspan="4">*This is provisional Admission.Final admission will be confirmed subject to approval by Admission committee/University.</td></tr>
                                        <tr> <td colspan="4">*If at any stage of the admissions process, it is found that applicant does not meet the eligibility criteria as per ACPC or University rules or that the information furnished by him/her
is incorrect, then such applications will be eliminated from admission process.
</td></tr>
                                        <tr> <td colspan="4">*Applicants submitting the application form of any program/course to University are advised to have read the rules and policies related to eligibility,
provisional admission, cancellation of admission and refund of fees.</td></tr>
                                ...
                                <button onclick="window.print()" class="print-btn"><i
