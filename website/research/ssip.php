...
<head>
    <?php $pageTitle = "SSIP | Gyanmanjari Innovative University | GMIU";?>
    <?php $meta_description = "Discover SSIP at GMIU: Supporting student startups, innovation, and entrepreneurship through mentorship and funding."; ?>
        ...
        <div class="container">
            <div class="cont">
                ...
                <p style="margin-top:5px;">
                    ...
                    <span class="b-active">About SSIP</span>
                </p>
                <hr>
            </div>
        </div>
