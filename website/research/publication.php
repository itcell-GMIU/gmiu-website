...
<head>
    <?php $pageTitle = "About Research Activities(Publication) | GMIU";
...
<body class="courses">
    ...
    <section class="hero">
        ...
        <div class="container">
            <div class="cont">
                <div class="top">
                    <h1>About Research Activities(Publication)</h1>
                </div>
                <p style="margin-top:5px;">
                    <span><a href="https://gmiu.edu.in/" style="color:#727272">Home</a> <i
                            class='fa fa-angle-right'></i></span>
                    <span class="b-active"><a href="#">About Research Activities(Publication)</a></span>
                </p>
                <hr>
            </div>
        </div>
