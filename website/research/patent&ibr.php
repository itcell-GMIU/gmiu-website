...
<head>
    <?php $pageTitle = "About Research Activities(Patent & IPR) | GMIU";?>
    <?php $meta_description = "Learn about GMIU’s initiatives in patents and industrial-based research. See how we support innovation and real-world applications."; ?>
...
<body class="courses">
    ...
    <section class="hero">
        ...
        <div class="container">
            <div class="cont">
                <div class="top">
                    <h1>About Research Activities(Patent & IPR)</h1>
                </div>
                <p style="margin-top:5px;">
                    <span><a href="https://gmiu.edu.in/gmiu/website/" style="color:#727272">Home</a> <i
                            class='fa fa-angle-right'></i></span>
                    <span class="b-active">About Research Activities(Patent & IPR)</span>
                </p>
                <hr>
            </div>
        </div>
                                        ...
                                        <div class="col-sm-12 about-card">
                                            ...
                                            if ($img_name) {
                                                ...
                                                <div class="col-sm-12 about-card"
                                                    ...
                                                    <img style="border-radius: 8px; width: 100%; height:500px; margin-bottom: 23px; object-fit: cover;"
