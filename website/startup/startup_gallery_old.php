...
@media (max-width: 768px) {
    ...
    .gallery_img_wrapper {
        display: flex;
        flex-wrap: wrap;
        justify-content: space-around; /* Ensure even spacing between gallery items */
    }
}
                                ...
                                <div class="section-paddings gallery-images event-01" style="padding-top: 0px;">
                                    <!--<div class="container">-->
                                        <div class="row gallery_img_wrapper">
                                           ...
                                           <!--         <figure>-->
                                           <!--             <img style="height: 245px;width: 345px;" src="<?php echo $base_url_website_assets ?>1.png" alt="gallery">-->
                                           <!--             <figcaption>-->
                                           ...
                                           <!-- </div>-->
                                             <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                                <div class="single-gallery">
                                                    <figure>
                                                        <img style="height: 245px;width: 345px;" src="<?php echo $base_url_website_assets ?>2.jpg" alt="gallery">
                                                        <figcaption>
                                                            <a href="<?php echo $base_url_website_assets ?>2.jpg" title=""><i class="fa fa-eye"></i></a>
                                                        </figcaption>
                                                    </figure>
                                                </div>
                                                ...
                                                <div class="single-gallery">
                                                    <figure>
                                                        <img style="height: 245px;width: 345px;" src="<?php echo $base_url_website_assets ?>3.png" alt="gallery">
                                                        <figcaption>
                                                            <a href="<?php echo $base_url_website_assets ?>3.png" title=""><i class="fa fa-eye"></i></a>
                                                        </figcaption>
                                                    </figure>
                                                </div>
                                            </div>
                                             <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                                <div class="single-gallery">
                                                    <figure>
                                                        <img style="height: 245px;width: 345px;" src="<?php echo $base_url_website_assets ?>4.jpeg" alt="gallery">
                                                        <figcaption>
                                                            <a href="<?php echo $base_url_website_assets ?>4.jpeg" title=""><i class="fa fa-eye"></i></a>
                                                        </figcaption>
                                                    </figure>
                                                </div>
                                            </div> <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                                <div class="single-gallery">
                                                    <figure>
                                                        <img style="height: 245px;width: 345px;" src="<?php echo $base_url_website_assets ?>5.jpeg" alt="gallery">
                                                        <figcaption>
                                                            <a href="<?php echo $base_url_website_assets ?>5.jpeg" title=""><i class="fa fa-eye"></i></a>
                                                        </figcaption>
                                                    </figure>
                                                </div>
                                            </div> <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                                <div class="single-gallery">
                                                    <figure>
                                                        <img style="height: 245px;width: 345px;" src="<?php echo $base_url_website_assets ?>6.jpeg" alt="gallery">
                                                        <figcaption>
                                                            <a href="<?php echo $base_url_website_assets ?>6.jpeg" title=""><i class="fa fa-eye"></i></a>
                                                        </figcaption>
                                                    </figure>
                                                </div>
                                            </div> <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                                <div class="single-gallery">
                                                    <figure>
                                                        <img style="height: 245px;width: 345px;" src="<?php echo $base_url_website_assets ?>7.jpeg" alt="gallery">
                                                        <figcaption>
                                                            <a href="<?php echo $base_url_website_assets ?>7.jpeg" title=""><i class="fa fa-eye"></i></a>
                                                        </figcaption>
                                                    </figure>
                                                </div>
                                            </div>
