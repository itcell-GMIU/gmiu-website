            ...
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    Swal.fire({
                        ...
                        text: 'Thank you, {$safe_full_name}. We have received your details for the GGC Scholarship.',
                        icon: 'success',
...
<head>
    ...
    <title>GGC Scholarship Form | GMIU</title>
...
<body class="flex justify-center items-center min-h-screen p-4 my-10 sm:my-0">
    ...
    <div
        ...
        <img src="https://gmiu.edu.in/gmiu/website_assets/images/GGC-Logo.png" alt="Company Logo"
            class="w-auto h-24 mx-auto mb-6 p-4 object-cover shadow-lg" />
        <h2 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">GGC Scholarship Form</h2>
        <p class="text-gray-600 mb-8">for 12th Arts & Commerce girl students.</p>
        ...
        <form method="POST" action="">
            ...
            <div class="space-y-4 text-left">
                ...
                <p class="text-red-500 mt-0" style="margin-top: 0px;"><small>* Validate dates are only 18th & 25th Jan 2026 !!!</small></p>
    ...
    <script>
        const allowedDates = ["2026-01-18", "2026-01-25"];
