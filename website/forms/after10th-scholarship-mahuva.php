...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // --- Basic Validation ---
    if (empty($full_name) || empty($mobile_number) || empty($email_id) || empty($standard) || empty($start_date)) {
    ...
    $sql = "INSERT INTO tbl_promotional_form_data 
        (form_type, full_name, email, mobile, standard, start_date)
        VALUES (?, ?, ?, ?, ?, ?)";
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    Swal.fire({
                        ...
                        text: 'Thank you, {$safe_full_name}. We have received your details for the Scholarship Test.',
                        icon: 'success',
...
<head>
    ...
    <title>After 10th Scholarship Form Mahuva | GMIU</title>
...
<body class="flex justify-center items-center min-h-screen p-4 my-10 sm:my-0">
    ...
    <div
        ...
        <img src="https://gmiu.edu.in/gmiu/website_assets/images/GMEM.png" alt="Company Logo"
            class="w-auto h-24 mx-auto mb-6 p-4 object-cover shadow-lg" />
        <h2 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">After 10th Scholarship Test Form Mahuva</h2>
        <p class="text-gray-600 mb-8">for students seeking admission in Diploma.</p>
            ...
            <div class="space-y-4 text-left">
                ...
                <div class="relative">
                    ...
                    <select id="standard" name="standard" required
                        ...
                        <option value="10-pass">10<sup>th</sup> Pass</option>
                ...
                <label class="font-semibold text-gray-700 block mt-3">Test Date</label>
                <div class="flex flex-col sm:flex-row gap-4 mt-0" style="margin-top: 0px;">
                    <div class="relative flex-1">
                        <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-500">
                            <i class="bi bi-calendar-event-fill"></i>
                        </span>
                        <input type="date" id="start_date" name="start_date" required class="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-300 rounded-lg 
                ...
                <p class="text-red-500 mt-0" style="margin-top: 0px;"><small>* Validate dates are only 23 Nov, 30 Nov, 7
                        Dec, 14 Dec 2025 !!!</small></p>
    ...
    <script>
        const allowedDates = ["2025-11-23", "2025-11-30", "2025-12-07", "2025-12-14"];
