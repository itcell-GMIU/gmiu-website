...
<body class="flex justify-center items-center min-h-screen p-4 my-10 sm:my-0">
            ...
            <div class="space-y-4 text-left">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <div class="relative flex-1">
                        ...
                        <input type="date" id="start_date" name="start_date" placeholder="Start Date" required class="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-300 rounded-lg 
               ...
               <p class="text-red-500"><small>* Validate dates are only 15, 16, 17, 22, 23, 24 of November,
    ...
    <script>
         const allowedDates = ["2025-11-15", "2025-11-16", "2025-11-17", "2025-11-22", "2025-11-23", "2025-11-24",];
