...
<head>
    ...
    <title>Techmanjari 2K26 | Invitation | GMIU
    </title>
...
<body class="text-gray-100 overflow-x-hidden">
    ...
    <nav class="fixed w-full z-50 glass px-4 md:px-6 py-3 md:py-4">
        <div class="max-w-7xl mx-auto flex justify-center items-center">
            <div class="flex items-center">
                <img src="https://admission.gmiu.edu.in/website_assets/images/gmiu_logo.png" alt="GMIU Logo"
                    class="h-12 w-auto md:h-14 md:w-auto object-contain">
            </div>
        </div>
    </nav>

    <header class="relative min-h-screen w-full flex items-center justify-center overflow-hidden pt-16">
        <div class="absolute inset-0 z-0">
            <img src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=2070"
                alt="Tech Background" class="w-full h-full object-cover opacity-20 scale-110 md:scale-100">
            <div class="absolute inset-0 bg-gradient-to-b from-slate-900/10 via-slate-900/60 to-slate-900"></div>
        </div>

        <div class="relative z-10 text-center px-6 md:px-4 animate-fade-up">
            <img src="https://techmanjari.gmiu.edu.in/images/speakers/featured-speaker.jpg" alt="Techmanjari Logo"
                class="h-32 sm:h-36 md:h-40 w-auto mx-auto mb-8 object-contain drop-shadow-xl transition-transform hover:scale-110 duration-500">

            <p
                class="text-sky-400 text-xl md:text-md font-medium tracking-[0.2em] md:tracking-[0.4em] uppercase mb-4 animate-pulse">
                INVITATION
            </p>

            <h1 class="text-4xl sm:text-6xl md:text-8xl font-bold text-glow mb-6 leading-tight">
                TECHMANJARI <br class="block md:hidden">
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-purple-500">2K26</span>
            </h1>

            <p class="max-w-xl md:max-w-2xl mx-auto text-gray-400 text-base md:text-xl mb-8 md:mb-10 leading-relaxed">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="https://techmanjari.gmiu.edu.in/" target="_blank"
                    class="w-full sm:w-auto px-10 py-4 bg-sky-500 hover:bg-sky-600 rounded-full font-bold transition-all transform hover:scale-105 shadow-lg shadow-sky-500/20">
                    Visit Techmanjari
                </a>
                <a href="https://gmiu.edu.in/" target="_blank"
                    class="w-full sm:w-auto px-10 py-4 glass hover:bg-white/10 rounded-full font-bold transition-all text-center">
                    Visit GMIU
                </a>
            </div>
        </div>
    ...
    <section id="highlights"
        class="py-16 md:py-24 px-4 md:px-6 max-w-7xl mx-auto bg-slate-900/50 rounded-[3rem] my-10 border border-white/5">
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-5xl font-bold text-white tracking-tight mb-4">
                Techmanjari <span class="text-sky-400 font-light italic">Vibes</span>
            </h2>
    ...
    <section id="press-notes" class="py-16 md:py-24 px-4 md:px-6 max-w-7xl mx-auto">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-5xl font-bold text-white tracking-tight mb-4">
                Press <span class="text-sky-400 font-light">Highlights</span>
            </h2>
        ...
        <div class="relative group px-4">
            ...
            <button onclick="scrollCarousel(-1)"
                class="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-black/30 hover:bg-black/60 text-white p-3 rounded-full ml-2 backdrop-blur-sm transition-all hidden md:block">
            ...
            <button onclick="scrollCarousel(1)"
                class="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-black/30 hover:bg-black/60 text-white p-3 rounded-full mr-2 backdrop-blur-sm transition-all hidden md:block">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor"
                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div id="pressCarousel"
                class="flex overflow-x-auto gap-6 pb-6 snap-x snap-mandatory no-scrollbar scroll-smooth">

                <div onclick="openModal('./img/press-notes/1000083675.jpg')"
                    class="min-w-[85%] sm:min-w-[45%] lg:min-w-[22%] snap-start glass rounded-2xl overflow-hidden group border-sky-500/20 hover:border-sky-500/50 transition-all duration-300 cursor-pointer">
    ...
    <div id="videoModal"
        class="fixed inset-0 z-[100] hidden flex items-center justify-center bg-black/95 backdrop-blur-md p-4 cursor-pointer"
        ...
        <div class="w-full max-w-[350px] aspect-[9/16] relative" onclick="event.stopPropagation()">
            <iframe id="shortsIframe" class="w-full h-full rounded-2xl border border-white/10 shadow-2xl" src=""
                frameborder="0"
    ...
    <footer
        class="relative mt-20 border-t border-white/10 bg-slate-900/80 backdrop-blur-md pt-16 pb-8 px-6 overflow-hidden">
        <div class="absolute -top-24 -left-24 w-64 h-64 bg-sky-500/10 rounded-full blur-3xl"></div>
        <div class="absolute -bottom-24 -right-24 w-64 h-64 bg-purple-500/10 rounded-full blur-3xl"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                ...
                <div class="space-y-4 text-center md:text-left">
                    <div class="flex items-center justify-center md:justify-start gap-3">
                        <img src="https://admission.gmiu.edu.in/website_assets/images/gmiu_logo.png" alt="GMIU"
                            class="h-10 w-auto">
                        <span class="text-xl font-bold tracking-widest text-sky-400 uppercase">Techmanjari</span>
                    </div>
                    <p class="text-gray-400 text-sm leading-relaxed max-w-xs mx-auto md:mx-0">
                        The biggest technical carnival of Bhavnagar.
                    </p>
                </div>

                <div class="text-center">
                    <h4 class="text-white font-bold uppercase tracking-widest text-sm mb-6">Navigation</h4>
                    <ul class="space-y-3 text-gray-400 text-sm">
                        <li><a href="#" class="hover:text-sky-400 transition-colors">Home</a></li>
                        <li><a href="#press-notes" class="hover:text-sky-400 transition-colors">Press Notes</a></li>
                        <li><a href="#highlights" class="hover:text-sky-400 transition-colors">Highlights</a></li>
                    </ul>
                </div>

                <div class="text-center md:text-right">
                    <h4 class="text-white font-bold uppercase tracking-widest text-sm mb-6">Connect With Us</h4>
                    <div class="flex justify-center md:justify-end gap-4 mb-6">
                        <a href="https://www.instagram.com/gyanmanjari_innovative_u/?igsh=b2hodnd6YmNld3lj#"
                            target="_blank"
                            class="w-10 h-10 rounded-xl glass flex items-center justify-center text-gray-400 hover:text-sky-400 hover:border-sky-500/50 transition-all">
                    ...
                    <p class="text-xs text-gray-500 tracking-widest uppercase">info@gmiu.edu.in</p>
                </div>
            </div>

            <div class="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-[10px] md:text-xs text-gray-500 uppercase tracking-[0.2em]">
                    &copy; 2026 Techmanjari • Gyanmanjari Innovative University
                </p>

                <p class="text-[10px] md:text-xs text-gray-500 uppercase tracking-[0.2em]">
                    Designed by
                    <a href="https://aksharrathod.netlify.app" target="_blank"
                        class="text-sky-400 font-bold hover:text-white transition-colors cursor-default ml-1">
                        Akshar Rathod
                    </a>
                </p>
            </div>
    ...
    <div id="imageModal"
        class="fixed inset-0 z-[100] hidden flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 cursor-pointer"
        onclick="closeModal()">
    ...
    <script>
        function openModal(imageSrc) {
            ...
            // Safety check: ensure elements exist before setting src
            if (modal && modalImg) {
                modalImg.src = imageSrc;
                modal.classList.remove('hidden');
                modal.classList.add('flex'); // Ensure it shows as flex
                document.body.style.overflow = 'hidden';
            } else {
                console.error("Modal elements not found in the DOM. Check your IDs.");
            }
        }
        ...
        function openShort(videoId) {
            ...
            // Construct the embed URL (using /embed/ ensures it works inside a modal)
        ...
        function closeVideoModal() {
            ...
            iframe.src = ''; // Clear source to stop video playback
            modal.classList.add('hidden');
            modal.classList.remove('flex');
            document.body.style.overflow = 'auto';
        }
    ...
    <script>
        function scrollCarousel(direction) {
            ...
            const scrollAmount = carousel.offsetWidth * 0.8; // Scrolls 80% of view width
            carousel.scrollBy({
