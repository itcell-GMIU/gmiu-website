...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->num_rows > 0) {
        ...
        $stmt->bind_param("ssssss", $inq_student_id_final, $name, $email, $mobile, $course, $is_online);
...
<body>
    ...
    <main class="main-content">
        ...
        <section class="compact-image-section">
            <img
                src="https://gmiu.edu.in/gmiu/website_assets/images/admission/12thAgroup.jpg"
            ...
            <section class="content-section">
                ...
                <div class="reel-wrapper">
                    ...
                    <div class="text-center">
                        <a href="reel.php" class="see-more-btn">
