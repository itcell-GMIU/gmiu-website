...
<head>
    ...
    <link href="page.css?v=2" rel="stylesheet">
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-section text-center">
                <h2 class="section-title">Diploma Courses</h2>
                <div class="diploma-grid">
                    <div class="diploma-card">Computer Science Engineering</div>
                    <div class="diploma-card">Computer Engineering</div>
                    <div class="diploma-card">Information Technology</div>
                    <div class="diploma-card">Chemical Engineering</div>
                    <div class="diploma-card">Electrical Engineering</div>
                    <div class="diploma-card">Electronics and Communication Engineering</div>
                    <div class="diploma-card">Interior Design</div>
                    <div class="diploma-card">Fashion Design</div>
                    <div class="diploma-card">Mechanical Engineering</div>
                    <div class="diploma-card">Civil Engineering</div>
                </div>
            ...
            <section class="content-section text-center">
                ...
                <div class="brochure-grid">
                    ...
                    <div class="brochure-card interactive-card">
                        <a href="<?php echo $website_assets_url; ?>images/leaflet/8-Page-Leaflet.pdf" target="_blank">
                    ...
                    <div class="brochure-card interactive-card">
                        <a href="<?php echo $website_assets_url; ?>images/leaflet/4-page-Leaflet.pdf" target="_blank">
