...
@media (max-width: 768px) {
    .modal-content {
        ...
        object-fit: contain;
        /* Slightly larger width for smaller screens */
        max-height: 75vh;
        top: 50% !important;
    ...
    .close {
        ...
        /*top: 50px;*/
        right: 0px;
        font-size: 30px;   /* Adjust the close button size for smaller screens */
    }
}
	</style>
</head>
						...
						<section class="events-list-03">
							<div class="container"> <?php
                                ...
                                ?> <div class="row event-body-content semester-content" id="sem-<?php echo $sem_c; ?>" style="display: none;">
								 <?php
                                        $cmd = $con->prepare("SELECT id  FROM tbl_campus WHERE type_id=11 AND is_active=1 AND is_delete=0 AND YEAR(date) = $sem_c");
												...
												<div id="img-slider" style="padding: 0px 0px 0px 0px;">
														...
														<?php
                                                                        ...
                                                                        ?>
                                                                              ...
                                                                              <div class="swiper-slide">
    																            <img src="<?php echo $upload_website_admin_url . 'culture/' . $file_name1; ?>">
															                   </div> 
													...
													<div style="height:80px" thumbsSlider="" class="swiper mySwiper<?php echo $sp_id; ?>">
														<div class="swiper-wrapper"> <?php
                                                                        ...
                                                                        ?> <div class="swiper-slide">
																<img src="<?php echo $upload_website_admin_url . 'culture/' . $file_name2; ?>">
															</div> <?php }
                                                                        } ?> </div>
													</div>
												</div>
