...
<head>
    <?php $pageTitle = "Expert Talks at Gyanmanjari Innovative University | GMIU"; 
        $meta_description = "Explore GMIU's Expert Talk series—insightful sessions by industry leaders and academics to enrich student learning and boost career prospects.";
   ?>
...
<body class="courses">
                ...
                <div class="curriculum-section">
                    ...
                    <div class="panel-group" id="accordion">
                        ...
                        $cmd = $con->prepare("SELECT faculty.name as faculty_name, faculty.faculty_slug as faculty_slug, faculty.id as faculty_id
                                              ...
                                              JOIN tbl_expert_talk as expert_talk
                                              ON expert_talk.faculty_id = faculty.id
                                              WHERE faculty.is_active = 1 AND faculty.is_delete = 0
                                              AND expert_talk.is_active = 1 AND expert_talk.is_delete = 0
                                              GROUP BY faculty.id");
                        $cmd->execute();
                                    ...
                                    <div id="c<?php echo $i; ?>" class="panel-collapse collapse out">
                                        <div class="panel-body">
                                            ...
                                            $query = "SELECT program.level_id, level.name as level_name
                                                      ...
                                                      JOIN tbl_expert_talk as expert_talk ON FIND_IN_SET(program.id, expert_talk.program_id) > 0
                                            ...
                                            if (mysqli_num_rows($result1) > 0) {
                                                while ($row1 = mysqli_fetch_assoc($result1)) {
                                                    ...
                                                    <section class="two-column-cards">
                                                        <h3 class="title gradText"><?php echo $level_name; ?></h3>
                                                        <hr>
                                                                    ...
                                                                    <div class="program-wrapper">
                                                                        ...
                                                                        <div class="program-details" id="details-<?php echo $program_id; ?>"
                                                                            ...
                                                                            <div class="program-content">
                                                                                <?php
                                                                                // Fetch Title
                                                                                $desc_query = $con->prepare("SELECT id, title as title
                                                                                    FROM tbl_expert_talk 
                                                                                    WHERE program_id = ?
                                                                                ...
                                                                                <div class="swiper program-swiper"
                                                                                    ...
                                                                                    <div class="swiper-wrapper">
                                                                                        ...
                                                                                        while ($row1 = $result1->fetch_assoc()) {
                                                                                            $image_url = $upload_website_admin_url . "expert_talk/image/" . htmlspecialchars($row1['file_name']);
                                                                                            $alt_text = !empty($short_description) ? $short_description : "Expert Talk in $program_name";
                                                                                ...
                                                                                <div class="program-description">
                                                                                    ...
                                                                                    <a href="<?php echo $base_url_website_faculty . $faculty_slug . '/' . $program_slug; ?>/program-expert-talk"
    ...
    <!-- jQuery (Ensure it's included if you're using jQuery-based plugins) -->
