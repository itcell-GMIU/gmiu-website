...
<head>
    <?php $pageTitle = "Industry Visit at Gyanmanjari Innovative University | Campus Opportunities";
                ...
                <div class="curriculum-section">
                    ...
                    <div class="panel-group" id="accordion">
                        ...
                        $cmd = $con->prepare(" SELECT 
                            ...
                            JOIN 
                                tbl_industry_visit as industry_visit 
                                ON industry_visit.faculty_id = faculty.id
                            WHERE 
                                faculty.is_active = 1 
                                AND faculty.is_delete = 0
                                AND industry_visit.is_active = 1
                                AND industry_visit.is_delete = 0
                            GROUP BY 
                                faculty.id;
                            ");
                        $cmd->execute();
                                    ...
                                    <div id="c<?php echo $i; ?>" class="panel-collapse collapse out">
                                        <div class="panel-body">
                                            ...
                                            $query = "SELECT 
                                                    ...
                                                    JOIN 
                                                        tbl_industry_visit as industry_visit 
                                                        ON FIND_IN_SET(program.id, industry_visit.program_id) > 0
                                                    WHERE 
