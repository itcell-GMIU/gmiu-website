...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $cmd = $con->prepare("SELECT faculty.description as faculty_description,faculty.name as faculty_name from tbl_faculty as faculty WHERE faculty.id=? AND faculty.is_active=1 AND faculty.is_delete=0");
...
<body class="courses">
            ...
            <div class="row two-colum-section">
                ...
                <div class="col-sm-8 sidebar-left">
                    <div class="single-curses-contert">
                        ...
                        $query = "SELECT program.level_id,level.name as level_name, program.brochure as brochure from tbl_program as program
                                    LEFT JOIN tbl_level level ON program.level_id = level.id
                        ...
                        <section class="links-card">
                            ...
                            <div class="cards-container">
                                ...
                                <a target="_blank" href="' . $website_assets_url . 'gmiu_doc/FACULTY OF ARTS/B.A/B.A. PDF.pdf">
                                    <div class="card">
                                        <i class="fa fa-book"></i>
                                        <p>Brochure</p>
                                    </div>
                    ...
                    <section class="links-card">
                        ...
                        <div class="cards-container">
                            ...
                            <a target="_blank" href="' . $website_assets_url . 'gmiu_doc/FACULTY OF ARTS/M.A/M.A .pdf">
                                <div class="card">
                                    <i class="fa fa-book"></i>
                                    <p>Brochure</p>
                                </div>
                ...
                <section class="links-card">
                    ...
                    <div class="cards-container">
                        ...
                        <a target="_blank" href="' . $website_assets_url . 'gmiu_doc/FACULTY OF COMPUTER SCIENCE/BCA/BCA.pdf">
                            <div class="card">
                                <i class="fa fa-book"></i>
                                <p>Brochure</p>
                            </div>
                                    ...
                                    echo '<section class="video-content">
                                        ...
                                        <section class="links-card">
                                            ...
                                            <div class="cards-container">
                                                ...
                                                <a target="_blank" href="' . $upload_website_admin_url . 'brochure/' . $brochure . '">
                                                    <div class="card">
                                                        <i class="fa fa-book"></i>
                                                        <p>Brochure</p>
                                                    </div>
                                    ...
                                    echo '<section class="video-content">
                                            ...
                                            <section class="links-card">
                                                ...
                                                <div class="cards-container">
                                                    ...
                                                    <a target="_blank" href="' . $website_assets_url . 'gmiu_doc/FACULTY OF DESIGN/Bachelor in Design/Bachelor in Design.pdf">
                                                        <div class="card">
                                                            <i class="fa fa-book"></i>
                                                            <p>Brochure</p>
                                                        </div>
   ...
   <a target="_blank" href="' . $upload_website_admin_url . 'brochure/' . $brochure . '">                                             care (1).pdf">
                                                    <div class="card">
                                                        <i class="fa fa-book"></i>
                                                        <p>Brochure</p>
                                                    </div>
                                                </a>
                                                <a target="_blank" href="' . $website_assets_url . 'gmiu_doc/MEDICAL SCIENCE _ HEALTH CARE/FAQS Of Medical Science Final For Online - Copy.pdf">
                                                    <div class="card">
                                                        <i class="fa fa-question"></i>
                                                        <p>FAQ</p>
                                                    </div>
                                    ...
                                    echo '<section class="video-content">
                                        ...
                                        <a target="_blank" href="' . $website_assets_url . 'gmiu_doc/SOCIAL WORK/BSW/BSW.pdf">
                                        <div class="card">
                                        <i class="fa fa-book"></i>
                                        <p>Brochure</p>
                                        </div>
                                    ...
                                    echo '<section class="video-content">
                                        ...
                                        <a target="_blank" href="' . $website_assets_url . 'gmiu_doc/SOCIAL WORK/MSW/MSW.pdf">
                                        <div class="card">
                                        <i class="fa fa-book"></i>
                                        <p>Brochure</p>
                                        </div>
                                    ...
                                    echo '<section class="video-content">
                                            ...
                                            <a target="_blank" href="' . $website_assets_url . 'gmiu_doc/FACULTY OF HOTEL MANAGEMENT/Bachelor of Hotel Managment/Hotel Managment.PDF.pdf">
                                            <div class="card">
                                            <i class="fa fa-book"></i>
                                            <p>Brochure</p>
                                            </div>
                                    ...
                                    echo '<section class="video-content">
                                            ...
                                            <a target="_blank" href="' . $website_assets_url . 'gmiu_doc/FACULTY OF HOTEL MANAGEMENT/Diploma of Hotel Managment/Diploma hotel managment.pdf">
                                            <div class="card">
                                            <i class="fa fa-book"></i>
                                            <p>Brochure</p>
                                            </div>
                                    ...
                                    echo '<section class="links-card">
                                            ...
                                            <a target="_blank" href="' . $website_assets_url . 'gmiu_doc/Comman University Point/4.Integrated Courses - Copy.pdf">
                                            <div class="card">
                                            <i class="fa fa-book"></i>
                                            <p>Brochure</p>
                                            </div>
                            ...
                            <div class="sticky">
                                <div>
                                    <ul>
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                        ?>
                                            <li><a href="faculty.php?id=<?php echo $row['faculty_id'] ?>"><i class="fa-solid fa-arrow-right"></i>
