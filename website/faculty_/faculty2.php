                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                               ...
                               // $brochure = $row['brochure'];
                                ...
                                $query23 = "SELECT `id`, `faculty_id`, `level_id`, `document` FROM `tbl_faculty_faq` WHERE faculty_id = $faculty_id AND level_id = $level_id";
                        ...
                        ?>
                                ...
                                <section class="links-card">
                                    ...
                                    <div class="cards-container">
                                        ...
                                        <a target="_blank" href="' . $upload_website_admin_url . 'faculty_FAQ/document/' . $FAQ . '">
                                            <div class="card">
                                    ...
                                    <i class="fa-solid fa-graduation-cap"></i>
                                        ...
                                        <a target="_blank" href="' . $upload_website_admin_url . 'faculty_FAQ/document/' . $FAQ . '"> <a target="_blank" href="#">
                                            <div class="card">
                                                <i class="fa fa-question"></i>
                                                <p>FAQ</p>
                                            </div>
