                                                            ...
                                                            ?>
                                                                ...
                                                                <h3 class="course-name" style="word-break: auto-phrase;">
                                                                    <?php //echo $program_name; ?>
                                                                     <?php echo $program_name;
                                                                    if ($program_id == 365) { ?>
                                                                        <sup class="text-danger">&nbsp;&nbsp;*Approved Under BCI</sup>
                                                                    <?php } ?>
                                                                </h3>
                            ...
                            <div class="card">
                                ...
                                <p>Apply Online</p>
                                    ...
                                    echo '<section class="links-card">
                                            ...
                                            // allowfullscreen></iframe>
                                            // </div>
                                            // ' . $upload_website_admin_url . 'faculty_brochure/document/' . $brochure . '
                                            // </section>
                                  echo '  <section class="links-card">
                                            <h3 class="title gradText">IMPORTANT LINKS</h3>
                                            <hr>
                                            ...
                                            <a target="_blank" href="' . $website_assets_url . 'gmiu_doc/FACULTY OF LAW/LAW_FAQS.pdf">
                                            <div class="card">
                                            <i class="fa fa-question"></i>
                                            <p>FAQ</p>
                                            </div>
