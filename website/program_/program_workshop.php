        ...
        <div class="container">
            <div class="cont">
                ...
                <p style="margin-top:5px;">
                    ...
                    <span class="b-active"><a href="">Workshop</a></span>
                </p>
                <hr>
            </div>
        ...
        <div class="container">
            <section class="placed-students">
                <div class="buttons-container-flex" style="padding: 10px;">
                    ...
                    $cmd = "SELECT YEAR(date) FROM tbl_workshop WHERE is_active = 1 AND is_delete = 0 and FIND_IN_SET('$program_id', program_id) and faculty_id = $faculty_id GROUP BY YEAR(date) ORDER BY YEAR(date)DESC ";
                    ...
                    <div class="single-curses-contert">
                        ...
                        <section class="events-list-03">
                            <div class="container">
                                <?php
                                //code for getting year buttons by grouping year in placement table
                                $cmd6 = "SELECT YEAR(date) FROM tbl_workshop WHERE is_active = 1 AND is_delete = 0 and FIND_IN_SET('$program_id', program_id) and faculty_id = $faculty_id GROUP BY YEAR(date) ORDER BY YEAR(date)";
                                ...
                                ?>
                                    <div class="row event-body-content semester-content" id="sem-<?php echo $sem_c; ?>" style="display: none;">
                                        <?php
                                        $cmd = $con->prepare("SELECT workshop.id as workshop_id,workshop.title as workshop_title, workshop.description as workshop_description FROM tbl_workshop as workshop  WHERE FIND_IN_SET('$program_id', program_id) AND is_active=1 AND is_delete=0 AND YEAR(date) = $sem_c");
                                      //  $cmd->bind_param("i", $program_id);
                                        $cmd->execute();
                                        $result = $cmd->get_result();
                                        if ($result->num_rows > 0) {
                                                    ...
                                                    <div class="events-single-box">
                                                        ...
                                                        <div class="row">
                                                            <div id="img-slider" class="col-sm-7" style="padding-top: 0;">
                                                                <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff; padding-bottom:0;" class="swiper swipermain mySwipers<?php echo $workshop_id; ?>">
                                                                    <div class="swiper-wrapper">
                                                                        ...
                                                                        $cmd1->bind_param("is", $workshop_id, $type);
                                                                        $cmd1->execute();
                                                                        ...
                                                                        ?>
                                                                                <div class="swiper-slide">
                                                                                    <img src="<?php echo $upload_website_admin_url . 'workshop/' . $file_name1; ?>">
                                                                                </div>
                                                                        <?php }
                                                                        } ?>
                                                                    </div>
                                                                </div>
                                                                <div style="height:80px" thumbsSlider="" class="swiper mySwiper<?php echo $workshop_id; ?>">
                                                                    <div class="swiper-wrapper">
                                                                        <?php
                                                                        $type = "workshop";
                                                                        ...
                                                                        $cmd2->bind_param("is", $workshop_id, $type);
                                                                        $cmd2->execute();
                                                                        ...
                                                                        ?>
                                                                                <div class="swiper-slide">
                                                                                    <img src="<?php echo $upload_website_admin_url . 'workshop/' . $file_name2; ?>">
                                                                                </div>
                                                                        <?php }
                                                                        } ?>
                                                                    </div>
                                                            ...
                                                            <div class="col-sm-5 event-info">
                                                                <p class="events-time">
                                                                    <?php echo htmlspecialchars_decode($workshop_description); ?>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
