...
<div id="preloader">
        ...
        <div class="container">
            <div class="cont">
                ...
                <p style="margin-top:5px;">
                    ...
                    <span class="b-active"><a href="program.php?program_id=<?php echo $program_id ?>&faculty_id=<?php echo $faculty_id ?>"><?php echo $program_name.' ('.$level_name .')'; ?></a>
        ...
        <div class="container">
            <section class="placed-students">
                <div class="buttons-container-flex" style="padding: 10px;">
                    ...
                    $cmd = "SELECT YEAR(date) FROM tbl_industry_visit WHERE is_active = 1 AND is_delete = 0 and program_id = $program_id and faculty_id = $faculty_id GROUP BY YEAR(date) ORDER BY YEAR(date)DESC ";
                    ...
                    <div class="single-curses-contert">
                        ...
                        <section class="events-list-03">
                            <div class="container">
                                <?php
                                //code for getting year buttons by grouping year in placement table
                                $cmd6 = "SELECT YEAR(date) FROM tbl_industry_visit WHERE is_active = 1 AND is_delete = 0 and program_id = $program_id and faculty_id = $faculty_id GROUP BY YEAR(date) ORDER BY YEAR(date)";
                                ...
                                ?>
                                    <div class="row event-body-content semester-content" id="sem-<?php echo $sem_c; ?>" style="display: none;">
                                        <?php
                                        $cmd = $con->prepare("SELECT industry_visit.id as industry_visit_id,industry_visit.visit_name as industry_visit_title,industry_visit.report as industry_visit_report, industry_visit.visit_description as industry_visit_description FROM tbl_industry_visit as industry_visit  WHERE program_id=? AND is_active=1 AND is_delete=0 AND YEAR(date) = $sem_c");
                                        $cmd->bind_param("i", $program_id);
                                        $cmd->execute();
                                        $result = $cmd->get_result();
                                        if ($result->num_rows > 0) {
                                                    ...
                                                    <div class="events-single-box">
                                                        ...
                                                        <div class="row">
                                                            <div id="img-slider" class="col-sm-7" style="padding-top: 0;">
                                                                <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff; padding-bottom:0;" class="swiper swipermain mySwipers<?php echo $industry_visit_id; ?>">
                                                                    <div class="swiper-wrapper">
                                                                        ...
                                                                        ?>
                                                                                <div class="swiper-slide">
                                                                                    <img src="<?php echo $upload_website_admin_url . 'industry_visit/image/' . $file_name1; ?>">
                                                                                </div>
                                                                        <?php }
                                                                        } ?>
                                                                    </div>
                                                                </div>
                                                                <div style="height:80px" thumbsSlider="" class="swiper mySwiper<?php echo $industry_visit_id; ?>">
                                                                    <div class="swiper-wrapper">
                                                                        <?php
                                                                        $type = "industry_visit";
                                                                        ...
                                                                        $cmd2->bind_param("is", $industry_visit_id, $type);
                                                                        $cmd2->execute();
                                                                        ...
                                                                        ?>
                                                                                <div class="swiper-slide">
                                                                                    <img src="<?php echo $upload_website_admin_url . 'industry_visit/image/' . $file_name2; ?>">
                                                                                </div>
                                                                        <?php }
                                                                        } ?>
                                                                    </div>
                                                            ...
                                                            <div class="col-sm-5 event-info">
                                                                ...
                                                                <a target="_blank" href="<?php echo $upload_website_admin_url;?>industry_visit/report/<?php echo $industry_visit_report ?>">
                                                                <button id="dwn-btn">
    ...
    <?php
    $cmd = $con->prepare("SELECT workshop.id as workshop_id,workshop.title as workshop_title, workshop.description as workshop_description FROM tbl_workshop as workshop  WHERE program_id=? AND is_active=1 AND is_delete=0 ");
    $cmd->bind_param("i", $program_id);
    $cmd->execute();
    $result = $cmd->get_result();
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<script>
                                                        var swiper = new Swiper(".mySwiper' . $workshop_id . '", {
                                                            loop: true,
                                                            spaceBetween: 10,
                                                            slidesPerView: 3,
                                                            freeMode: true,
                                                        ...
                                                        var swiper2 = new Swiper(".mySwipers' . $workshop_id . '", {
                                                            loop: true,
                                                            spaceBetween: 10,
                                                            navigation: {
