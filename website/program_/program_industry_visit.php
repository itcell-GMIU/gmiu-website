                    ...
                    <div class="single-curses-contert">
                        ...
                        <section class="events-list-03">
                            <div class="container">
                                <?php
                                //code for getting year buttons by grouping year in placement table
                                $cmd6 = "SELECT YEAR(date) FROM tbl_industry_visit WHERE is_active = 1 AND is_delete = 0 and FIND_IN_SET('$program_id', program_id) and faculty_id = $faculty_id GROUP BY YEAR(date) ORDER BY YEAR(date)";
