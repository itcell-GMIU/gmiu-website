...
<head>
     <?php $pageTitle = "International Cell: Exposure | Gyanmanjari University | GMIU"; 
         $meta_description = "Explore GMIU’s Exposure program offering global learning, cultural exchanges, and international opportunities to expand students’ academic and career horizons.";
   ?>
                    ...
                    <div class="single-curses-contert">
                        <section class="about-cards">
                            <div class="about-card">
                                ...
                                ?>
                                        <!--<hr style="margin: 0;">
                                            <div> <h4 class="gradText" ><?php echo $title; ?></h4></div>
                                            <br>
                                             <div><p class="mu-blog-description"><?php echo $description; ?></p></div><br>
                                              <div class="row">-->
                                        <!--<div style="height:200px" class="col-sm-12 swiper-container mySwiper<?php echo $id; ?>">
                                                         <img src="<?php echo "../../website_admin/uploads/international_cell/" . $img_name; ?>" alt="<?php echo $title; ?>">
                                                     </div>-->
                                        <!--<div class="col-sm-12 about-card">-->
                                        <!--<div style="height:200px" class="swiper-container mySwiper<?php echo $id; ?>">-->
                                        <!--<img style="border-radius: 8px; width: 100%; margin-bottom: 23px; object-fit: cover;" src="<?php echo "../../website_admin/uploads/international_cell/" . $img_name; ?>" alt="<?php echo $title; ?>">-->
                                        <!--</div>-->
                                        <!--</div>
                                                </div>-->
                        ...
                        <div class="sideBar">
                            <div class="sticky">
                                <ul>
                                    ...
                                    <li><a href="about_explosure.php" class="active"><i class="fa-solid fa-arrow-right"></i>Global Exposure</a></li>
