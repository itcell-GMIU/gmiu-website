...
<head>
    <?php $pageTitle = "International Cell: ICM | Gyanmanjari Innovative University | GMIU"; 
        $meta_description = "Explore GMIU's ICM program with global partnerships, international exposure, and cross-border opportunities for student growth and collaboration.";
   ?>
...
<body class="courses">
    ...
    <section class="hero">
        ...
        <div class="container">
            <div class="cont">
                <div class="top">
                    <h1>International Initiatives & Collaboration Modes</h1>
                </div>
                <p style="margin-top:5px;">
                    <span><a href="https://gmiu.edu.in/gmiu/website/" style="color:#727272">Home</a> <i class='fa fa-angle-right'></i></span>
                    <span class="b-active">International Initiatives & Collaboration Modes</span>
                </p>
                <hr>
            </div>
        </div>
                        ...
                        <div class="sideBar">
                            <div class="sticky">
                                <ul>
                                    ...
                                    <li><a href="about_icm.php" class="active"><i class="fa-solid fa-arrow-right"></i>International Initiatives & Collaboration Modes</a></li>
