...
<head>
    <?php $pageTitle = "International Cell Admission Info of Gyanmanjari University | GMIU"; ?>
    <?php
    $meta_description = "GMIU International Admission 2025—apply as a foreign, NRI, OCI, or PIO student. Get guidance on visa, eligibility, courses, documents & scholarships.";
    $meta_keywords = "Learn about GMIU's international admission process – offering clear guidelines, requirements, and support for international students seeking to join our academic community.";?>
                            ...
                            <div class="about-card">
                                ...
                                ?>
                                        ...
                                        <div class="col-sm-12 about-card">
                                            <hr style="margin: 0;">
                                            <div>
                                                <h3 class="gradText"><?php echo $title; ?></h3>
                                            </div>
                                            <hr>
                        ...
                        <div class="sideBar">
                            <div class="sticky">
                                <ul>
                                    ...
                                    <li><a href="about_admission.php" class="active"><i class="fa-solid fa-arrow-right"></i>International Admission </a></li>
