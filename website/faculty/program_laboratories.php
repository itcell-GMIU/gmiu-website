                                                ...
                                                <div class="events-single-box">
                                                   ...
                                                   <div class="row">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <!-- Image Slider -->
                                                            <div id="img-slider" style="padding-top: 0;">
                                                                <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff; padding-bottom:0;"
                                                                    class="swiper swipermain mySwipers<?php echo $laboratories_id; ?>">
                                                                        ...
                                                                        if ($result1->num_rows > 0) {
                                                                            while ($row1 = $result1->fetch_assoc()) {
                                                                                ...
                                                                                <div class="swiper-slide">
                                                                                    <img
                                                                                        src="<?php echo $upload_website_admin_url . 'laboratory/' . $file_name1; ?>">
                                                                                </div>
                                                                            <?php }
                                                                        } ?>
                                                                    </div>
                                                                ...
                                                                <!-- Thumbnail Slider -->
                                                                <div style="height:80px" thumbsSlider=""
                                                                    class="swiper mySwiper<?php echo $laboratories_id; ?>">
                                                                    <div class="swiper-wrapper">
                                                                        <?php
                                                                        ...
                                                                        if ($result2->num_rows > 0) {
                                                                            while ($row2 = $result2->fetch_assoc()) {
                                                                                ...
                                                                                <div class="swiper-slide">
                                                                                    <img
                                                                                        src="<?php echo $upload_website_admin_url . 'laboratory/' . $file_name2; ?>">
                                                                                </div>
                                                                            <?php }
                                                                        } ?>
                                                                    </div>
