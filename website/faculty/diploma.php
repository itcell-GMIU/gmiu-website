                        ...
                        ?>
                                ...
                                if ($result1->num_rows != 0) {
                                    while ($row1 = $result->fetch_assoc()) { */
                                        $query1 = "SELECT program.id as program_id,program.name as program_name,program.intake as program_intake,program.regular as regular,program.duration as program_duration,program_slug from tbl_program as program 
