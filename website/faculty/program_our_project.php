        ...
        <div class="container">
            <div class="cont">
                ...
                <p style="margin-top:5px;">
                    ...
                    <span class="b-active"><a href="<?php echo $base_url_website_faculty?><?php echo $faculty_slug; ?>/<?php echo $program_slug; ?>"><?php echo $program_name.' ('.$level_name .')'; ?></a><i class='fa fa-angle-right'></i></span>
                    ...
                    <div class="single-curses-contert">
                        <section class="events-list-031">
                            <div>
                                ...
                                $cmd_social = "SELECT our_social.id as our_social_id, our_social.title as our_social_title FROM tbl_our_social as our_social 
                                WHERE FIND_IN_SET('$program_id', program_id) > 0 AND faculty_id = ? AND is_active = 1 AND is_delete = 0 ";
                                $stmt_social = $con->prepare($cmd_social);
                                $stmt_social->bind_param("i",  $faculty_id);
                                $stmt_social->execute();
                                ...
                                <div class="row">
                                    <?php
                                    $cmd = $con->prepare("SELECT our_social.id as our_social_id,our_social.title as our_social_title FROM tbl_our_social as our_social  WHERE FIND_IN_SET('$program_id', program_id) > 0 AND is_active=1 AND is_delete=0");
