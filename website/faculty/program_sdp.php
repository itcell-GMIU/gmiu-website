        ...
        <div class="container">
            <div class="cont">
                ...
                <p style="margin-top:5px;">
                    ...
                    <span class="b-active"><a href="<?php echo $base_url_website_faculty?><?php echo $faculty_slug; ?>/<?php echo $program_slug; ?>"><?php echo $program_name ?></a></span><i class='fa fa-angle-right'></i></span>
                    ...
                    <div class="single-curses-contert">
                        ...
                        <section class="expert-talk-card-section">
                            <div class="row event-body-content">
                                ...
                                <?php
                                $cmd = $con->prepare("SELECT id, title, date, YEAR, description, report as report, level_id, program_id, faculty_id, img_name as image FROM tbl_sdp as exp_sdp WHERE is_active = 1 AND is_delete = 0 and FIND_IN_SET('$program_id', program_id) and faculty_id = ?");
