...
<div id="preloader">
                    ...
                    <div class="single-curses-contert">
                        ...
                        <section class="events-list-03">
                            <div class="container">
                                <?php
                                //code for getting year buttons by grouping year in placement table
                                $cmd6 = "SELECT YEAR(date) FROM tbl_workshop WHERE is_active = 1 AND is_delete = 0 and FIND_IN_SET('$program_id', program_id) and faculty_id = $faculty_id GROUP BY YEAR(date) ORDER BY YEAR(date) DESC";
                                                ...
                                                <div class="col-sm-8 events-full-box">
                                                    <div class="events-single-box">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="swiper swipermain mySwipers<?php echo $workshop_id; ?>">
                                ...
                                <img src='" . $upload_website_admin_url . "workshop/" . htmlspecialchars($row1['sp_file_name']) . "' class='img-fluid' onerror=\"this.style.display='none';\">
                              </div>";
                                                                        } ?>
                                                                    </div>
    ...
    <script>
        <?php
        // Get all workshop_id IDs for Swiper initialization
        $cmd = $con->prepare("SELECT id FROM tbl_workshop WHERE FIND_IN_SET(?, program_id) AND is_active=1 AND is_delete=0 AND faculty_id=?");
        ...
        while ($row = $result->fetch_assoc()) {
            $workshop_id = $row['id'];
            echo '
    var swiper' . $workshop_id . ' = new Swiper(".mySwipers' . $workshop_id . '", {
        loop: true,
        spaceBetween: 10,
        pagination: {
