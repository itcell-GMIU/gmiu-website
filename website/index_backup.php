...
})(window,document,'script','dataLayer','GTM-NMF9CJ96');</script>
...
<!-- End Google Tag Manager (noscript) -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-xs-12 header-top-right">
                        <ul class="list-unstyled">
                            ...
                            <li><a href="<?php echo $base_url_admission; ?>" style="animation: highlight-blink 1s infinite;"><i class="fa fa-globe top-icon"></i> <span style="font-weight: bold;">Admission 2024-25</span></a></li>
                                        ...
                                        <div id="img-set" class="col-sm-3 event-img">
                                            ...
                                            switch ($icon) {
                                                case 0:
                                                    ...
                                                    break;
                                                case 1:
                                                    echo "<i class='fa-solid fa-computer' style='color: black; font-size: 29px;'></i>";
                                                    break;
                                                case 2:
                                                    echo "<i class='fa-solid fa-code' style='color: black; font-size: 29px;'></i>";
                                                    break;
                                                case 3:
                                                    echo "<i class='fa-solid fa-pills' style='color: black; font-size: 29px;'></i>";
                                                    break;
                                                default:
  ...
  color: rgb(255, 255, 255);"></i>
    ...
    <div class="swiper3 mySwiper" style="margin: 0 10%; overflow:hidden;">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/4TzKfUWcnYY?si=MtZMP_2zxHaq2hkj" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/dBRsx5wsknQ?si=AshGe2wirrWakpDA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/JHn2WJOFnlk?feature=share" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/JxwJvV-t9yI?si=p5t7_2IZRb-dogiK" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/s1EjToFi8uk?si=vdXTsgUkTiR2Ajpc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/6H8A3zpQv1k?si=PCeZzKohVZvSoQ5X" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/G-UQSKjPwN4?si=K3Ky9tIS6-NMZmkO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/AmKwN_yD2wI?si=Q6pHZ2_uyNf6w2r0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/JV9Q8JjTiGI?feature=share" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/Q0oX1rrXmWA?si=4QJ7PGgMp3Bzc0cG" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/BXmUQ-zbeek?si=RS85igRQiZBdK_gc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/7Kwa70ZgyDU?si=xK8-9FIs98RCE5vY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/FCRJhxIGzR8?si=USrv-zua0pUp6txh" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/Fiv2D6iI5cA?si=GL4SjyMI3YxxQWss" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/W8fnoTM17c4?si=HxPaRTGxbDZOH413" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/JJQt51mSBK4?si=EjRtRrrW846ilAe1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/tVJgR-1IDvI?si=DlScrCTM_QCSA1Jr" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/Bj9OiZ7MCk8?feature=share" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/Ezm4FmfDZ3Q?feature=share" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/RI-2VLUtTkk?si=EVME97UGDg55NeGe" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="swiper-slide">
                <iframe width="280px" height="250px" style="border-radius: 10px;" src="https://youtube.com/embed/bh7JM4j6BZA?si=-YgAL4mOAZwYMvQn" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
    ...
    <div class="swiper3 mySwiper" style="margin: 0 10%; overflow:hidden;">
        <div class="swiper-wrapper">
            <?php
            $cmd = "SELECT `file_type`, `file` FROM `tbl_media_coverage` WHERE is_active = 1 AND is_delete = 0 ORDER BY id DESC";
            $stmt = $con->prepare($cmd);
            $stmt->execute();
            $result = $stmt->get_result();
            ...
            ?>
                    <iframe width="280px" height="250px" src="<?php echo $row['file']; ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="border-radius: 10px;" style="border:1px solid black;"></iframe>
            <?php
                    echo '</div>';
                }
            }
    ...
    <div class="news-slider">
        <marquee onMouseOver="this.stop()" onMouseOut="this.start()" direction="left" scrollamount="20" loop="infinite">
            ...
            ?>
                        <img src="<?php echo $upload_website_admin_url; ?>media_coverage/<?php echo $image; ?>" onclick="onClick(this)" class="modal-ns-hover-opacity">
            <?php
                    }
                }
            }
