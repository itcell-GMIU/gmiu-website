        ...
        <div class="card-body">
          ...
          <div class="row g-3">
                <div class="col-12 col-md-6">
                    <a href="https://admission.gmiu.edu.in/admission/girlscollege.php" class="text-decoration-none">
                        <div class="card clickable-card">
                            <img src="../assets/gown.png" alt="Card 1 Image" />
                            <div class="card-body">
                                <h5 class="card-title">જ્ઞાનમંજરી ગર્લ્સ કોલેજ</h5>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-12 col-md-6">
                    <a href="https://admission.gmiu.edu.in/premium/index.php" class="text-decoration-none">
                        <div class="card clickable-card">
                            <img src="../assets/premium-.png" alt="Card 2 Image" />
                            <div class="card-body">
                                <h5 class="card-title">PREMIUM પ્રોગ્રામ</h5>
                            </div>
                        </div>
                    </a>
                </div>
