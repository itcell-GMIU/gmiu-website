            ...
            $message = validate_data($message);
                    ...
                    if ($stmt->execute()) {
                       $message="<b>Name:</b> $name<br><br>"."<b>Subject:</b>$subject<br><br>"."<b>Message:</b>$message";
                        ...
                        //$to = "info@gmiu.edu.in";
                        $to = "admissions@gmiu.edu.in";


                        //code for sending sms
                          $smsmessage = "Dear Applicant,Thank you for showing interest in Gyanmanjari Innovative University.You are just a step away from enrolling at GMIU.Login on https://gmiu.edu.in/gmiu/admission/ to complete your Registration process.";
