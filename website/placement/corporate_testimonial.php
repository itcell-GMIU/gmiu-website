...
<head>
   <?php $pageTitle = "Corporate Testimonials at Gyanmanjari Innovative University"; 
    $meta_description = "Read corporate testimonials for GMIU—insights from industry leaders on our talented graduates and successful campus recruitment partnerships.";
   ?>
...
<div id="preloader">
    ...
    <section class="hero">
        ...
        <div class="container">
            <div class="cont">
                <div class="top">
                    <h1>Corporate Testimonial</h1>
                </div>
                <p style="margin-top:5px;">
                    <span><a href="<?php echo $base_url_website;?>" style="color:#727272">Home</a> <i
                            class='fa fa-angle-right'></i></span>
                    <span class="b-active"><a href="">Corporate Testimonial</a></span>
                </p>
                <hr>
            </div>
                            ...
                            <div class="sticky">
                                <div>
                                    <ul>
                                        ...
                                        <li><a href="corporate_testimonial.php" class="active"><i
