...
<head>
    <?php     
    $pageTitle = "Student Development Program At GMIU.";
    $meta_description = "Explore GMIU's SDP programs—skill development workshops and training to boost students' professional abilities and career readiness.";
   ?>
    ...
    <div class="flexContainer container">
                           ...
                           WHERE program.faculty_id=$faculty_id AND program.level_id = $level_id AND program.is_active=1 AND program.is_delete=0";
                                                            ...
                                                            ?>
                                                                    <div class="card-for-course">
                                                                        ...
                                                                        <a href="<?php echo $base_url_website_faculty; ?><?php echo $faculty_slug; ?>/<?php echo $program_slug; ?>/program-sdp">
        ...
        <div class="col-sm-4 sidebar-right">
                 ...
                 <li>
                  ...
                  <!-- </li> -->
                  <li>
                    <!----><a href="<?php echo $base_url_website_home; ?>sdp.php" class="active"> <i class="fa fa-long-arrow-right"></i> SDP </a><!----><!----><!---->
                  </li>
            <!-- <li>
