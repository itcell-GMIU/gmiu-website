...
<head>
    <?php     
    $pageTitle = "Industry visit At Gyanmanjari Innovative University";
    $meta_description = "Discover GMIU's Industrial Visit Program—offering real-world exposure, hands-on learning, and industry insights to bridge theory with practical experience.";
   ?>
    ...
    <div class="flexContainer container">
                                            ...
                                            ?>
                                                    <section class="two-column-cards">
                                                        ...
                                                        <div class="courses-cards">
                                                            ...
                                                            $query2 = "SELECT program.id as program_id,program.name as program_name,program.intake as program_intake, program.program_slug as program_slug, program.duration as program_duration from tbl_program as program
                           WHERE program.faculty_id=$faculty_id AND program.level_id = $level_id AND program.is_active=1 AND program.is_delete=0";
                                                            ...
                                                            ?>
                                                                    <div class="card-for-course">
                                                                        ...
                                                                        <a href="<?php echo $base_url_website_faculty; ?><?php echo $faculty_slug; ?>/<?php echo $program_slug; ?>/program-industry-visit">
        ...
        <div class="col-sm-4 sidebar-right">
                 ...
                 <li>
                  ...
                  <li>
                    <!----><a href="<?php echo $base_url_website_home; ?>project.php"> <i class="fa fa-long-arrow-right"></i> Project - Social impact project </a><!----><!----><!---->
                  </li>
                  <li>
                    <!----><a href="<?php echo $base_url_website_home; ?>placement.php"> <i class="fa fa-long-arrow-right"></i> Regular update of placement </a><!----><!----><!---->
                  </li>
                  <li>
                    <!----><a href="<?php echo $base_url_website_home; ?>industrial_visit.php" class="active"> <i class="fa fa-long-arrow-right"></i> Industrial visit </a><!----><!----><!---->
                  </li>
                  <!-- <li> -->
