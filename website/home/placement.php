...
<head>
    <?php 
    $pageTitle = "Placement of Gyanmanjari Innovative University";
        $meta_description = "Discover GMIU’s placement opportunities with career guidance, skill development, and job support to help students achieve successful career paths.";
   ?>
    ...
    <div class="flexContainer container">
                           ...
                           WHERE program.faculty_id=$faculty_id AND program.level_id = $level_id AND program.is_active=1 AND program.is_delete=0";
                                                            ...
                                                            ?>
                                                                    <div class="card-for-course">
                                                                        ...
                                                                        <a href="<?php echo $base_url_website_faculty; ?><?php echo $faculty_slug; ?>/<?php echo $program_slug; ?>/placement">
        ...
        <div class="col-sm-4 sidebar-right">
                 ...
                 <li>
                  ...
                  <li>
                    <!----><a href="<?php echo $base_url_website_home; ?>placement.php" class="active"> <i class="fa fa-long-arrow-right"></i> Regular update of placement </a><!----><!----><!---->
                  </li>
                  <li>
