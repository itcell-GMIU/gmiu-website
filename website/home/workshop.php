...
<head>
        <?php 
        $pageTitle = "Workshop At Gyanmanjari Innovative University";
    $meta_description = "Explore GMIU's workshops – offering hands-on learning experiences, skill development, and practical insights to enhance student knowledge and career growth.";
   ?>
    ...
    <div class="flexContainer container">
                           ...
                           WHERE program.faculty_id=$faculty_id AND program.level_id = $level_id AND program.is_active=1 AND program.is_delete=0";
                                                            ...
                                                            ?>
                                                                    <div class="card-for-course">
                                                                        ...
                                                                        <a href="<?php echo $base_url_website_faculty; ?><?php echo $faculty_slug; ?>/<?php echo $program_slug; ?>/program-workshop">
        ...
        <div class="col-sm-4 sidebar-right">
                 ...
                 <li>
                  ...
                  <li>
                    <!----><a href="<?php echo $base_url_website_home; ?>workshop.php" class="active"> <i class="fa fa-long-arrow-right"></i> Seminar / workshop </a><!----><!----><!---->
                  </li>
                  <li>
