    ...
    <div class="single-courses-area">
        <div class="container">
            <div style="padding: 20px 0;" class="row two-colum-section">
                                ...
                                <div class="container">
                                    <div class="row gallery_img_wrapper">
                                        <div class="col-sm-10 col-md-7 ">
                                            ...
                                            ">
                                                <figure>
                                                    <img style="height: auto; width: 500px;" src="../../admin_assets/images/ADVERTISEMENT-MBA.jpg" alt="gallery">
                                                    <figcaption>
                                                        <a href="../../admin_assets/images/ADVERTISEMENT-MBA.jpg" title=""><i class="fa fa-eye"></i></a>
                                            </div>
                ...
                <!--                            ">-->
                <!--                                <figure>-->
                <!--                                    <img style="height: auto; width: 500px;" src="../../admin_assets/images/m2.jpeg" alt="gallery">-->
                <!--                                    <figcaption>-->
                <!--                                        <a href="../../admin_assets/images/m2.jpeg" title=""><i class="fa fa-eye"></i></a>-->
                <!--                            </div>-->
