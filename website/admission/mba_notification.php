                                    ...
                                    <div class="row gallery_img_wrapper">
                                        <div class="col-sm-6 col-md-6">
                                            <div class="single-gallery" style="display:flex;">
                                                <figure>
                                                    <img style="height: auto; width: 100%;" src="../../admin_assets/images/MBA.jpg" alt="gallery">
                                                    <figcaption>
                                                        <a href="../../admin_assets/images/MBA.jpg" target="_blank" title=""><i class="fa fa-eye"></i></a>
                                                    </figcaption>
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6">
                                            <div class="single-gallery" style="display:flex;">
                                                <figure>
                                                    <img style="height: auto; width: 100%;" src="../../admin_assets/images/MCA.jpg" alt="gallery">
                                                    <figcaption>
                                                        <a href="../../admin_assets/images/MCA.jpg" target="_blank" title=""><i class="fa fa-eye"></i></a>
                                                    </figcaption>
                                                </figure>
                                            </div>
                                        </div>
