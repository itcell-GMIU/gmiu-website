                                ...
                                <div class="container">
                                    <div class="row gallery_img_wrapper">
                                        <div class="col-sm-10 col-md-7 ">
                                            ...
                                            ">
                                                <figure>
                                                    <img style="height: auto; width: 500px;" src="images/B.Pharm-ADMISSION-ADVERTISEMENT.jpg" alt="gallery">
                                                    <figcaption>
                                                        <a href="images/B.Pharm-ADMISSION-ADVERTISEMENT.jpg" title=""><i class="fa fa-eye"></i></a>
                                            </div>
