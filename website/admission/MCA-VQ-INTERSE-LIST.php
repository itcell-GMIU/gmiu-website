                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="single-gallery" style="display:flex;">
                                            <figure style="width:100%; text-align:center;">
                                                ...
                                                <img src="../../admin_assets/images/MCA-VQ-INTERSE-LIST.jpg" 
                                                     alt="PDF Preview" 
                                                     style="max-width:250px; width:100%; height:auto; border:1px solid #ccc; border-radius:6px; box-shadow:0 2px 6px rgba(0,0,0,0.15);" />
                                    
                                                <!-- PDF open/download button -->
                                                <figcaption>
                                                    <a href="../../admin_assets/images/MCA-VQ-INTERSE-LIST.pdf" target="_blank" title="Open PDF">
                                                        <i class="fa fa-eye"></i> 
                                                    </a>
                                                </figcaption>
                                            </figure>
