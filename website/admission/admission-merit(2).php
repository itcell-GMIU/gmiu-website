...
<head>
    ...
    <style>
        ...
        /* Image grid and alignment styles */
        .image-grid {
            display: flex;
            flex-wrap: wrap;
            margin: -10px;
        ...
        .image-container {
            ...
            width: 100%;
            height: 0;
            padding-bottom: 70%; /* Decreased height (was 141.42%) */
            background: #f8f9fa;
            border-radius: 8px;
            overflow: hidden;
        ...
        .image-container img {
            ...
            cursor: pointer;
            padding: 5px; /* Added padding inside container */
        }
...
<body class="courses">
    ...
    $years_query = "SELECT DISTINCT year FROM tbl_admission_merit WHERE is_delete = '0' ORDER BY year ASC";
                                ...
                                <div class="tab-content" style="margin-top: 20px;">
                                    ...
                                    foreach ($years as $index => $year) {
                                        ...
                                        foreach ($types as $type) {
                                            ...
                                            $query = "SELECT m.*, 
                                                    GROUP_CONCAT(DISTINCT COALESCE(mi.image_path, m.image)) as all_images 
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    if (!empty($row['all_images'])) {
                                                        $all_images = array_unique(array_filter(explode(',', $row['all_images'])));
                                                        
                                                        echo '<div class="image-grid">';
                                                        foreach ($all_images as $img) {
                                                            echo '<div class="image-item">
                                                                    <div class="image-container">
                                                                        <img src="../../uploads/ugc/' . $img . '" 
