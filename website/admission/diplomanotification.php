                                ...
                                <div class="container">
                                    <div class="row gallery_img_wrapper">
                                        <div class="col-sm-10 col-md-7 ">
                                            ...
                                            ">
                                                <figure>
                                                    <img style="height: auto; width: 500px;" src="../../admin_assets/images/MQ.png" alt="gallery">
                                                    <figcaption>
                                                        <a href="../../admin_assets/images/MQ.png" title=""><i class="fa fa-eye"></i></a>
                                            </div>
                                ...
                                <div class="container">
                                    <div class="row gallery_img_wrapper">
                                        <div class="col-sm-10 col-md-7 ">
                                            ...
                                            ">
                                                <figure>
                                                    <img style="height: auto; width: 500px;" src="../../admin_assets/images/VQ.png" alt="gallery">
                                                    <figcaption>
                                                        <a href="../../admin_assets/images/VQ.png" title=""><i class="fa fa-eye"></i></a>
                                            </div>
