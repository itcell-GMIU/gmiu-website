...
<head>
   <?php $pageTitle = "Contact BKSVE Cell at Gyanmanjari Innovative University | Get in Touch";
    $meta_description = "Connect with GMIU's IKSVE Cell to learn about initiatives on Indian Knowledge Systems, Values, and Ethics, and be part of our cultural mission."; ?>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 single-address-box">
                                                <div class="single-address d-flex"><i class="fa fa-phone"></i>
                                                    <div>
                                                        <h4>Phone</h4><a href="tel:7798400982">+91 7798400982</a><br>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-6 single-address-box">
                                                <div class="single-address"><i class="fa fa-envelope"></i>
                                                    <div class="">
                                                        <h4>Email</h4>
                                                        <a href="mailto:nhbhatt@gmiu.edu.in">nhbhatt@gmiu.edu.in</a>
                                                    </div>
                        ...
                        <div class="sideBar">
                            <div class="sticky">
                                <ul>
                                    ...
                                    <li><a href="contact_us_bksve_cell.php" class="active"><i class="fa-solid fa-arrow-right"></i>Contact Us</a></li>
