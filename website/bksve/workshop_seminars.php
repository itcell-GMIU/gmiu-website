...
<head>
 <?php 
    $meta_description = "Explore workshops and seminars organized by GMIU under the IKSVE program to enhance your professional skills and knowledge with industry experts and thought leaders.";
   ?>
...
<body class="courses">
    ...
    <section class="hero">
        ...
        <div class="container">
            <div class="cont">
                <div class="top">
                    <h1>BKSVE Cell Workshop Seminars</h1>
                </div>
                <p style="margin-top:5px;">
                    <span><a href="https://gmiu.edu.in/" style="color:#727272">Home</a> <i class='fa fa-angle-right'></i></span>
                    <span class="b-active"><a href="#">BKSVE Cell Workshop Seminars</a></span>
                </p>
                <hr>
            </div>
        </div>
