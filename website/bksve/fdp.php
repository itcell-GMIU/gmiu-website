...
<head>
    <?php 
    $meta_description = "Explore GMIU's Faculty Development Program (FDP) designed to enhance teaching skills, academic knowledge, and professional growth for educators and faculty members.";
   ?>
