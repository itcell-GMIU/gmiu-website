...
$cmd = "Select stu.*,pro.name as program_name,level.name as level_name,faculty.shortname as faculty_shortname,faculty.name as faculty_name from tbl_students_2023 as stu LEFT JOIN tbl_program pro
...
if ($result->num_rows == 1) {
    ...
    $enrollnment_no = !empty($row['enrollnment_no']) ? $row['enrollnment_no'] :  "N/A";
                    ...
                    <img src="https://th.bing.com/th/id/OIP.aNuVPko-fipxD4-hwuKSTQHaHl?pid=ImgDet&rs=1"
                        id="profile_img" class="rounded float-right" alt="...">
                                ...
                                <tbody>
                                    <tr>
                                        <th >ER Number</th>
                                        <td colspan="2"> <?php echo $enrollnment_no; ?></td>
                                        <th>Semester</th>
                                        <td colspan="2">
                                            <?php echo $semester; ?>
                                        </td>
