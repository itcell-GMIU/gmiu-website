...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $cmd2 = "SELECT `faculty_id`, `level_id` FROM tbl_admission_student WHERE id = ? ";
            ...
            <div class="content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-2">
                        <!-- col -->
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Educational Details</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Edit Educational Details</li>
                            </ol>
                        </div> <!-- /.col -->
                    </div> <!-- /.row -->
                </div> <!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">Edit Educational Details</h3>
                                </div> <!-- /.card-header -->

                                <!-- form start -->
                                <form id="quickForm" method="POST" action="student_edu_update.php">
                                    <!-- card body -->
                                    <div class="card-body">
                                        <input type="text" name="stu_id" class="form-control" id="stu_id" value="<?php echo $student_id; ?>" hidden>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="ssc_boardname" id="board_name_input_id" class="form-control select2me">
                                                    ...
                                                    <option value="Andhra Pradesh Board of Intermediate Education" <?php if ($ssc_boardname == "Andhra Pradesh Board of Intermediate Education") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Andhra
                                                        Pradesh Board of Intermediate
                                                        Education
                                                    </option>
                                                    <option value="Andhra Pradesh Board of Secondary Education" <?php if ($ssc_boardname == "Andhra Pradesh Board of Secondary Education") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>Andhra
                                                        Pradesh Board of Secondary Education
                                                    </option>
                                                    <option value="Assam Board of Secondary Education" <?php if ($ssc_boardname == "Assam Board of Secondary Education") {
                                                                                                            echo "selected";
                                                                                                        } ?>>
                                                        Assam Board of Secondary Education
                                                    </option>
                                                    <option value="Bihar Intermediate Education Council" <?php if ($ssc_boardname == "Bihar Intermediate Education Council") {
                                                                                                                echo "selected";
                                                                                                            } ?>>Bihar
                                                        Intermediate Education Council
                                                    </option>
                                                    <option value="Bihar School Examination Board" <?php if ($ssc_boardname == "Bihar School Examination Board") {
                                                                                                        echo "selected";
                                                                                                    } ?>>Bihar
                                                        School Examination Board
                                                    </option>
                                                    <option value="Board of Higher Secondary Education,New Delhi" <?php if ($ssc_boardname == "Board of Higher Secondary Education,New Delhi") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Board of
                                                        Higher Secondary Education,New
                                                        Delhi
                                                    </option>
                                                    <option value="Board of School Education, Haryana" <?php if ($ssc_boardname == "Board of School Education, Haryana") {
                                                                                                            echo "selected";
                                                                                                        } ?>>
                                                        Board of School Education, Haryana
                                                    </option>
                                                    <option value="Board of Secondary Education Kant Shahjahanpur Uttar Pradesh" <?php if ($ssc_boardname == "Board of Secondary Education Kant Shahjahanpur Uttar Pradesh") {
                                                                                                                                        echo "selected";
                                                                                                                                    } ?>>Board of Secondary Education Kant
                                                        Shahjahanpur Uttar
                                                        Pradesh</option>
                                                    <option value="Board of Secondary Education Madhya Bharat Gwalior" <?php if ($ssc_boardname == "Board of Secondary Education Madhya Bharat Gwalior") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>Board of Secondary Education
                                                        Madhya Bharat
                                                        Gwalior
                                                    </option>
                                                    <option value="Board of Secondary Education, Madhya Pradesh" <?php if ($ssc_boardname == "Board of Secondary Education, Madhya Pradesh") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Board of
                                                        Secondary Education, Madhya Pradesh
                                                    </option>
                                                    <option value="Board of Secondary Education, Rajasthan" <?php if ($ssc_boardname == "Board of Secondary Education, Rajasthan") {
                                                                                                                echo "selected";
                                                                                                            } ?>>Board of
                                                        Secondary Education, Rajasthan </option>
                                                    <option value="Board of Youth Education India" <?php if ($ssc_boardname == "Board of Youth Education India") {
                                                                                                        echo "selected";
                                                                                                    } ?>>Board
                                                        of Youth Education India</option>
                                                    <option value="Central Board Of Education Ajmer New Delhi" <?php if ($ssc_boardname == "Central Board Of Education Ajmer New Delhi") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>Central
                                                    ...
                                                    <option value="Chhattisgarh Board of Secondary Education" <?php if ($ssc_boardname == "Chhattisgarh Board of Secondary Education") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>Chhattisgarh
                                                        Board of Secondary Education
                                                    </option>
                                                    <option value="Goa Board of Secondary & Higher Secondary Education" <?php if ($ssc_boardname == "Goa Board of Secondary & Higher Secondary Education") {
                                                                                                                            echo "selected";
                                                    ...
                                                    <option value="Himachal Pradesh Board of School Education" <?php if ($ssc_boardname == "Himachal Pradesh Board of School Education") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>Himachal
                                                        Pradesh Board of School Education
                                                    </option>
                                                    <option value="Institution of Secondary Distance Education" <?php if ($ssc_boardname == "Institution of Secondary Distance Education") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>Institution of Secondary Distance Education
                                                    </option>
                                                    <option value="J&K State Board of School Education" <?php if ($ssc_boardname == "J&K State Board of School Education") {
                                                                                                            echo "selected";
                                                                                                        } ?>>
                                                    ...
                                                    <option value="Karnataka Board of the Pre-University Education" <?php if ($ssc_boardname == "Karnataka Board of the Pre-University Education") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Karnataka Board of the
                                                        Pre-University
                                                        Education
                                                    </option>
                                                    <option value="Karnataka Secondary Education Examination Board" <?php if ($ssc_boardname == "Karnataka Secondary Education Examination Board") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Karnataka Secondary Education
                                                        Examination
                                                        Board
                                                    </option>
                                                    <option value="Kerala Board of Public Examinations" <?php if ($ssc_boardname == "Kerala Board of Public Examinations") {
                                                                                                            echo "selected";
                                                                                                        } ?>>
                                                        Kerala Board of Public Examinations
                                                    </option>
                                                    <option value="Madhya Pradesh State Open School Education Board" <?php if ($ssc_boardname == "Madhya Pradesh State Open School Education Board") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>Madhya Pradesh State Open
                                                        School Education
                                                        Board
                                                    </option>
                                                    <option value="Maharashtra State Board of Secondary and Higher Secondary Education" <?php if ($ssc_boardname == "Maharashtra State Board of Secondary and Higher Secondary Education") {
                                                                                                                                            echo "selected";
                                                                                                                                        } ?>>Maharashtra State Board of Secondary and
                                                        Higher
                                                        Secondary Education
                                                    </option>
                                                    <option value="Manipur Board of Secondary Education" <?php if ($ssc_boardname == "Manipur Board of Secondary Education") {
                                                                                                                echo "selected";
                                                                                                            } ?>>Manipur Board of
                                                        Secondary Education
                                                    </option>
                                                    <option value="Manipur Council of Higher Secondary Education" <?php if ($ssc_boardname == "Manipur Council of Higher Secondary Education") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Manipur
                                                        Council of Higher Secondary
                                                        Education
                                                    </option>
                                                    <option value="Meghalaya Board of School Education" <?php if ($ssc_boardname == "Meghalaya Board of School Education") {
                                                                                                            echo "selected";
                                                                                                        } ?>>
                                                        Meghalaya Board of School Education
                                                    </option>
                                                    <option value="Mizoram Board of School Education" <?php if ($ssc_boardname == "Mizoram Board of School Education") {
                                                                                                            echo "selected";
                                                                                                        } ?>>
                                                        Mizoram Board of School Education
                                                    </option>
                                                    <option value="Nagaland Board of School Education" <?php if ($ssc_boardname == "Nagaland Board of School Education") {
                                                                                                            echo "selected";
                                                                                                        } ?>>
                                                        Nagaland Board of School Education
                                                    </option>
                                                    <option value="Northwest Accreditation Commission & [NWAC]" <?php if ($ssc_boardname == "Northwest Accreditation Commission & [NWAC]") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>Northwest
                                                        Accreditation Commission & [NWAC]
                                                    </option>
                                                    <option value="Orissa Board of Secondary Education" <?php if ($ssc_boardname == "Orissa Board of Secondary Education") {
                                                                                                            echo "selected";
                                                                                                        } ?>>
                                                        Orissa Board of Secondary Education
                                                    </option>
                                                    <option value="Orissa Council of Higher Secondary Education" <?php if ($ssc_boardname == "Orissa Council of Higher Secondary Education") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Orissa
                                                    ...
                                                    <option value="Rajasthan Board of Secondary Education" <?php if ($ssc_boardname == "Rajasthan Board of Secondary Education") {
                                                                                                                echo "selected";
                                                                                                            } ?>>Rajasthan Board
                                                        of Secondary Education
                                                    </option>
                                                    <option value="Sampurnanand Sanskrit Vishwavidyalaya Varanasi Uttar Pradesh" <?php if ($ssc_boardname == "Sampurnanand Sanskrit Vishwavidyalaya Varanasi Uttar Pradesh") {
                                                                                                                                        echo "selected";
                                                                                                                                    } ?>>
                                                        Sampurnanand Sanskrit Vishwavidyalaya Varanasi Uttar
                                                        Pradesh</option>
                                                    <option value="Tamil Nadu Board of Higher Secondary Education" <?php if ($ssc_boardname == "Tamil Nadu Board of Higher Secondary Education") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Tamil
                                                        Nadu Board of Higher Secondary
                                                        Education
                                                    </option>
                                                    <option value="Tamil Nadu Board of Secondary Education" <?php if ($ssc_boardname == "Tamil Nadu Board of Secondary Education") {
                                                                                                                echo "selected";
                                                                                                            } ?>>Tamil Nadu
                                                        Board of Secondary Education
                                                    </option>
                                                    <option value="Tamilnadu Council for Open and Distance Learning" <?php if ($ssc_boardname == "Tamilnadu Council for Open and Distance Learning") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>Tamilnadu Council for Open and
                                                        Distance
                                                        Learning
                                                    </option>
                                                    <option value="Telangana State Board of Intermediate Education" <?php if ($ssc_boardname == "Telangana State Board of Intermediate Education") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Telangana State Board of
                                                        Intermediate
                                                        Education
                                                    </option>
                                                    <option value="The West Bengal Council of Rabindra Open Schooling" <?php if ($ssc_boardname == "The West Bengal Council of Rabindra Open Schooling") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>The
                                                        West Bengal Council of Rabindra Open
                                                        Schooling
                                                    </option>
                                                    <option value="Tripura Board of Secondary Education" <?php if ($ssc_boardname == "Tripura Board of Secondary Education") {
                                                                                                                echo "selected";
                                                                                                            } ?>>Tripura Board of
                                                        Secondary Education
                                                    </option>
                                                    <option value="Uttar Pradesh Board of High School and Intermediate Education" <?php if ($ssc_boardname == "Uttar Pradesh Board of High School and Intermediate Education") {
                                                                                                                                        echo "selected";
                                                                                                                                    } ?>>Uttar Pradesh Board of High School and
                                                        Intermediate
                                                        Education</option>
                                                    <option value="Uttarakhand Board of School Education" <?php if ($ssc_boardname == "Uttarakhand Board of School Education") {
                                                                                                                echo "selected";
                                                                                                            } ?>>
                                                    ...
                                                    <option value="West Bengal Board of Secondary Education" <?php if ($ssc_boardname == "West Bengal Board of Secondary Education") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>West Bengal
                                                        Board of Secondary Education
                                                    </option>
                                                    <option value="West Bengal Council of Higher Secondary Education" <?php if ($ssc_boardname == "West Bengal Council of Higher Secondary Education") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>West
                                                        Bengal Council of Higher Secondary
                                                        Education
                                                    </option>
                                                    <option value="KARNATAKA PRE-UNIVERSITY EDUCATION EXAMINATION" <?php if ($ssc_boardname == "KARNATAKA PRE-UNIVERSITY EDUCATION EXAMINATION") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>
                                                        KARNATAKA PRE-UNIVERSITY EDUCATION EXAMINATION</option>
                                                    <option value="West Bengal State Council of Vocational Education and Training" <?php if ($ssc_boardname == "West Bengal State Council of Vocational Education and Training") {
                                                                                                                                        echo "selected";
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input name="ssc_schoolname" value="<?php echo $ssc_schoolname; ?>" type="text" maxlength="250" id="school_name_input_id" class="form-control" placeholder="Enter School Name" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <label for="last_name">Aggregate Percentage</label>
                                                <input value="<?php echo $ssc_percentage; ?>" name="ssc_percentage" type="number" maxlength="5" id="percentage_input_id" class="form-control" placeholder="Enter Aggregate Percentage" />
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label for="last_name">Passing Month</label>
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="gender">Passing Year</label>
                                        ...
                                        ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="mobile_number">Stream</label>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="email">Board Name</label>
                                                    <select name="hsc_passingboard" id="board_name_input_id" class="form-control select2me">
                                                        ...
                                                        <option value="Andhra Pradesh Board of Intermediate Education" <?php if ($hsc_passingboard == "Andhra Pradesh Board of Intermediate Education") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>Andhra Pradesh Board of
                                                            Intermediate
                                                            Education
                                                        </option>
                                                        <option value="Andhra Pradesh Board of Secondary Education" <?php if ($hsc_passingboard == "Andhra Pradesh Board of Secondary Education") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Andhra
                                                            Pradesh Board of Secondary Education
                                                        </option>
                                                        <option value="Assam Board of Secondary Education" <?php if ($hsc_passingboard == "Assam Board of Secondary Education") {
                                                                                                                echo "selected";
                                                                                                            } ?>>
                                                            Assam Board of Secondary Education
                                                        </option>
                                                        <option value="Bihar Intermediate Education Council" <?php if ($hsc_passingboard == "Bihar Intermediate Education Council") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>Bihar
                                                            Intermediate Education Council
                                                        </option>
                                                        <option value="Bihar School Examination Board" <?php if ($hsc_passingboard == "Bihar School Examination Board") {
                                                                                                            echo "selected";
                                                                                                        } ?>>Bihar
                                                            School Examination Board
                                                        </option>
                                                        <option value="Board of Higher Secondary Education,New Delhi" <?php if ($hsc_passingboard == "Board of Higher Secondary Education,New Delhi") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>Board
                                                            of Higher Secondary Education,New
                                                            Delhi
                                                        </option>
                                                        <option value="Board of School Education, Haryana" <?php if ($hsc_passingboard == "Board of School Education, Haryana") {
                                                                                                                echo "selected";
                                                                                                            } ?>>
                                                            Board of School Education, Haryana
                                                        </option>
                                                        <option value="Board of Secondary Education Kant Shahjahanpur Uttar Pradesh" <?php if ($hsc_passingboard == "Board of Secondary Education Kant Shahjahanpur Uttar Pradesh") {
                                                                                                                                            echo "selected";
                                                                                                                                        } ?>>Board of Secondary Education Kant
                                                            Shahjahanpur Uttar
                                                            Pradesh</option>
                                                        <option value="Board of Secondary Education Madhya Bharat Gwalior" <?php if ($hsc_passingboard == "Board of Secondary Education Madhya Bharat Gwalior") {
                                                                                                                                echo "selected";
                                                                                                                            } ?>>Board of Secondary
                                                            Education Madhya Bharat
                                                            Gwalior
                                                        </option>
                                                        <option value="Board of Secondary Education, Madhya Pradesh" <?php if ($hsc_passingboard == "Board of Secondary Education, Madhya Pradesh") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>Board
                                                            of Secondary Education, Madhya Pradesh
                                                        </option>
                                                        <option value="Board of Secondary Education, Rajasthan" <?php if ($hsc_passingboard == "Board of Secondary Education, Rajasthan") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>Board of
                                                            Secondary Education, Rajasthan </option>
                                                        <option value="Board of Youth Education India" <?php if ($hsc_passingboard == "Board of Youth Education India") {
                                                                                                            echo "selected";
                                                                                                        } ?>>Board
                                                            of Youth Education India</option>
                                                        <option value="Central Board Of Education Ajmer New Delhi" <?php if ($hsc_passingboard == "Central Board Of Education Ajmer New Delhi") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Central
                                                            Board Of Education Ajmer New Delhi
                                                        </option>
                                                        <option value="Central Board Of Patna, Bihar" <?php if ($hsc_passingboard == "Central Board Of Patna, Bihar") {
                                                                                                            echo "selected";
                                                                                                        } ?>>
                                                            Central Board Of Patna, Bihar</option>
                                                        <option value="Chhattisgarh Board of Secondary Education" <?php if ($hsc_passingboard == "Chhattisgarh Board of Secondary Education") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Chhattisgarh Board of Secondary Education
                                                        </option>
                                                        <option value="Goa Board of Secondary & Higher Secondary Education" <?php if ($hsc_passingboard == "Goa Board of Secondary & Higher Secondary Education") {
                                                                                                                                echo "selected";
                                                                                                                            } ?>>Goa Board of Secondary &
                                                            Higher Secondary
                                                            Education
                                                        ...
                                                        <option value="Himachal Pradesh Board of School Education" <?php if ($hsc_passingboard == "Himachal Pradesh Board of School Education") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Himachal
                                                            Pradesh Board of School Education
                                                        </option>
                                                        <option value="Institution of Secondary Distance Education" <?php if ($hsc_passingboard == "Institution of Secondary Distance Education") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Institution of Secondary Distance Education
                                                        </option>
                                                        <option value="J&K State Board of School Education" <?php if ($hsc_passingboard == "J&K State Board of School Education") {
                                                                                                                echo "selected";
                                                                                                            } ?>>
                                                            J&K State Board of School Education
                                                        </option>
                                                        <option value="Jharkhand Academic Council" <?php if ($hsc_passingboard == "Jharkhand Academic Council") {
                                                            ...
                                                            Academic Council</option>
                                                        <option value="KARNATAKA PRE-UNIVERSITY EDUCATION EXAMINATION" <?php if ($hsc_passingboard == "KARNATAKA PRE-UNIVERSITY EDUCATION EXAMINATION") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>
                                                            KARNATAKA PRE-UNIVERSITY EDUCATION EXAMINATION</option>
                                                        <option value="Karnataka Board of the Pre-University Education" <?php if ($hsc_passingboard == "Karnataka Board of the Pre-University Education") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>Karnataka Board of the
                                                            Pre-University
                                                            Education
                                                        </option>
                                                        <option value="Karnataka Secondary Education Examination Board" <?php if ($hsc_passingboard == "Karnataka Secondary Education Examination Board") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>Karnataka Secondary Education
                                                            Examination
                                                            Board
                                                        </option>
                                                        <option value="Kerala Board of Public Examinations" <?php if ($hsc_passingboard == "Kerala Board of Public Examinations") {
                                                                                                                echo "selected";
                                                                                                            } ?>>
                                                            Kerala Board of Public Examinations
                                                        </option>
                                                        <option value="Madhya Pradesh State Open School Education Board" <?php if ($hsc_passingboard == "Madhya Pradesh State Open School Education Board") {
                                                                                                                                echo "selected";
                                                                                                                            } ?>>Madhya Pradesh State Open
                                                            School Education
                                                            Board
                                                        </option>
                                                        <option value="Maharashtra State Board of Secondary and Higher Secondary Education" <?php if ($hsc_passingboard == "Maharashtra State Board of Secondary and Higher Secondary Education") {
                                                                                                                                                echo "selected";
                                                                                                                                            } ?>>Maharashtra State Board of Secondary and
                                                            Higher
                                                            Secondary Education
                                                        </option>
                                                        <option value="Manipur Board of Secondary Education" <?php if ($hsc_passingboard == "Manipur Board of Secondary Education") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>Manipur Board
                                                            of Secondary Education
                                                        </option>
                                                        <option value="Manipur Council of Higher Secondary Education" <?php if ($hsc_passingboard == "Manipur Council of Higher Secondary Education") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>Manipur Council of Higher
                                                            Secondary
                                                            Education
                                                        </option>
                                                        <option value="Meghalaya Board of School Education" <?php if ($hsc_passingboard == "Meghalaya Board of School Education") {
                                                                                                                echo "selected";
                                                                                                            } ?>>
                                                            Meghalaya Board of School Education
                                                        </option>
                                                        <option value="Mizoram Board of School Education" <?php if ($hsc_passingboard == "Mizoram Board of School Education") {
                                                                                                                echo "selected";
                                                                                                            } ?>>
                                                            Mizoram Board of School Education
                                                        </option>
                                                        <option value="Nagaland Board of School Education" <?php if ($hsc_passingboard == "Nagaland Board of School Education") {
                                                                                                                echo "selected";
                                                                                                            } ?>>
                                                            Nagaland Board of School Education
                                                        </option>
                                                        <option value="Northwest Accreditation Commission & [NWAC]" <?php if ($hsc_passingboard == "Northwest Accreditation Commission & [NWAC]") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Northwest Accreditation Commission &
                                                            [NWAC]
                                                        </option>
                                                        <option value="Orissa Board of Secondary Education" <?php if ($hsc_passingboard == "Orissa Board of Secondary Education") {
                                                                                                                echo "selected";
                                                                                                            } ?>>
                                                            Orissa Board of Secondary Education
                                                        </option>
                                                        <option value="Orissa Council of Higher Secondary Education" <?php if ($hsc_passingboard == "Orissa Council of Higher Secondary Education") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>Orissa
                                                            Council of Higher Secondary Education
                                                        </option>
                                                        <option value="Punjab School Education Board" <?php if ($hsc_passingboard == "Punjab School Education Board") {
                                                                                                            echo "selected";
                                                                                                        } ?>>Punjab
                                                            School Education Board</option>
                                                        <option value="Rajasthan Board of Secondary Education" <?php if ($hsc_passingboard == "Rajasthan Board of Secondary Education") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>Rajasthan
                                                            Board of Secondary Education
                                                        </option>
                                                        <option value="Sampurnanand Sanskrit Vishwavidyalaya Varanasi Uttar Pradesh" <?php if ($hsc_passingboard == "Sampurnanand Sanskrit Vishwavidyalaya Varanasi Uttar Pradesh") {
                                                                                                                                            echo "selected";
                                                                                                                                        } ?>>
                                                            Sampurnanand Sanskrit Vishwavidyalaya Varanasi Uttar
                                                            Pradesh</option>
                                                        <option value="Tamil Nadu Board of Higher Secondary Education" <?php if ($hsc_passingboard == "Tamil Nadu Board of Higher Secondary Education") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>Tamil Nadu Board of Higher Secondary
                                                            Education
                                                        </option>
                                                        <option value="Tamil Nadu Board of Secondary Education" <?php if ($hsc_passingboard == "Tamil Nadu Board of Secondary Education") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>Tamil Nadu
                                                            Board of Secondary Education
                                                        </option>
                                                        <option value="Tamilnadu Council for Open and Distance Learning" <?php if ($hsc_passingboard == "Tamilnadu Council for Open and Distance Learning") {
                                                                                                                                echo "selected";
                                                                                                                            } ?>>Tamilnadu Council for Open and
                                                            Distance
                                                            Learning
                                                        </option>
                                                        <option value="Telangana State Board of Intermediate Education" <?php if ($hsc_passingboard == "Telangana State Board of Intermediate Education") {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>Telangana State Board of
                                                            Intermediate
                                                            Education
                                                        </option>
                                                        <option value="The West Bengal Council of Rabindra Open Schooling" <?php if ($hsc_passingboard == "The West Bengal Council of Rabindra Open Schooling") {
                                                                                                                                echo "selected";
                                                                                                                            } ?>>The West Bengal Council
                                                            of Rabindra Open
                                                            Schooling
                                                        </option>
                                                        <option value="Tripura Board of Secondary Education" <?php if ($hsc_passingboard == "Tripura Board of Secondary Education") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>Tripura Board
                                                            of Secondary Education
                                                        </option>
                                                        <option value="Uttar Pradesh Board of High School and Intermediate Education" <?php if ($hsc_passingboard == "Uttar Pradesh Board of High School and Intermediate Education") {
                                                                                                                                            echo "selected";
                                                                                                                                        } ?>>Uttar Pradesh Board of High School and
                                                            Intermediate
                                                            Education</option>
                                                        <option value="Uttarakhand Board of School Education" <?php if ($hsc_passingboard == "Uttarakhand Board of School Education") {
                                                                                                                    echo "selected";
                                                                                                                } ?>>
                                                            Uttarakhand Board of School Education
                                                        </option>
                                                        <option value="H P Board Of School Education" <?php if ($hsc_passingboard == "H P Board Of School Education") {
                                                                                                            echo "selected";
                                                                                                        } ?>>
                                                            H P Board Of School Education
                                                        </option>
                                                        ...
                                                        <option value="West Bengal Board of Secondary Education" <?php if ($hsc_passingboard == "West Bengal Board of Secondary Education") {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>West
                                                            Bengal Board of Secondary Education
                                                        </option>
                                                        <option value="West Bengal Council of Higher Secondary Education" <?php if ($hsc_passingboard == "West Bengal Council of Higher Secondary Education") {
                                                                                                                                echo "selected";
                                                                                                                            } ?>>West Bengal Council of
                                                            Higher Secondary
                                                            Education
                                                        </option>
                                                        <option value="West Bengal State Council of Vocational Education and Training" <?php if ($hsc_passingboard == "West Bengal State Council of Vocational Education and Training") {
                                                                                                                                            echo "selected";
                                                                                                                                        } ?>>West Bengal State Council of Vocational
                                                            Education and
                                                            Training</option>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label for="dob">Seat Number</label>
                                                    <input value="<?php echo $hsc_boardseatnumber; ?>" name="hsc_boardseatnumber" type="number" maxlength="15" id="seat_number_input_id" class="form-control" placeholder="Enter Seat Number" />
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="blood_group">Passing Status</label>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input value="<?php echo $hsc_schoolname; ?>" name="hsc_schoolname" type="text" maxlength="250" id="school_name_input_id" class="form-control" placeholder="Enter School Name" />
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="caste">Aggregate Percentage</label>
                                                    <input value="<?php echo $hsc_percentage; ?>" name="hsc_percentage" type="number" maxlength="5" id="percentage_input_id" class="form-control" placeholder="Enter Aggregate Percentage" />
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="adhar">Passing Month</label>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="adhar">Passing Year</label>
                                        ...
                                        if ($stu_faculty_id == 1 || $stu_faculty_id == 15 || $stu_faculty_id == 2) {
                                            ...
                                            ?>
                                                ...
                                                <div class="row" style="display: flex; flex-direction:column;">
                                                    <div class="row">
                                                        <h5 class="heading-p">Competitive Exam Details</h5>
                                                        <hr>
                                                    </div>
                                                    <script>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-3">
                                                            <label for="father">GUJCET Appearance</label><br>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div id="ifgujcetyes" style="display:block;">
                                                                <div class="row">
                                                                    <div class="form-group col-md-6">
                                                                        <label for="father">Seat Number</label>
                                                                        <input value="<?php echo $gujcet_seatnumber; ?>" name="gujcet_seatnumber" type="text" maxlength="25" id="seat_number_input_id" class="form-control" placeholder="Enter Seat Number" />
                                                                    </div>

                                                                    <div class="form-group col-md-6">
                                                                        <label for="mother">Application Number</label>
                                                                        <input value="<?php echo $gujcet_applicationnumber; ?>" name="gujcet_applicationnumber" type="text" maxlength="25" id="application_number_input_id" class="form-control" placeholder="Enter Application Number" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-sm-3">
                                                            <label for="father_occupation">NEET Appearance</label><br>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div id="ifneetyes" style="display:block;">

                                                                <div class="row">
                                                                    <div class="form-group col-md-6">
                                                                        <label for="father_occupation">Seat Number</label>
                                                                        <input value="<?php echo $neet_seatnumber; ?>" name="neet_seatnumber" type="text" maxlength="25" id="seat_number_input_id" class="form-control" placeholder="Enter Seat Number" />
                                                                    </div>

                                                                    <div class="form-group col-md-6">
                                                                        <label for="mother_occupation">Application Number</label>
                                                                        <input value="<?php echo $neet_applicationnumber; ?>" name="neet_applicationnumber" type="text" maxlength="25" id="application_number_input_id" class="form-control" placeholder="Enter Application Number" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-sm-3">
                                                            <label for="parents_number">JEE Appearance</label><br>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div id="ifjeeyes" style="display:block;">
                                                                <div class="row">
                                                                    <div class="form-group col-md-6">
                                                                        <label for="parents_number">Seat Number</label>
                                                                        <input value="<?php echo $jee_seatnumber; ?>" name="jee_seatnumber" type="text" maxlength="25" id="seat_number_input_id" class="form-control" placeholder="Enter Seat Number" />
                                                                    </div>

                                                                    <div class="form-group col-md-6">
                                                                        <label for="parents_email">Application Number</label>
                                                                        <input value="<?php echo $jee_applicationnumber; ?>" name="jee_applicationnumber" type="text" maxlength="25" id="application_number_input_id" class="form-control" placeholder="Enter Application Number" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="address">Graduation Course</label>
                                                    <input value="<?php echo $graduation_course; ?>" name="graduation_course" type="text" maxlength="250" id="course_input_id" class="form-control" placeholder="Enter Graduation Course" />
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="pincode">University</label><!--  -->
                                                    <input value="<?php echo $graduation_university; ?>" name="graduation_university" type="text" maxlength="250" id="seat_number_input_id" class="form-control" placeholder="Select University Name" />
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="pincode">College Name</label>
                                                    <input value="<?php echo $graduation_college_name; ?>" name="graduation_college_name" type="text" maxlength="250" id="college_name_input_id" class="form-control" placeholder="Enter College Name" />
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input value="<?php echo $graduation_cpi; ?>" name="graduation_cpi" type="number" maxlength="5" id="percentage_input_id" class="form-control" placeholder="Enter Aggregate Percentage" />
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="caste">Passing Status</label>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label for="permanent_address">Passing Month</label>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input value="<?php echo $gmcet_score; ?>" name="gmcet_score" type="text" maxlength="5" id="percentage_input_id" class="form-control" placeholder="Enter Score" />
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="permanent_pincode">CMAT Score</label>
                                                    <input value="<?php echo $cmat_score; ?>" name="cmat_score" type="text" maxlength="5" id="percentage_input_id" class="form-control" placeholder="Enter Score" />
                                                </div>
