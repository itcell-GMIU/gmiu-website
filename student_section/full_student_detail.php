                    ...
                    <img src="https://th.bing.com/th/id/OIP.aNuVPko-fipxD4-hwuKSTQHaHl?pid=ImgDet&rs=1"
                        id="profile_img" class="rounded float-right" alt="...">
                                ...
                                if ($result->num_rows == 1) {
                                 ...
                                 {
                                    $photo=$row['photo'];
                                     echo"<li> Photo :-<a href=$upload_document_url$stu_id/$photo download><i class='fa fa-download' aria-hidden='true'></i> </a></li>";
                                   
                                 }
                                 if($row['aadharcard'] != null || $row['aadharcard']!= "")
                                 {
                                    $aadharcard=$row['aadharcard'];
                                    echo"<li> Aadhar card :-<a href=$upload_document_url$stu_id/$aadharcard download><i class='fa fa-download' aria-hidden='true'></i></a></li>";
                                     
                                 }
                                  if($row['parent_aadharcard'] != null || $row['parent_aadharcard']!= "")
                                 {
                                    $parent_aadharcard=$row['parent_aadharcard'];
                                    echo"<li> Parent Aadhar card :-<a href=$upload_document_url$stu_id/$parent_aadharcard download><i class='fa fa-download' aria-hidden='true'></i></a></li>";
                                     
                                 }
                                  if($row['school_leaving'] != null || $row['school_leaving']!= "")
                                 {
                                    $school_leaving=$row['school_leaving'];
                                    echo"<li> School Leaving Certificate :-<a href=$upload_document_url$stu_id/$school_leaving download><i class='fa fa-download' aria-hidden='true'></i></a></li>";  
                                 }
                                  if($row['ssc_marksheet'] != null || $row['ssc_marksheet']!= "")
                                 {
                                    $ssc_marksheet=$row['ssc_marksheet'];
                                    echo"<li> SSC Marksheet :-<a href=$upload_document_url$stu_id/$school_leaving download><i class='fa fa-download' aria-hidden='true'></i></a></li>";    
                                 }
                                  if($row['hsc_marksheet'] != null || $row['hsc_marksheet']!= "")
                                 {
                                    $hsc_marksheet=$row['hsc_marksheet'];
                                    echo"<li> HSC Marksheet :-<a href=$upload_document_url$stu_id/$hsc_marksheet download><i class='fa fa-download' aria-hidden='true'></i></a></li>";
                                    
                                 }
                                  if($row['caste_certificate'] != null || $row['caste_certificate']!= "")
                                 {
                                    $caste_certificate=$row['caste_certificate'];
                                    echo"<li> Cast Certificate :-<a href=$upload_document_url$stu_id/$caste_certificate download><i class='fa fa-download' aria-hidden='true'></i></a></li>";
                                    
                                 }
                                  if($row['gujcet_result'] != null || $row['gujcet_result']!= "")
                                 {
                                    $gujcet_result=$row['gujcet_result'];
                                    echo"<li> Gujcet Result :-<a href=$upload_document_url$stu_id/$gujcet_result download><i class='fa fa-download' aria-hidden='true'></i> </a></li>";
                                    
                                 }
                                  if($row['jee_result'] != null || $row['jee_result']!= "")
                                 {
                                    $jee_result=$row['jee_result'];
                                    echo"<li> JEE Result :-<a href=$upload_document_url$stu_id/$jee_result download><i class='fa fa-download' aria-hidden='true'></i></a></li>";
                                    
                                 }
                                  if($row['neet_result'] != null || $row['neet_result']!= "")
                                 {
                                    $neet_result=$row['neet_result'];
                                    echo"<li> NEET Result :-<a href=$upload_document_url$stu_id/$neet_result download><i class='fa fa-download' aria-hidden='true'></i></a></li>";
                                    
                                 }
                                  if($row['graduation_marksheet'] != null || $row['graduation_marksheet']!= "")
                                 {
                                    $graduation_marksheet=$row['graduation_marksheet'];
                                    echo"<li>Graduation Marksheets :-<a href=$upload_document_url$stu_id/$graduation_marksheet download><i class='fa fa-download' aria-hidden='true'></i></a></li>";
                                    
                                 }
                                  if($row['migration_certificate'] != null || $row['migration_certificate']!= "")
                                 {
                                    $migration_certificate=$row['migration_certificate'];
                                    echo"<li> Migration Certificate :-<a href=$upload_document_url$stu_id/$migration_certificate download><i class='fa fa-download' aria-hidden='true'></i></a></li>";
                                    
                                 }
                                 if($row['other_documents'] != null || $row['other_documents']!= "")
                                 {
                                    $other_documents=$row['other_documents'];
                                    echo" <li> Other Documents :-<a href=$upload_document_url$stu_id/$other_documents download><i class='fa fa-download' aria-hidden='true'></i></a></li>";
