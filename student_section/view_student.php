                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-label-group">
                                                <select name="url_program_id" id="program_id"
                                                    class="browser-default custom-select"
                                                    style="color:black; border-color:#325d88; border-width:2px"
                                                    >
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-label-group">
                                                <select name="url_admission_quota" id="admission_quota"
                                                    class="browser-default custom-select"
                                                    style="color:black; border-color:#325d88; border-width:2px"
                                                    >
                                                    ...
                                                    <option value="mq">MQ</option>
                                                        ...
                                                        <option value="d2dacpc">D2D ACPC</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                            ...
                            <div class="table-responsive">
                                <table id="acedemic1" class="dataTableLoad table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        if ($url_admission_quota != "") {
                                            $cmd = $cmd . " AND stu.admission_quota = '$url_admission_quota' ";
                                        }
