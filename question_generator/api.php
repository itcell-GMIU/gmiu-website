                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="sem" id="sem" class="form-control" required disabled>
                                               ...
                                               <?php
                                                ...
                                                ?>
                                                        <div class="form-group row" id="additional_fields_container">
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select name="chapter[]" class="form-control" id="chapter" required>
                                                                    <option value="<?php echo $s_chapter; ?>"><?php echo $s_chapter; ?></option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group col-md-4">
                                                   ...
                                                   <?php } ?>
                                                    ...
                                                    <!-- row -->
                                                    <div class="form-group row additional_container" style="display: none;">
                                                        <div class="form-group col-md-4">
                                                            <label for="chapter">Chapter<span style="color: red;">*</span></label>
                                                            <select name="chapter[]" class="form-control" id="chapter" required>
...
<script>
    ...
    //     const rowDiv = document.getElementById('.additional_container');
    //     const clonedRow = rowDiv.cloneNode(true);
    //     const removeButton = clonedRow.querySelector('#remove-quali-field');
    //     document.getElementById('.additional_container').style.display = 'block';
...
addButton.addEventListener('click', function() {
    // Select the cloned div using the class selector
    const rowDiv = document.querySelector('.additional_container');
    const clonedRow = rowDiv.cloneNode(true);
    const removeButton = clonedRow.querySelector('#remove-quali-field');
    document.querySelector('.additional_container').style.display = 'flex';
    removeButton.addEventListener('click', function() {
        const rowToRemove = this.parentNode.parentNode;
        rowToRemove.parentNode.removeChild(rowToRemove);
    });
