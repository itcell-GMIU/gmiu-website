...
SELECT pq.question_id, pq.bl_level, q.question, q.modify_question, q.marks
...
<head>
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('textarea.text_editor').forEach(function(el) {
                CKEDITOR.replace(el.id);
            });
        });
    </script>
    <style>
        /* Force CKEditor editor content text size */
        .cke_editable {
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="faculty_name" class="form-control"
                                                        id="faculty_name" value="<?php echo $faculty_name; ?>" readonly>
                                                </div>

                                                <div class="form-group col-md-4 ">
                                                    <label> Leval Name <span style="color: red;"> *</span></label>
                                                    <input type="text" name="leval_name" class="form-control"
                                                        id="leval_name" value="<?php echo $level_name; ?>" readonly>
                                                </div>

                                                <div class="form-group col-md-4 ">
                                                    <label> Program Name <span style="color: red;"> *</span></label>
                                                    <input type="text" name="program_name" class="form-control"
                                                        id="program_name" value="<?php echo $program_name; ?>" readonly>
                                                </div>

                                                <div class="form-group col-md-4 ">
                                                    <label>Semester<span style="color: red;"> *</span></label>
                                                    <input type="text" name="sem" class="form-control" id="sem"
                                                        value="<?php echo $sem; ?>" readonly>
                                                ...
                                                <div class="form-group col-md-4 ">
                                                    ...
                                                    <input type="text" name="marks" class="form-control" id="marks"
                                                        value="<?php echo $marks; ?>" readonly>

                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="exam_date">Subject Code <span
                                                            style="color: red;">*</span></label>
                                                    ...
                                                    ?>
                                                        ...
                                                        <input type="text" name="subject_code" class="form-control"
                                                            id="subject_code" value="<?php echo $subject_code1; ?>" readonly>
                                                    <?php } ?>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="exam_date">Subject Name <span
                                                            style="color: red;">*</span></label>
                                                    ...
                                                    ?>
                                                        ...
                                                        <input type="text" name="subject_code" class="form-control"
                                                            id="subject_code" value="<?php echo $subject_name; ?>" readonly>
                                                    <?php } ?>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select name="clg_name" class="form-control" id="clg_name" required>
                                                        ...
                                                        <option value="<?php echo $clg_name; ?>" selected>
                                                            <?php echo $clg_name; ?></option>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="exam_name" class="form-control" id="exam_name"
                                                        value="<?php echo $exam_name; ?>" required>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <div class="input-group clockpicker">
                                                        <input type="text" name="exam_time" class="form-control"
                                                            id="exam_time" value="<?php echo $exam_time; ?>" required>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <div class="input-group clockpicker">
                                                        <input type="text" name="end_time" class="form-control"
                                                            id="end_time" value="<?php echo $end_time; ?>" required>
                                                        <span class="input-group-addon">
                                                            <span class="glyphicon glyphicon-time"></span>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="exam_date" class="form-control" id="exam_date"
                                                        value="<?php echo $exam_date; ?>" required>
                                                </div>
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <?php
                                                    // Fetch all questions for this paper from tbl_paper_question
                                                    $question_stmt = $con->prepare("
                                                        SELECT pq.question_id, pq.bl_level, pq.sequence_no,q.question,  q.marks, q.modify_question
                                                        FROM tbl_paper_question pq
                                                        LEFT JOIN tbl_questions q ON pq.question_id = q.id
                                                        WHERE pq.paper_id = ?
                                                    ");
                                                    $question_stmt->bind_param("i", $id); // $id is the paper ID
                                                    $question_stmt->execute();
                                                    $questions_result = $question_stmt->get_result();

                                                    while ($qrow = $questions_result->fetch_assoc()) {
                                                        $original_question = $qrow['question'];
                                                        $seq = $qrow['sequence_no'];
                                                        $qmarks = $qrow['marks'];
                                                        $modified_question = !empty($qrow['modify_question']) ? $qrow['modify_question'] : $original_question;
                                                        /* Remove inline font-size styling */
                                                        $modified_question = preg_replace('/font-size:\s*\d+px;?/i', '', $modified_question);
                                                    ?>
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <div class="form-group">
                                                                    <div style="display: flex; align-items: center;">
                                                                        <label>Original Question: No :
                                                                            <?php echo htmlspecialchars($seq); ?>
                                                                        </label>
                                                                    
                                                                        <label style="margin-left:auto;">
                                                                            Question Mark : <?php echo htmlspecialchars($qmarks); ?>
                                                                        </label>
                                                                    </div>

                                                                    <div class="alert alert-info">
                                                                        <?php echo ($original_question); ?>
                                                                    </div>

                                                                    <label>Modified Question:</label>
                                                                    <textarea
                                                                        name="questions[<?php echo $qrow['question_id']; ?>][modify_questions]"
                                                                        class="form-control text_editor"
                                                                        id="question_<?php echo $qrow['question_id']; ?>"
                                                                        rows="3"><?php echo ($modified_question); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php } ?>
...
<!-- Make sure jQuery is only loaded once -->
...
<script>
    $(document).ready(function() {
        // Clockpickers
        $('#exam_time, #end_time').clockpicker({
            donetext: 'Done',
            autoclose: true,
            twelvehour: true
        });
