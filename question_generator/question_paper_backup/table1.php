        ...
        <table class="border border-dark c-b-t table" border="2">
            <div class="d-flex justify-content-center"> -->
                ...
                <thead>
                    ...
                    <tr>
                        <th colspan="3" style="padding:50px 8px 8px 8px; text-align: left;font-size: 12pt;">
                            <p>
                        ...
                        <th colspan="3" style="padding:50px 8px 8px 8px; text-align: left; font-size: 12pt; vertical-align: top;">
            ...
            echo "<tr><th  style='border: 1px solid black !important;'>CO</th>";
            
            // Display CO1 to CO5 headers
            for ($i = 1; $i <= 5; $i++) {
                echo "<th style='border: 1px solid black !important;padding: 0 50px;'>CO$i</th>";
            }
            echo "</tr><tr><td style='border: 1px solid black !important;padding: 0 50px;'>Marks</td>";
            
            // Display the total marks for each CO level
            for ($i = 1; $i <= 5; $i++) {
                $coKey = 'CO' . $i;
                if (isset($coMarks[$coKey])) {
                    echo "<td style='border: 1px solid black !important;padding: 0 50px;'>{$coMarks[$coKey]}</td>";
                } else {
                    echo "<td style='border: 1px solid black !important;padding: 0 50px;'>0</td>";
                }
            }
            echo "</tr></table>";
            ...
            echo "<table border='1' cellpadding='5' cellspacing='0' style='border-collapse: collapse; text-align: center;margin: 0px 0px 50px 60px;'>";
            echo "<tr><th  style='border: 1px solid black !important;padding: 0 50px;'rowspan='2'>Bloom's Taxonomy</th>
