...
$status = 0;
$cmd = $con->prepare("SELECT p.id, c.subject_code,c.sem, p.total_mark, p.question, c.subject_name,p.exam_date,
        ...
        <table class="border border-dark c-b-t table" border="2">
            <div class="d-flex justify-content-center"> -->
                ...
                <thead class= "">
                    ...
                    <tr>
                        <th colspan="6" style="padding: 8px; text-align: center;">
                    ...
                    <tr>
                        <th colspan="4" style="padding: 8px; text-align: left;">
                            <?php //echo$clg_name ; 
                            ?>
                            <?php //echo$exam_name; 
                            ?>
                        ...
                        <th colspan="2" style="padding: 8px; text-align: left; vertical-align: top;">
