...
<div class="wrapper">
    ...
    <div class="table-responsive">
        ...
        <table id="acedemic" class="dataTableLoad table border border-dark c-b-t table">
        <!-- <table id="acedemic" class="dataTableLoad table table-bordered table-striped "> -->
                               

                    <thead>    
                        <tr style="border-color: black;">
                            <th colspan="4" style="border: 1px solid black; padding: 8px; text-align: left;">
                                Enrollment No.:_________________<br>
                                Subject Code: <?php echo $subjectCode; ?><br>
                                Subject Name: <?php echo $subject_name; ?> <br>
                                Time:<br>
                                Instructions:
                                <ol style="line-height: 1.5; padding-left: 11%;">
                            ...
                            <th colspan="2" style="border: 1px solid black; padding: 8px; text-align: left; vertical-align: top;">
                                Date:<br>
