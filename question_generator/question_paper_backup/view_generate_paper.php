            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- + ADD Button  -->
                            <a class="btn btn-primary" style="margin-left: 90%;" href="generate_paper.php"><i class="fa-solid fa-plus"></i> Add</a>
                            <!-- + ADD Button End -->
                            <div class="table-responsive">
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        LEFT JOIN tbl_std_corner AS corner ON std.subject_code = corner.id
                                        ...
                                        ?>
                                            <tr align="center">
                                                ...
                                                <td scope="row">
                                                    <?php
                                                    $cmd2 = $con->prepare("SELECT subject_code , subject_name from tbl_std_corner where id = $subject_code ");
                                                    $cmd2->execute();
                                                ...
                                                <td scope="row">
                                                 <a href="table1.php?id=<?php echo $id ?>" target="new tab" class="btn btn-success"><i class="fas fa-eye"></i></a>  
