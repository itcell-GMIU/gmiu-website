...
$query = "SELECT
        ...
        WHERE que.is_delete = 0 and que.marks IN ('1', '2')
        AND que.mcq_choice_a IS NOT NULL
        AND que.mcq_choice_b IS NOT NULL
        AND que.mcq_choice_c IS NOT NULL
        AND que.mcq_choice_d IS NOT NULL
        AND corner.is_delete = 0";
                ...
                <div class="container-fluid">
                            ...
                            <form method="GET" action="">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <!-- Clear Filter Button -->
                                        <a href="view_mcq_question_bank.php" class="btn btn-secondary" style="margin-top: 25px; margin-left: 10px;">Clear Filter</a>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <span>
                                <center>
                                    <h5><b><i class="fas fa-book-reader"></i>View MCQ Question Bank</b></h5>
                                </center>
                            </span>
                        </div>
                        <!-- /.card-header -->
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            if ($role_id == 8 || $role_id == 51 || $role_id == 54) { ?>
                                                ...
                                                <td scope="row">
                                                    <a href="view_mcq_question.php?id=<?php echo $id ?>" class="btn btn-success"><i class="fas fa-eye"></i></a>
