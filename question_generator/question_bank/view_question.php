...
// Fetch question list
$query = $con->prepare("SELECT id, chapter, question, co_level, bl_level, marks FROM tbl_questions WHERE subject_code = ? AND is_delete = 0 AND marks NOT IN ('1', '2')");
                                        ...
                                        while ($row = $questions->fetch_assoc()) { ?>
                                            <tr>
                                                <td class="text-center"><?= $sr++ ?></td>
                                                 <td><?= $row['chapter'] ?></td>
                                                <td><?= $row['question'] ?></td>
                                                <td class="text-center"><?= $row['co_level'] ?></td>
                                                <td class="text-center"><?= $row['bl_level'] ?></td>
                                                <td class="text-center"><?= $row['marks'] ?></td>
                                                <?php
                                                if ($role_id == 8 || $role_id == 51 || $role_id == 54) { ?>

                                                    <td scope="row">
                                                        <a href="edit_question.php?id=<?php echo $row['id'] ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
