...
<body>
    ...
    <div class="wrapper">
        ...
        <table class="border border-dark c-b-t table" border="2">
            <div class="d-flex justify-content-center"> -->
                ...
                <thead>
                    ...
                    <tr class="header-info">
                        ...
                        <th colspan="3" style="padding: 25px 8px 8px 8px; text-align: left; font-size: 16pt; vertical-align: top;">
            ...
            echo "<table class='tbl-co' border='1' cellpadding='5' cellspacing='0' style='border-collapse: collapse; text-align:center; margin: 70px 0px 0 70px;font-size: 12pt;'>";
            ...
            echo "<table border='1' cellpadding='5' cellspacing='0' style='border-collapse: collapse; text-align: center;margin: 0px 0px 50px 60px;font-size: 12pt;'>";
