        ...
        <table class="border border-dark c-b-t table" border="2">
            <div class="d-flex justify-content-center"> -->
                ...
                <thead>
                    ...
                    <tr>
                        <th colspan="4" style="padding: 8px; text-align: left;font-size: 12pt;">
                            <p>
                        ...
                        <th colspan="2" style="padding: 8px; text-align: left; font-size: 12pt; vertical-align: top;">
            ...
            echo "<table class='tbl-co' border='1' cellpadding='5' cellspacing='0' style='border-collapse: collapse;  text-align: center;margin: 70px 0px 0 70px;'>";
            echo "<tr><th>CO</th>";

            // Dynamically generate CO headers
            for ($i = 1; $i <= count($chapterMarks); $i++) {
                echo "<th style='border: 1px solid black !important;padding: 0 70px;'>CO$i</th>";
            }
            echo "</tr><tr><td style='border: 1px solid black !important;padding: 0 70px;'>Marks</td>";

            // Dynamically generate CO marks
            for ($i = 1; $i <= count($chapterMarks); $i++) {
                if (isset($chapterMarks[$i])) {
                    echo "<td style='border: 1px solid black !important;padding: 0 70px;'>{$chapterMarks[$i]}</td>";
                } else {
                    echo "<td>-</td>";
                }
            }
            ...
            echo "<table border='1' cellpadding='5' cellspacing='0' style='border-collapse: collapse; text-align: center;margin: 0px 0px 60px 70px;'>";
            echo "<tr><th  style='border: 1px solid black !important;padding: 0 60px;'rowspan='2'>Bloom's Taxonomy</th><th colspan='6'>% Weightage As per Syllabus</th></tr>";
            echo "<tr>";

            // Dynamically generate Bloom's level headers
            $blLevels = array_keys($blMarks);
            foreach ($blLevels as $level) {
                echo "<td style='border: 1px solid black !important;padding: 0 45px;'>$level</td>";
            }
            echo "</tr><tr><td style='border: 1px solid black !important;padding: 0 45px;'>% Weightage</td>";

            foreach ($blMark as $marks) {
                echo "<td style='border: 1px solid black !important;padding: 0 45px;'>$marks</td>";
            }
            echo "</tr><tr><td style='border: 1px solid black !important;padding: 0 45px;'>Marks</td>";
