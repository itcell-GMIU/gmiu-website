            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- + ADD Button  -->
                            <a class="btn btn-primary" style="margin-left: 90%;" href="student_corner_insert.php"><i
                                    ...
                                    <tbody>
                                        ...
                                        if ($role_id == 8) {
                                            ...
                                            $cmd = $con->prepare("SELECT 
                                                                            ...
                                                                            std.sem AS sem,
                                                                            std.Syllabus AS Syllabus,
                                                                            std.subject_code AS subject_code,
                                                                            std.subject_name AS subject_name,
                                                                            std.subject_short_name AS subject_short_name,
                                                                            std.lectures AS lectures,
                                                                            std.tutorial AS tutorial,
                                                                            std.practical AS practical,
                                                                            std.credit AS credit,
                                                                            std.is_active AS std_is_active, 
                                                                            faculty.name AS faculty_name,
                                                                            level.name AS level_name,
                                                                            GROUP_CONCAT(program.name ORDER BY program.name SEPARATOR ', ') AS program_name
                                                                        FROM tbl_std_corner AS std
                                                                        LEFT JOIN tbl_faculty faculty 
                                                                            ON std.faculty_id = faculty.id 
                                                                        LEFT JOIN tbl_level level 
                                                                            ON std.level_id = level.id 
                                                                        LEFT JOIN tbl_program program 
                                                                            ON FIND_IN_SET(program.id, std.program_id) > 0
                                                                        WHERE std.is_delete = ?
                                                                        GROUP BY std.id");
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            <tr align="center">
                                                ...
                                                <td scope="row">
                                                    <a href="../uploads/Syllabus/<?php echo $Syllabus; ?>"
