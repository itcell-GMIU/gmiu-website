...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        // $stmt = $con->prepare("INSERT INTO `tbl_our_social`(faculty_id,level_id,program_id,title)VALUES (?,?,?,?)");
        // $stmt->bind_param("iiss", $faculty_id, $level_id, $program_id_str, $title);
        $stmt = $con->prepare("INSERT INTO `tbl_our_social`(program_id,title)VALUES (?,?)");
        $stmt->bind_param("ss", $program_id_str, $title);
        $result = $stmt->execute();
                                    ...
                                    <form id="quickForm" method="POST" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <!--        <option value="">---Select Faculty---</option>-->
                                                    ...
                                                    ?>
                                                    <!--<option value="<?php echo $row['id'] ?>" <?php if ($faculty_id == $row['id']) { echo "selected"; } ?>><?php echo $row['name'] ?></option>-->
                                                    <?php 
                                                    // } 
                                                    ?>
