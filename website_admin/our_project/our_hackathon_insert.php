...
if ($role_id == 8) {
    if (isset($_POST['submit'])) {
        ...
        $stmt = $con->prepare("INSERT INTO `tbl_our_hackathon`(faculty_id,level_id,program_id,title, team_leader, team_member, location)VALUES (?,?,?,?,?,?,?)");
        $stmt->bind_param("iiissss", $faculty_id, $level_id, $program_id, $title, $teamleader, $teammember, $location);
        $result = $stmt->execute();
        ...
        if (isset($_FILES['images']['tmp_name'])) {
            ...
            if ($uploaded_images['status'] == 200) {
                ...
                $_SESSION['status'] = "Our Hackathon Inserted Successfully";
                ...
                echo "<script>setTimeout(function(){window.location='our_hackathon_insert.php'},1000)</script>";
            }
        }
    }
?>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Add Our Hackathon</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                    <li class="breadcrumb-item active">Add Our Hackathon</li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-gmiu">
                                    <div class="card-header">
                                        <h3 class="card-title">Add Our Hackathon</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form id="quickForm" method="POST" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name">Hackathon Title<span style="color: red;">*</span></label>
                                                <input type="text" name="title" class="form-control" id="title_id" placeholder="Enter Our Hackathon Title" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="team_leader">Team Leader<span style="color: red;">*</span></label>
                                                <input type="text" name="team_leader" class="form-control" id="team_leader" placeholder="Enter Our Hackathon Team Leader" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="team_member">Team Member<span style="color: red;">*</span></label>
                                                <textarea name="team_member[]" class="form-control" id="team_member" placeholder="Enter Our Hackathon Team Leader"></textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="level_name">Upload Images<span style="color: red;">*</span></label>
...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $level_id = mysqli_real_escape_string($con, $_POST['level_id']);
            ...
            // Assuming $location is defined elsewhere in your code
 ...
 // Retrieve the team_member field as an array
 $teammembers = isset($_POST['team_member']) ? $_POST['team_member'] : array();
 
 // Implode the array to create a comma-separated string
 $teammember = implode(', ', array_map(function($item) use ($con) {
     return mysqli_real_escape_string($con, $item);
 }, $teammembers));
 

        // Validate Data
        // Assuming validate_data() is defined elsewhere in your code
        $title = validate_data($title);
                                    ...
                                    <form id="quickForm" method="POST" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" id="title_id" placeholder="Enter Title" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="team_leader">Team Leader<span style="color: red;">*</span></label>
                                                <input type="text" name="team_leader" class="form-control" id="team_leader" placeholder="Enter Team Leader" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="team_member">Team Member<span style="color: red;">*</span></label>
                                                <textarea name="team_member[]" class="form-control" id="team_member" placeholder="Enter Team Member"></textarea>
                                            </div>
