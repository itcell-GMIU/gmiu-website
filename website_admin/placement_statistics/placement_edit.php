...
<script>
    ...
    function load_program() {
        ...
        var faculty_id = <?php echo $faculty_id; ?>;
        var level_id = <?php echo $level_id; ?>;
        var program_id = '<?php echo $program_id; ?>'; // This can be "1,2,3"
        var api_for = "dashboard";
        $.ajax({
            ...
            success: function(result) {
                ...
                // If it's a comma separated string, we might need to trigger change after setting html
                // Select2 will pick up the 'selected' attributes from the HTML result
