            ...
            <div class="content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-2">
                        <!-- col -->
                        <div class="col-sm-6">
                            <h1 class="m-0">AI-ML Program Registration</h1>
                        </div><!-- /.col -->

                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">AI-ML Program Registration</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <span>
                                <center>
                                    <h5><b><i class="fas fa-book-reader"></i> AI-ML Program Registration</b></h5>
                                </center>
                            </span>
                        </div> <!-- /.card-header -->
                                ...
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                       <?php
                                        ...
                                        // Fetch AI-ML registrations from the new table
                                        $cmd = $con->prepare("
                                            SELECT id, full_name, mobile, standard, district, school_name, email, start_date, end_date, time_slot 
