...
if (isset($_POST['submit'])) {
    ...
    $stmt = $con->prepare("INSERT INTO `tbl_nss_contact_us` (`description`) VALUES (?)");
    $stmt->bind_param("s", $description);
    $result = $stmt->execute();
    $id = $con->insert_id;

    if ($result) {
        $_SESSION['status'] = "Contact Us Inserted Successfully";
        ...
        $_SESSION['status'] = "Contact UsInsertion Failed";
        $_SESSION['status_code'] = "error";
        echo "<script>setTimeout(function(){window.location='nss_contact_us_insert.php'},1000)</script>";
    }
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Add Contact Us</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
