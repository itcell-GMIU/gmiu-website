        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">View Sports Activity</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">View Sports Activity</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <span>
                                <center>
                                    <h5><b><i class="fas fa-globe"></i> View Sports Activity</b></h5>
                                </center>
                            </span>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <!-- + ADD Button  -->
                            <a class="btn btn-primary" style="margin-left: 90%;" href="sports_insert.php"><i class="fa-solid fa-plus"></i> Add</a>
                            <!-- + ADD Button End -->
                            <div class="table-responsive">
                                <table id="sports" class="dataTableLoad table table-bordered table-striped ">
                                    <thead>
                                        <tr align="center">
                                            ...
                                            <tr align="center">
                                                ...
                                                <td scope="row">
                                                   ...
                                                   $photo_result = $cmd->get_result();
                                                    ...
                                                    // Check if there are any images associated with the sports activity
                                                   if ($photo_result->num_rows > 0) {
                                                   // Loop through the result set and display each image
                                                   while ($row = $photo_result->fetch_assoc()) {
                                                   $file_name = $row['file_name'];
                                                   ?>
                                                    <a href="<?php echo "../uploads/sports/" . $file_name; ?>" target="_blank">
                                                     <img src="../uploads/sports/<?php echo $file_name; ?>" alt="" style="width: 100px;">
                                                     </a>
                                                    <?php
                                                    }
                                                    } else {
                                                   // If no images are found, display a message
                                                     echo "<p>No images found for this sports activity.</p>";
                                                     }
                                                 ?>
                                                 </td>
                                                ...
                                                <td scope="row">
                                                    <a href="sports_edit.php?sp_id=<?php echo $sp_id ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
                                                      <?php if($role_id == 11) { ?>
                                                    <a href="sports_delete.php?sp_id=<?php echo $sp_id; ?>" class="btn btn-danger"><i class="fas fa-trash"></i>
                                                    </a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
