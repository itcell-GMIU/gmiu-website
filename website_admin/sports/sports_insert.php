...
if (isset($_POST['submit'])) {
    ...
    $month = strtok('-');
    $type_id = 1;
    // Prepare and execute SQL statement for inserting data into 'tbl_sports'
    ...
    if ($_FILES['image_uploads']['error'][0]  == 0) {
        $targetDirectory = "../uploads/sports/";
        ...
        if ($uploaded_images['status'] == 200) {
            ...
            // Set session status and code for success
            $_SESSION['status'] = " sports Inserted Successfully";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Add Sports Activity</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Add Sports Activity</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                <div class="card-header">
                                    <h3 class="card-title">Add Sports Activity</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="quickForm" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="fileupload">Upload sports Photo(Multiple Allowed)
                                                <!-- <span style="color: red;">*</span> -->
                                            </label>
