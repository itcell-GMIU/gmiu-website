...
if (isset($_POST["submit"])) {
    ...
    if ($file_upload_status['status'] == 200) {
        ...
        $stmt = $con->prepare("DELETE FROM `tbl_even_report` WHERE id = ?");
    ...
    $stmt = $con->prepare("INSERT INTO `tbl_event_report`(date,event_year,event_name,event_description,report)VALUES (?,?,?,?,?)");
    $stmt->bind_param("sssss", $date, $year, $title, $description, $file_name);
    $result = $stmt->execute();
                                ...
                                <form id="event_report_upload" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" id="title" placeholder="Enter Event Report Title" required>
                                        </div>
...
<script>
    var img = document.forms['event_report_upload']['image_upload1'];
