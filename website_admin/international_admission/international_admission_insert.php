      ...
      //     $title = validate_data($title);
        ...
        if (isset($_POST["submit"])) {
            ...
            $type_id = 3;
              ...
              //  $id = $con->insert_id;
                if ($result) {
                    $_SESSION['status'] = "International admission Inserted Successfully";
                    $_SESSION['status_code'] = "success";

                    echo "<script>setTimeout(function(){window.location='international_admission_view.php'},1000);</script>";
                } else {
                    $_SESSION['status'] = "International admission Insertion Failed";
                    $_SESSION['status_code'] = "error";
                    echo "<script>setTimeout(function(){window.location='international_admission_insert.php'},1000)</script>";
                }
            } else {
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Add International Admission</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                    <li class="breadcrumb-item active">Add International Admission</li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-gmiu">
                                    <div class="card-header">
                                        <h3 class="card-title">Add International Admission</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form id="quickForm" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                           <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" id="title_id" placeholder="Enter International Admission Title" required>
                                           </div>
