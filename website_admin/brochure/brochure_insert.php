...
if (isset($_POST['submit'])) {
    ...
    $sno = isset($_POST['sno']) ? mysqli_real_escape_string($con, $_POST['sno']) : null;

    // Validate data
    $title = validate_data($title);
    $sno = validate_data($sno);

    $targetDirectory = "../uploads/brochure/thumbnail/";
    $file_name = null; // Initialize to avoid undefined variable
    ...
    $document = null; // Initialize to avoid undefined variable
    ...
    $stmt = $con->prepare("INSERT INTO `tbl_brochure`(title, thumbnail, document, sno) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("sssi", $title, $file_name, $document, $sno);
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="quickForm" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sno" class="form-control" id="sno_id" placeholder="Enter Sno" required>
                                        </div>
