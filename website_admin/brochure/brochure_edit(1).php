...
$status = 0;
$cmd = $con->prepare("SELECT brochure.id as brochure_id, brochure.title as brochure_title,brochure.document as brochure_document,brochure.thumbnail as brochure_thumbnail, brochure.is_active as brochure_is_active FROM tbl_brochure as brochure WHERE brochure.is_delete = ? and brochure.id = ?");
