...
if ($role_id == 8) {
    if (isset($_POST['submit'])) {
        ...
        $content = $_POST['program_description'];
        ...
        $stmt = $con->prepare("INSERT INTO `tbl_program_outcome`(faculty_id,level_id,program_id,title,content)VALUES (?,?,?,?,?)");
        $stmt->bind_param("iisss", $faculty_id, $level_id, $program_id, $title, $content);
        $result = $stmt->execute();
        if ($result) {
            if ($result) {
                //Sweet Alert of Success Message
                $_SESSION['status'] = "Program Outcome Inserted Successfully";
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Add Program Outcome</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                    <li class="breadcrumb-item active">Add Program Outcome</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-gmiu">
                                    <div class="card-header">
                                        <h3 class="card-title">Add Program Outcome</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form id="quickForm" method="POST">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" id="title_id" placeholder="Enter program Outcome Title" required>
                                            </div>
...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        // Prepare and execute the SQL statement to insert a record in the tbl_program_outcome
        $stmt = $con->prepare("INSERT INTO `tbl_program_outcome`(faculty_id,level_id,program_id,title,content)VALUES (?,?,?,?,?)");
        $stmt->bind_param("iisss", $faculty_id, $level_id, $program_id_str, $title, $content);
        $result = $stmt->execute();
        if ($result) {
            if ($result) {
                //Sweet Alert of Success Message
