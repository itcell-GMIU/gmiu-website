...
if ($role_id == 8) {
    if (isset($_POST['submit'])) {
        ...
        // fetch report
        $targetDirectory = "../uploads/interview_alumni/report/";
        ...
        $stmt = $con->prepare("INSERT INTO `tbl_interview_alumni`(faculty_id,level_id,program_id,i_a_type,date,description,report_file,title)VALUES (?,?,?,?,?,?,?,?)");
        $stmt->bind_param("isssssss", $faculty_id, $level_id, $program_id, $i_a_type, $date, $description, $file_name, $title);
        $result = $stmt->execute();
        $interview_alumni_id = $con->insert_id;


        // for multiple image upload in site photos
        if (isset($_FILES['images']['tmp_name'])) {
            $targetDirectory = "../uploads/interview_alumni/image/";
            ...
            if ($uploaded_images['status'] == 200) {
                foreach ($uploaded_images['message'] as $file_name) {
                    ...
                    $stmt->bind_param("ssss", $interview_alumni_id, $type, $file_name, $file_type);
                    $result = $stmt->execute();
                }

                $_SESSION['status'] = "Mock Interview & Alumni Inserted Successfully";
                ...
                echo "<script>setTimeout(function(){window.location='interview_alumni_insert.php'},1000)</script>";
            }
        }
    }
?>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Add Mock Interview & Alumni</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                    <li class="breadcrumb-item active">Add Mock Interview & Alumni</li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-gmiu">
                                    <div class="card-header">
                                        <h3 class="card-title">Add Mock Interview & Alumni</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form id="quickForm" method="POST" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" id="title_id" placeholder="Enter Mock Interview & Alumni Title" required>
                                            </div>
...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $title = mysqli_real_escape_string($con, $_POST['title']);
        $i_a_type = mysqli_real_escape_string($con, $_POST['i_a_type']);
        ...
        $stmt = $con->prepare("INSERT INTO `tbl_interview_alumni`(faculty_id,level_id,program_id,i_a_type,date,description,report_file,title)VALUES (?,?,?,?,?,?,?,?)");
        $stmt->bind_param("iiisssss", $faculty_id, $level_id, $program_id, $i_a_type, $date, $description, $file_name, $title);
        $result = $stmt->execute();
        $interview_alumni_id = $con->insert_id;
