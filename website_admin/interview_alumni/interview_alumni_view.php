        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">View Mock Interview & Alumni</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">View Mock Interview & Alumni</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <span>
                                <center>
                                    <h5><b><i class="fas fa-book-reader"></i>View Mock Interview & Alumni</b></h5>
                                </center>
                            </span>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <!-- + ADD Button  -->
                            <a class="btn btn-primary" style="margin-left: 90%;" href="interview_alumni_insert.php"><i class="fa-solid fa-plus"></i> Add</a>
                            <!-- + ADD Button End -->
                                ...
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                    <thead>
                                        <tr align="center">
                                            ...
                                            <th class="row" style="color:black;">Type</th>
                                    ...
                                    <tbody>
                                        ...
                                        if ($role_id == 8) {
                                            ...
                                            $cmd = $con->prepare("SELECT mock.id as mock_id, mock.faculty_id as faculty_id, mock.level_id as level_id, mock.program_id as program_id, mock.title as title, mock.is_active as program_is_active, mock.date as date,mock.i_a_type as i_a_type,  
                                            faculty.name as faculty_name, level.name as level_name, program.name as program_name FROM tbl_interview_alumni as mock 
                                            LEFT JOIN tbl_faculty faculty ON mock.faculty_id = faculty.id 
                                            LEFT JOIN tbl_level level ON mock.level_id = level.id
                                            LEFT JOIN tbl_program program ON mock.program_id = program.id  WHERE mock.is_delete = ? and mock.faculty_id = ? and mock.level_id IN ($level_placeholder) and mock.program_id IN ($program_id)");
                                            ...
                                            $cmd = $con->prepare("SELECT mock.id as mock_id, mock.faculty_id as faculty_id, mock.level_id as level_id, mock.program_id as program_id, mock.title as title, mock.is_active as program_is_active, mock.date as date,mock.i_a_type as i_a_type ,
                                                                ...
                                                                LEFT JOIN tbl_faculty faculty ON mock.faculty_id = faculty.id 
                                                                LEFT JOIN tbl_level level ON mock.level_id = level.id
                                                                LEFT JOIN tbl_program program ON mock.program_id = program.id  WHERE mock.is_delete = ?");
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            $mock_description = !empty($row['mock_description']) ? $row['mock_description'] : "<b>N/A</b>";
                                            $program_name = !empty($row['program_name']) ? $row['program_name'] : "<b>N/A</b>";
                                            $i_a_type = !empty($row['i_a_type']) ? $row['i_a_type'] : "<b>N/A</b>";
                                        ...
                                        ?>
                                            <tr align="center">
                                                ...
                                                <td scope="row">
                                                    <a href="interview_alumni_edit.php?mock_id=<?php echo $row['mock_id'] ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
                                                       <?php if($role_id == 11) { ?>
                                                    <a href="interview_alumni_delete.php?mock_id=<?php echo $row['mock_id'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
