...
if ($role_id == 8) {
    if (isset($_POST['submit'])) {
       ...
       // $level_id = validate_data($level_id);
        ...
        $stmt = $con->prepare("INSERT INTO `tbl_sdp`(faculty_id,program_id,level_id,year,title,description,date)VALUES (?,?,?,?,?,?,?)");
        $stmt->bind_param("issssss", $faculty_id, $program_id, $level_id, $year, $title, $description, $date);
        $result = $stmt->execute();
        $id = $con->insert_id;
        if ($_FILES['image_upload']['error'] == 0  &&  $_FILES['report_upload']['error'] == 0) {
            ...
            if ($file_upload_status['status'] == 200) {
                ...
                $stmt = $con->prepare("UPDATE `tbl_sdp` SET `report` = ? WHERE `tbl_sdp`.`id` = ?");
                $stmt->bind_param("si", $report_name, $id);
                $result = $stmt->execute();
            } else {

                $stmt = $con->prepare("DELETE FROM `tbl_sdp` WHERE id = ?");
            ...
            if ($file_upload_status['status'] == 200) {
                ...
                $stmt = $con->prepare("UPDATE `tbl_sdp` SET `img_name` = ? WHERE `tbl_sdp`.`id` = ?");
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Add SDP</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                    <li class="breadcrumb-item active">Add SDP</li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-gmiu">
                                    <div class="card-header">
                                        <h3 class="card-title">Add SDP</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form id="quickForm" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" id="title_id" placeholder="Enter SDP Title" required>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input" name="image_upload" id="image_upload" required>
                                ...
                                <div class="card card-gmiu">
                                    ...
                                    <form id="quickForm" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label>Select Level<span style="color: red;"> *</span></label>
                                                <select name="level_id" id="level_id" class="form-control" style="color:black; border-color:#325d88; border-width:2px" required>
                                                    <option value="">---Select Level---</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>Select Program<span style="color: red;"> *</span></label>
                                                <select name="program_id[]" id="program_id" class="form-control" style="color:black; border-color:#325d88; border-width:2px" multiple required>
