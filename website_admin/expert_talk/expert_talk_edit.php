...
if (isset($_GET['exp_id']) && !empty($_GET['exp_id'])) {
    ...
    $status = 0;
    $cmd = $con->prepare("SELECT  exp.faculty_id as faculty_id, exp.level_id as level_id, exp.program_id as program_id, exp.title as exp_title, exp.date as exp_date, exp.report_file as exp_report_file, exp.description as exp_description, exp.is_active as exp_is_active FROM tbl_expert_talk as exp WHERE exp.is_delete = ? AND exp.id = ?");
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $exp_date = !empty($row['exp_date']) ? $row['exp_date'] : 'N/A';
        $exp_description = !empty($row['exp_description']) ? $row['exp_description'] : 'N/A';
        $report_file = !empty($row['exp_report_file']) ? $row['exp_report_file'] : 'N/A';
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Expert Talk Outcome</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../common/dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Edit Expert Talk Outcome</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Expert Talk Outcome</h3>
                                    <!-- <h3 class="card-title">Quick Example <small>jQuery Validation</small></h3> -->
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="quickForm" method="POST" action="expert_talk_update.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <?php if ($role_id != 8) { ?>
       ...
       $stmt = $con->prepare($cmd);
        ...
        <?php } ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" id="title_id" value="<?php echo $exp_title; ?>" placeholder="Enter Expert Talk Name" required>
                                        </div>
                                        <input type="hidden" name="id" value="<?php echo $exp_id; ?>">
                                        <div class="form-group">
                                            <label for="level_name">Date<span style="color: red;">*</span></label>
                                            <input type="date" name="date" class="form-control" id="title" value="<?php echo $exp_date; ?>" placeholder="Enter date" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="text_editor">Description </label>
                                            <textarea id="text_editor" name="description"><?php echo htmlspecialchars_decode($exp_description); ?></textarea>
                                        </div>
                                        ...
                                        <div name="image_display_main" id="image_display_main" class="form-group">
                                            ...
                                            ?>
                                                <span name="image_display" id="image_display" class="form-group">
                                                    <img src="<?php echo "../uploads/expert_talk/image/" . "$file_name"; ?>" width="200" height="200">
                                                </span>
                                            <?php
                                            } ?>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <a href="../uploads/expert_talk/report/<?php echo  $report_file; ?>">View Report</a>
                                        </div>
