...
<head>
    ...
    $stmtCareerApp = $con->prepare("SELECT id FROM tbl_program WHERE is_active = 1 AND is_delete = 0");
    $stmtCareerApp->execute();
    $resultCareerApp = $stmtCareerApp->get_result();
    $total_program = $resultCareerApp->num_rows;
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-primary">
                                    ...
                                    <a href="../program/program_view_admin.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
