...
if (isset($_GET['workshop_id'])) {
    if (isset($_GET['workshop_id']) && !empty($_GET['workshop_id'])) {
        $workshop_id = mysqli_real_escape_string($con, $_GET['workshop_id']);
        $workshop_id = only_digits($workshop_id);
        ...
        $status = 0;
        $cmd = $con->prepare("SELECT  workshop.faculty_id as faculty_id,workshop.level_id as level_id,workshop.program_id as program_id,workshop.id as workshop_id,workshop.title as workshop_title,workshop.date as workshop_date, workshop.description as workshop_description,workshop.year as workshop_year FROM tbl_workshop as workshop
LEFT JOIN tbl_faculty faculty ON workshop.faculty_id = faculty.id 
 LEFT JOIN tbl_level level ON workshop.level_id = level.id
 LEFT JOIN tbl_program program ON workshop.program_id = program.id  WHERE workshop.is_delete = ? and workshop.id = ?");
        $cmd->bind_param("ii", $status, $workshop_id);
        $cmd->execute();
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="industryvisit_upload" method="POST" action="workshop_update.php" enctype="multipart/form-data">
...
<div class="selected-items"></div>
   ...
   $stmt = $con->prepare($cmd);
    ...
    <?php } ?>
                                        ...
                                        <input type="hidden" name="id" id="id" value=" <?php echo $workshop_id; ?>">
                                        <div class="form-group">
                                            <label for="title_name">Title<span style="color: red;">*</span></label>
                                            <input type="text" name="title" class="form-control" id="title" value="<?php echo $workshop_title ?>" placeholder="Enter Workshop Title" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="ckeditor" id="description" required><?php echo htmlspecialchars_decode($description); ?></textarea>
                                        </div>
                                        ...
                                        <div name="image1" id="image1" class="form-group">
                                            <div class="form-group">
                                                <label for="exampleInputFile">Upload Images (Multipart Image)</label>
                                        ...
                                        <div name="image_display_main" id="image_display_main" class="form-group">
                                            ...
                                            $cmd->bind_param("ss", $type, $workshop_id);
                                            $cmd->execute();
                                            $result = $cmd->get_result();
                                            ...
                                            ?>
                                                ...
                                                <div name="image_display" id="image_display" class="form-group">
                                                    <img src="<?php echo "../uploads/workshop/" . "$file_name"; ?>" width="200" height="200">
                                        ...
                                        <!-- <div name="image2" id="image2" class="form-group">
                                                <div class="form-group">
                                                    <label for="exampleInputFile">Upload Image 2<span style="color: red;">*</span></label>
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                        
                                                            <input type="file" class="custom-file-input" name="image_upload2" id="image_upload2" required>
                                            ...
                                            <div name="image3" id="image3" class="form-group">
                                                <div class="form-group">
                                                    <label for="exampleInputFile">Upload Image 3<span style="color: red;">*</span></label>
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                        
                                                            <input type="file" class="custom-file-input" name="image_upload3" id="image_upload3" required>
                                                            <label class="custom-file-label" for="exampleInputFile">  
                                                                </label>
                                                        </div>
                                                    </div>
...
<script src="../../admin_assets/plugins/bs-custom-file-input/bs-custom-file-input.min.js"></script>s
<script>
