...
if (isset($_GET['mm_id']) && !empty($_GET['mm_id'])) {
    ...
    if ($mm_id == false) {
        ...
        echo "<script>setTimeout(function(){window.location='project_exhibition_view.php'},1000)</script>";
    }
    $cmd = "SELECT sp.id as mm_id, sp.title as title, site_photos.file_name as file_name FROM tbl_campus as sp LEFT JOIN tbl_site_photos site_photos on sp.id = site_photos.type_id WHERE sp.id = ?";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit project_exhibition Activity</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Edit project_exhibition Activity</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-gmiu">
                                <div class="card-header">
                                    <h3 class="card-title">Edit project_exhibition Activity</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="quickForm" method="POST" action="project_exhibition_update.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div name="image_display_main" id="image_display_main" class="form-group">
                                            ...
                                            ?>
                                                ...
                                                <div name="image_display" id="image_display" class="form-group">
                                                    <img src="<?php echo "../uploads/project_exhibition/" . "$file_name"; ?>" width="200" height="200">
