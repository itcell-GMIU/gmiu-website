            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i class="fas fa-user-graduate"></i>
                            <p>Placement Statistics<i class="right fas fa-angle-left"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="../placement_statistics/placement_insert.php" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i class="fas fa-user-graduate"></i>
                            <p>Placement Overview<i class="right fas fa-angle-left"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="../placement_overview/placement_overview_insert.php" class="nav-link">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">
                                            <i class="fas fa-newspaper"></i>
                                            <p>Manage QR Page Post <i class="right fas fa-angle-left"></i></p>
                                        </a>
                                        <ul class="nav nav-treeview">
                                            <li class="nav-item">
                                                <a href="../post_handle/post_insert.php" class="nav-link">
                                                    <i class="fa-solid fa-plus nav-icon"></i>
                                                    <p>Add Post</p>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="../post_handle/post_view.php" class="nav-link">
                                                    <i class="fa-solid fa-eye nav-icon"></i>
                                                    <p>View Post </p>
                                                </a>
                                            </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="#" class="nav-link">
                                    ...
                                    <p>Website Log<i class="right fas fa-angle-left"></i></p>
                                </a>
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="../website_log/pdiploma-visitor.php" class="nav-link">
                                            <i class="fa-solid fa-plus nav-icon"></i>
                                            <p>Diploma Page Visitor</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="../website_log/admission-log.php" class="nav-link">
                                            <i class="fa-solid fa-eye nav-icon"></i>
                                            <p>Admission Login Data</p>
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a href="../website_log/email-log.php" class="nav-link">
                                            <i class="fa-solid fa-eye nav-icon"></i>
                                            <p>Admission Email Log</p>
                                        </a>
                                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="#" class="nav-link">
                                    <i class="fas fa-newspaper"></i>
                                    <p>Admission Merit<i class="right fas fa-angle-left"></i></p>
                                </a>
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="../UGC/ugc_insert.php" class="nav-link">
                                            <i class="fa-solid fa-plus nav-icon"></i>
                                            <p>Add Admission Merit</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="../UGC/ugc_view.php" class="nav-link">
                                             <i class="fa-solid fa-eye nav-icon"></i>
                                             <p>View Admission Merit </p>
                                        </a>
                                    </li>
                                </ul>
                             </li>
                   ...
                   <li class="nav-item">
                        ...
                        <!--<ul class="nav nav-treeview">-->
                        <!--    <li class="nav-item">-->
                        <!--        <a href="../forms/view-ca-registration.php" class="nav-link">-->
                        <!--            <i class="fa-solid fa-eye nav-icon"></i>-->
                        <!--            <p>CA Registrations</p>-->
                        <!--        </a>-->
                        <!--    </li>-->
                        <!--    <li class="nav-item">-->
                        <!--        <a href="../forms/view-aiml-registration.php" class="nav-link">-->
                        <!--            <i class="fa-solid fa-eye nav-icon"></i>-->
                        <!--            <p>AIML Registrations</p>-->
                        <!--        </a>-->
                        <!--    </li>-->
                        <!--    <li class="nav-item">-->
                        <!--        <a href="../forms/view-virtual-counselling.php" class="nav-link">-->
                        <!--            <i class="fa-solid fa-eye nav-icon"></i>-->
                        <!--            <p>Virtual Counselling</p>-->
                        <!--        </a>-->
                        <!--    </li>-->
                        <!--</ul>-->
                         <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=1&other_type=AIML" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>AIML Registrations</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=2&other_type=CA" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>CA Registrations</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=3" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>Virtual Counselling</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=4" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>GGC Scholarship Form</p>
                                </a>
                            </li>
                             <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=5" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>After 10th Scholarship</p>
                                </a>
                            </li>
                             <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=6" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>After 10th Scholarship Mahuva</p>
                                </a>
                            </li>
                             <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=7" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>12th Scholarship Test for Sci, Arts & Com</p>
                                </a>
                            </li>
                             <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=8" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>Career Chart Leads</p>
                                </a>
                            </li>
                             <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=9" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>Gyanmanjari Girls' College Admission Form</p>
                                </a>
                            </li>
                             <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=10" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>Design Admission Form</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=11" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>PLM Entrance Test Registration</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=12" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>DDCET Registration</p>
                                </a>
                            </li>
                             <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=14" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>Free One Day Vacation Workshop Registration Form</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=13" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>Diploma Reel Registration Form</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="../forms/forms-data.php?form_type=15" class="nav-link">
                                    <i class="fa-solid fa-eye nav-icon"></i>
                                    <p>GUJCET  Registration Form</p>
                                </a>
                            </li>
                        </ul>
                    </li>
