                            ...
                            <div class="table-responsive">
                                <table id="acedemic" class="dataTableLoad table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        <?php
                                            $status = 0;
                                            $cmd = $con->prepare("SELECT ach.id as ach_id, ach.faculty_id as faculty_id, ach.level_id as level_id, ach.program_id as program_id, ach.type as type, 
                                            program.name as program_name FROM tbl_achievement as ach 
                                            LEFT JOIN tbl_program program ON ach.program_id = program.id  WHERE ach.is_delete = ?");
                                        ...
                                        <tr align="center">
                                            ...
                                            <td scope="row" style="max-width:300px; overflow-x:scroll; display:flex; ">
                                                    <?php 
                                                        ...
                                                        $status = 0;
                                                        $type = "achievement";
                                                        $cmd1 = $con->prepare("SELECT photos.file_name as file_name  FROM `tbl_site_photos` as photos  where  photos.type = ? and photos.type_id = ?");
                                                    ...
                                                    ?>
                                                                <a href='<?php echo "../uploads/achievement/" . $file_name ?>' target="_blank"><img src="../uploads/achievement/<?php echo $file_name ?>" alt="" style="height: 200px; width:300px;"></a>
                                                        <?php
                                                        }
                                            ...
                                            <td scope="row">
                                                <?php echo $achievement_type; ?>
                                            </td>

                                            <td scope="row">
                                             <?php if($role_id == 11) { ?>
                                                <a href="achievement_delete.php?ach_id=<?php echo $ach_id; ?>"
